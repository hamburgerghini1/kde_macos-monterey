	...
	<div style="margin-bottom:20px;display:flex;">
		...
		<div class="shopify-payment-button" style="max-width:240px;">
			<a href="${DOMPurify.sanitize(offer.bestOffer.url)}"${merchantCfg.open_mode}>
				<button class="shopify-payment-button__button" style="max-width:240px;">${translates.buyAtOnAks((offer.priceDiffPercent!==0)?merchantCfg.priceDiffText:merchantCfg.priceCleaner(offer.bestOffer.price))}</button>
			</a>
		</div>
		<div class="shopify-payment-button" style="max-width:240px;">
