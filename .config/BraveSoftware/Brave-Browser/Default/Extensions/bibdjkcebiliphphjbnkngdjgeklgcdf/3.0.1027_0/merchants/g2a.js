const merchantCfg={
	...
	priceSelector:()=>{
		...
		if (jsonp&&jsonp.offers&&jsonp.offers.lowPrice)return String(jsonp.offers.lowPrice);
	},
	...
	template:(offer,offersCount,seeOnAKSLink,translates)=>{
		...
		return `<div style="width:300px;padding-right:30px;">
			<div ${ppp}>
				<div ${ppp_d}>
					<span ${ppp_d_l}>
						Price
			...
			<a href="${seeOnAKSLink}" style="display:block;color:white;text-decoration:none;margin:10px 0;"${merchantCfg.open_mode}>
				<button ${btp}>
