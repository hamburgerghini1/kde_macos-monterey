const merchantCfg={
	...
	template:(offer,offersCount,seeOnAKSLink,translates)=>{
		...
		<div class="plo-digital-price-box" id="akInjected">
		...
		<a href="${DOMPurify.sanitize(offer.bestOffer.url)}"${merchantCfg.open_mode} style="color:white;display:block;margin-top:10px;max-width:330px;text-align:center;">
		...
		<div style="max-width:330px;text-align:center;">
