const merchantCfg={
	...
	template:(offer,offersCount,seeOnAKSLink,translates)=> {
		document.querySelector('head').insertAdjacentHTML('beforeend','<style type="text/css">.product-actions-price__final-amount._price.naaa::before{content:none;}</style>');
		return `
		<div class="product-actions-price product-actions-price--discounted">
