...
const ignoredChars=[':','™','-','(',')','[',']',','];
const ignoredWords=['buy','compra','kup','kaufen','cd key','retail key','key','clé ',' \/ windows 10','green gift','gift','bethesda','Rockstar','game of the Year','precommande de','précommande','pre-order','preorder','ultimate bundle','Complete Edition','Definitive Edition','Ultimate Edition','deluxe','Edição Completa','Édition standard','Standard Edition','gold edition','PlayStation 4','PlayStation4','PlayStation5','PlayStation 5','gog','\/ V','/ biohazard 4','steam','epic games','microsoft','microsoft','battle.net','uplay','origin','pc','psn','ps vita','ps4 e ps5','ps4 et Ps5','ps4 and ps5','ps3','ps4','ps5','xbox series x','xbox live','xbox one','nintendo switch','switch','rocksta','™','©','®','global','europe','eu','north america','us/ca','us','asia','emea','ru/cis','uk','germany','france','spain','italy','eng','anniversary edition','edition','add-on'];
