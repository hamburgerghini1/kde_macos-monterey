/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/videoacc.idl - Do not edit ***/
...
/*** IAMVideoAccelerator methods ***/
static FORCEINLINE HRESULT IAMVideoAccelerator_GetVideoAcceleratorGUIDs(IAMVideoAccelerator* This,DWORD *count,GUID *accelerators) {
    return This->lpVtbl->GetVideoAcceleratorGUIDs(This,count,accelerators);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_GetUncompFormatsSupported(IAMVideoAccelerator* This,const GUID *accelerator,DWORD *count,DDPIXELFORMAT *formats) {
    return This->lpVtbl->GetUncompFormatsSupported(This,accelerator,count,formats);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_GetInternalMemInfo(IAMVideoAccelerator* This,const GUID *accelerator,const AMVAUncompDataInfo *format_info,AMVAInternalMemInfo *mem_info) {
    return This->lpVtbl->GetInternalMemInfo(This,accelerator,format_info,mem_info);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_GetCompBufferInfo(IAMVideoAccelerator* This,const GUID *accelerator,const AMVAUncompDataInfo *uncompressed_info,DWORD *compressed_info_count,AMVACompBufferInfo *compressed_infos) {
    return This->lpVtbl->GetCompBufferInfo(This,accelerator,uncompressed_info,compressed_info_count,compressed_infos);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_GetInternalCompBufferInfo(IAMVideoAccelerator* This,DWORD *count,AMVACompBufferInfo *infos) {
    return This->lpVtbl->GetInternalCompBufferInfo(This,count,infos);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_BeginFrame(IAMVideoAccelerator* This,const AMVABeginFrameInfo *info) {
    return This->lpVtbl->BeginFrame(This,info);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_EndFrame(IAMVideoAccelerator* This,const AMVAEndFrameInfo *info) {
    return This->lpVtbl->EndFrame(This,info);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_GetBuffer(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index,BOOL read_only,void **buffer,LONG *stride) {
    return This->lpVtbl->GetBuffer(This,type_index,buffer_index,read_only,buffer,stride);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_ReleaseBuffer(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index) {
    return This->lpVtbl->ReleaseBuffer(This,type_index,buffer_index);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_Execute(IAMVideoAccelerator* This,DWORD function,void *in_data,DWORD in_size,void *out_data,DWORD out_size,DWORD buffer_count,const AMVABUFFERINFO *buffers) {
    return This->lpVtbl->Execute(This,function,in_data,in_size,out_data,out_size,buffer_count,buffers);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_QueryRenderStatus(IAMVideoAccelerator* This,DWORD type_index,DWORD buffer_index,DWORD flags) {
    return This->lpVtbl->QueryRenderStatus(This,type_index,buffer_index,flags);
}
static FORCEINLINE HRESULT IAMVideoAccelerator_DisplayFrame(IAMVideoAccelerator* This,DWORD index,IMediaSample *sample) {
...
/*** IAMVideoAcceleratorNotify methods ***/
static FORCEINLINE HRESULT IAMVideoAcceleratorNotify_GetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,const GUID *accelerator,AMVAUncompBufferInfo *info) {
    return This->lpVtbl->GetUncompSurfacesInfo(This,accelerator,info);
}
static FORCEINLINE HRESULT IAMVideoAcceleratorNotify_SetUncompSurfacesInfo(IAMVideoAcceleratorNotify* This,DWORD allocated_count) {
    return This->lpVtbl->SetUncompSurfacesInfo(This,allocated_count);
}
static FORCEINLINE HRESULT IAMVideoAcceleratorNotify_GetCreateVideoAcceleratorData(IAMVideoAcceleratorNotify* This,const GUID *accelerator,DWORD *size,void **data) {
