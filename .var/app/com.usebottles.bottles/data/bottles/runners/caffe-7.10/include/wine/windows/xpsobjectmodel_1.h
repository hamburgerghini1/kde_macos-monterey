/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/xpsobjectmodel_1.idl - Do not edit ***/
...
/*** IXpsDocumentPackageTarget methods ***/
static FORCEINLINE HRESULT IXpsDocumentPackageTarget_GetXpsOMPackageWriter(IXpsDocumentPackageTarget* This,IOpcPartUri *documentpart,IOpcPartUri *controlpart,IXpsOMPackageWriter **writer) {
    return This->lpVtbl->GetXpsOMPackageWriter(This,documentpart,controlpart,writer);
}
static FORCEINLINE HRESULT IXpsDocumentPackageTarget_GetXpsOMFactory(IXpsDocumentPackageTarget* This,IXpsOMObjectFactory **factory) {
    return This->lpVtbl->GetXpsOMFactory(This,factory);
}
static FORCEINLINE HRESULT IXpsDocumentPackageTarget_GetXpsType(IXpsDocumentPackageTarget* This,XPS_DOCUMENT_TYPE *document_type) {
