/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/mfplay.idl - Do not edit ***/
...
/*** IMFPMediaItem methods ***/
static FORCEINLINE HRESULT IMFPMediaItem_GetMediaPlayer(IMFPMediaItem* This,IMFPMediaPlayer **player) {
    return This->lpVtbl->GetMediaPlayer(This,player);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetURL(IMFPMediaItem* This,LPWSTR *url) {
    return This->lpVtbl->GetURL(This,url);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetObject(IMFPMediaItem* This,IUnknown **obj) {
    return This->lpVtbl->GetObject(This,obj);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetUserData(IMFPMediaItem* This,DWORD_PTR *user_data) {
    return This->lpVtbl->GetUserData(This,user_data);
}
static FORCEINLINE HRESULT IMFPMediaItem_SetUserData(IMFPMediaItem* This,DWORD_PTR user_data) {
    return This->lpVtbl->SetUserData(This,user_data);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetStartStopPosition(IMFPMediaItem* This,GUID *start_format,PROPVARIANT *start_position,GUID *stop_format,PROPVARIANT *stop_position) {
    return This->lpVtbl->GetStartStopPosition(This,start_format,start_position,stop_format,stop_position);
}
static FORCEINLINE HRESULT IMFPMediaItem_SetStartStopPosition(IMFPMediaItem* This,const GUID *start_format,const PROPVARIANT *start_position,const GUID *stop_format,const PROPVARIANT *stop_position) {
    return This->lpVtbl->SetStartStopPosition(This,start_format,start_position,stop_format,stop_position);
}
static FORCEINLINE HRESULT IMFPMediaItem_HasVideo(IMFPMediaItem* This,BOOL *has_video,BOOL *selected) {
    return This->lpVtbl->HasVideo(This,has_video,selected);
}
static FORCEINLINE HRESULT IMFPMediaItem_HasAudio(IMFPMediaItem* This,BOOL *has_audio,BOOL *selected) {
    return This->lpVtbl->HasAudio(This,has_audio,selected);
}
static FORCEINLINE HRESULT IMFPMediaItem_IsProtected(IMFPMediaItem* This,BOOL *protected) {
    return This->lpVtbl->IsProtected(This,protected);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetDuration(IMFPMediaItem* This,REFGUID format,PROPVARIANT *value) {
    return This->lpVtbl->GetDuration(This,format,value);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetNumberOfStreams(IMFPMediaItem* This,DWORD *count) {
    return This->lpVtbl->GetNumberOfStreams(This,count);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetStreamSelection(IMFPMediaItem* This,DWORD index,BOOL *enabled) {
    return This->lpVtbl->GetStreamSelection(This,index,enabled);
}
static FORCEINLINE HRESULT IMFPMediaItem_SetStreamSelection(IMFPMediaItem* This,DWORD index,BOOL enabled) {
    return This->lpVtbl->SetStreamSelection(This,index,enabled);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetStreamAttribute(IMFPMediaItem* This,DWORD index,REFGUID key,PROPVARIANT *value) {
    return This->lpVtbl->GetStreamAttribute(This,index,key,value);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetPresentationAttribute(IMFPMediaItem* This,REFGUID key,PROPVARIANT *value) {
    return This->lpVtbl->GetPresentationAttribute(This,key,value);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetCharacteristics(IMFPMediaItem* This,MFP_MEDIAITEM_CHARACTERISTICS *flags) {
    return This->lpVtbl->GetCharacteristics(This,flags);
}
static FORCEINLINE HRESULT IMFPMediaItem_SetStreamSink(IMFPMediaItem* This,DWORD index,IUnknown *sink) {
    return This->lpVtbl->SetStreamSink(This,index,sink);
}
static FORCEINLINE HRESULT IMFPMediaItem_GetMetadata(IMFPMediaItem* This,IPropertyStore **metadata) {
