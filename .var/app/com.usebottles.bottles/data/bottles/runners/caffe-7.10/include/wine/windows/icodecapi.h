/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/icodecapi.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ICodecAPI_GetParameterRange(ICodecAPI* This,const GUID *api,VARIANT *min,VARIANT *max,VARIANT *delta) {
    return This->lpVtbl->GetParameterRange(This,api,min,max,delta);
}
static FORCEINLINE HRESULT ICodecAPI_GetParameterValues(ICodecAPI* This,const GUID *api,VARIANT **values,ULONG *count) {
...
static FORCEINLINE HRESULT ICodecAPI_SetValueWithNotify(ICodecAPI* This,const GUID *api,VARIANT *value,GUID **param,ULONG *count) {
    return This->lpVtbl->SetValueWithNotify(This,api,value,param,count);
}
static FORCEINLINE HRESULT ICodecAPI_SetAllDefaultsWithNotify(ICodecAPI* This,GUID **param,ULONG *count) {
    return This->lpVtbl->SetAllDefaultsWithNotify(This,param,count);
}
static FORCEINLINE HRESULT ICodecAPI_GetAllSettings(ICodecAPI* This,IStream *stream) {
    return This->lpVtbl->GetAllSettings(This,stream);
}
static FORCEINLINE HRESULT ICodecAPI_SetAllSettings(ICodecAPI* This,IStream *stream) {
    return This->lpVtbl->SetAllSettings(This,stream);
}
static FORCEINLINE HRESULT ICodecAPI_SetAllSettingsWithNotify(ICodecAPI* This,IStream *stream,GUID **param,ULONG *count) {
