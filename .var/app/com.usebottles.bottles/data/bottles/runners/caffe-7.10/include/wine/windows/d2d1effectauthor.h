/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/d2d1effectauthor.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1VertexBuffer_QueryInterface(ID2D1VertexBuffer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1VertexBuffer_AddRef(ID2D1VertexBuffer* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1VertexBuffer_Release(ID2D1VertexBuffer* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1VertexBuffer methods ***/
static FORCEINLINE HRESULT ID2D1VertexBuffer_Map(ID2D1VertexBuffer* This,BYTE **data,UINT32 size) {
    return This->lpVtbl->Map(This,data,size);
}
static FORCEINLINE HRESULT ID2D1VertexBuffer_Unmap(ID2D1VertexBuffer* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ResourceTexture_QueryInterface(ID2D1ResourceTexture* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ResourceTexture_AddRef(ID2D1ResourceTexture* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ResourceTexture_Release(ID2D1ResourceTexture* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1ResourceTexture methods ***/
static FORCEINLINE HRESULT ID2D1ResourceTexture_Update(ID2D1ResourceTexture* This,const UINT32 *min_extents,const UINT32 *max_extents,const UINT32 *strides,UINT32 dimensions,const BYTE *data,UINT32 data_size) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1RenderInfo_QueryInterface(ID2D1RenderInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1RenderInfo_AddRef(ID2D1RenderInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1RenderInfo_Release(ID2D1RenderInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1RenderInfo methods ***/
static FORCEINLINE HRESULT ID2D1RenderInfo_SetInputDescription(ID2D1RenderInfo* This,UINT32 index,D2D1_INPUT_DESCRIPTION description) {
    return This->lpVtbl->SetInputDescription(This,index,description);
}
static FORCEINLINE HRESULT ID2D1RenderInfo_SetOutputBuffer(ID2D1RenderInfo* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1RenderInfo_SetCached(ID2D1RenderInfo* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
static FORCEINLINE void ID2D1RenderInfo_SetInstructionCountHint(ID2D1RenderInfo* This,UINT32 count) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1DrawInfo_QueryInterface(ID2D1DrawInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1DrawInfo_AddRef(ID2D1DrawInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1DrawInfo_Release(ID2D1DrawInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1RenderInfo methods ***/
static FORCEINLINE HRESULT ID2D1DrawInfo_SetInputDescription(ID2D1DrawInfo* This,UINT32 index,D2D1_INPUT_DESCRIPTION description) {
    return This->lpVtbl->SetInputDescription(This,index,description);
}
static FORCEINLINE HRESULT ID2D1DrawInfo_SetOutputBuffer(ID2D1DrawInfo* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1DrawInfo_SetCached(ID2D1DrawInfo* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
static FORCEINLINE void ID2D1DrawInfo_SetInstructionCountHint(ID2D1DrawInfo* This,UINT32 count) {
    This->lpVtbl->SetInstructionCountHint(This,count);
}
/*** ID2D1DrawInfo methods ***/
static FORCEINLINE HRESULT ID2D1DrawInfo_SetPixelShaderConstantBuffer(ID2D1DrawInfo* This,const BYTE *buffer,UINT32 size) {
    return This->lpVtbl->SetPixelShaderConstantBuffer(This,buffer,size);
}
static FORCEINLINE HRESULT ID2D1DrawInfo_SetResourceTexture(ID2D1DrawInfo* This,UINT32 index,ID2D1ResourceTexture *texture) {
    return This->lpVtbl->SetResourceTexture(This,index,texture);
}
static FORCEINLINE HRESULT ID2D1DrawInfo_SetVertexShaderConstantBuffer(ID2D1DrawInfo* This,const BYTE *buffer,UINT32 size) {
    return This->lpVtbl->SetVertexShaderConstantBuffer(This,buffer,size);
}
static FORCEINLINE HRESULT ID2D1DrawInfo_SetPixelShader(ID2D1DrawInfo* This,REFGUID id,D2D1_PIXEL_OPTIONS options) {
    return This->lpVtbl->SetPixelShader(This,id,options);
}
static FORCEINLINE HRESULT ID2D1DrawInfo_SetVertexProcessing(ID2D1DrawInfo* This,ID2D1VertexBuffer *buffer,D2D1_VERTEX_OPTIONS options,const D2D1_BLEND_DESCRIPTION *description,const D2D1_VERTEX_RANGE *range,const GUID *shader) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ComputeInfo_QueryInterface(ID2D1ComputeInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ComputeInfo_AddRef(ID2D1ComputeInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ComputeInfo_Release(ID2D1ComputeInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1RenderInfo methods ***/
static FORCEINLINE HRESULT ID2D1ComputeInfo_SetInputDescription(ID2D1ComputeInfo* This,UINT32 index,D2D1_INPUT_DESCRIPTION description) {
    return This->lpVtbl->SetInputDescription(This,index,description);
}
static FORCEINLINE HRESULT ID2D1ComputeInfo_SetOutputBuffer(ID2D1ComputeInfo* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1ComputeInfo_SetCached(ID2D1ComputeInfo* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
static FORCEINLINE void ID2D1ComputeInfo_SetInstructionCountHint(ID2D1ComputeInfo* This,UINT32 count) {
    This->lpVtbl->SetInstructionCountHint(This,count);
}
/*** ID2D1ComputeInfo methods ***/
static FORCEINLINE HRESULT ID2D1ComputeInfo_SetComputeShaderconstantBuffer(ID2D1ComputeInfo* This,const BYTE *buffer,UINT32 size) {
    return This->lpVtbl->SetComputeShaderconstantBuffer(This,buffer,size);
}
static FORCEINLINE HRESULT ID2D1ComputeInfo_SetComputeShader(ID2D1ComputeInfo* This,REFGUID id) {
    return This->lpVtbl->SetComputeShader(This,id);
}
static FORCEINLINE HRESULT ID2D1ComputeInfo_SetResourceTexture(ID2D1ComputeInfo* This,UINT32 index,ID2D1ResourceTexture *texture) {
    return This->lpVtbl->SetResourceTexture(This,index,texture);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1TransformNode_QueryInterface(ID2D1TransformNode* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1TransformNode_AddRef(ID2D1TransformNode* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1TransformNode_Release(ID2D1TransformNode* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1TransformNode_GetInputCount(ID2D1TransformNode* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1TransformGraph_QueryInterface(ID2D1TransformGraph* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1TransformGraph_AddRef(ID2D1TransformGraph* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1TransformGraph_Release(ID2D1TransformGraph* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformGraph methods ***/
static FORCEINLINE UINT32 ID2D1TransformGraph_GetInputCount(ID2D1TransformGraph* This) {
    return This->lpVtbl->GetInputCount(This);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_SetSingleTransformNode(ID2D1TransformGraph* This,ID2D1TransformNode *node) {
    return This->lpVtbl->SetSingleTransformNode(This,node);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_AddNode(ID2D1TransformGraph* This,ID2D1TransformNode *node) {
    return This->lpVtbl->AddNode(This,node);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_RemoveNode(ID2D1TransformGraph* This,ID2D1TransformNode *node) {
    return This->lpVtbl->RemoveNode(This,node);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_SetOutputNode(ID2D1TransformGraph* This,ID2D1TransformNode *node) {
    return This->lpVtbl->SetOutputNode(This,node);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_ConnectNode(ID2D1TransformGraph* This,ID2D1TransformNode *from_node,ID2D1TransformNode *to_node,UINT32 index) {
    return This->lpVtbl->ConnectNode(This,from_node,to_node,index);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_ConnectToEffectInput(ID2D1TransformGraph* This,UINT32 input_index,ID2D1TransformNode *node,UINT32 node_index) {
    return This->lpVtbl->ConnectToEffectInput(This,input_index,node,node_index);
}
static FORCEINLINE void ID2D1TransformGraph_Clear(ID2D1TransformGraph* This) {
    This->lpVtbl->Clear(This);
}
static FORCEINLINE HRESULT ID2D1TransformGraph_SetPassthroughGraph(ID2D1TransformGraph* This,UINT32 index) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1Transform_QueryInterface(ID2D1Transform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1Transform_AddRef(ID2D1Transform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1Transform_Release(ID2D1Transform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1Transform_GetInputCount(ID2D1Transform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1Transform methods ***/
static FORCEINLINE HRESULT ID2D1Transform_MapOutputRectToInputRects(ID2D1Transform* This,const D2D1_RECT_L *output_rect,D2D1_RECT_L *input_rects,UINT32 input_rects_count) {
    return This->lpVtbl->MapOutputRectToInputRects(This,output_rect,input_rects,input_rects_count);
}
static FORCEINLINE HRESULT ID2D1Transform_MapInputRectsToOutputRect(ID2D1Transform* This,const D2D1_RECT_L *input_rects,const D2D1_RECT_L *input_opaque_rects,UINT32 input_rect_count,D2D1_RECT_L *output_rect,D2D1_RECT_L *output_opaque_rect) {
...
static FORCEINLINE HRESULT ID2D1Transform_MapInvalidRect(ID2D1Transform* This,UINT32 index,D2D1_RECT_L input_rect,D2D1_RECT_L *output_rect) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1DrawTransform_QueryInterface(ID2D1DrawTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1DrawTransform_AddRef(ID2D1DrawTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1DrawTransform_Release(ID2D1DrawTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1DrawTransform_GetInputCount(ID2D1DrawTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1Transform methods ***/
static FORCEINLINE HRESULT ID2D1DrawTransform_MapOutputRectToInputRects(ID2D1DrawTransform* This,const D2D1_RECT_L *output_rect,D2D1_RECT_L *input_rects,UINT32 input_rects_count) {
    return This->lpVtbl->MapOutputRectToInputRects(This,output_rect,input_rects,input_rects_count);
}
static FORCEINLINE HRESULT ID2D1DrawTransform_MapInputRectsToOutputRect(ID2D1DrawTransform* This,const D2D1_RECT_L *input_rects,const D2D1_RECT_L *input_opaque_rects,UINT32 input_rect_count,D2D1_RECT_L *output_rect,D2D1_RECT_L *output_opaque_rect) {
    return This->lpVtbl->MapInputRectsToOutputRect(This,input_rects,input_opaque_rects,input_rect_count,output_rect,output_opaque_rect);
}
static FORCEINLINE HRESULT ID2D1DrawTransform_MapInvalidRect(ID2D1DrawTransform* This,UINT32 index,D2D1_RECT_L input_rect,D2D1_RECT_L *output_rect) {
    return This->lpVtbl->MapInvalidRect(This,index,input_rect,output_rect);
}
/*** ID2D1DrawTransform methods ***/
static FORCEINLINE HRESULT ID2D1DrawTransform_SetDrawInfo(ID2D1DrawTransform* This,ID2D1DrawInfo *info) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ComputeTransform_QueryInterface(ID2D1ComputeTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ComputeTransform_AddRef(ID2D1ComputeTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ComputeTransform_Release(ID2D1ComputeTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1ComputeTransform_GetInputCount(ID2D1ComputeTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1Transform methods ***/
static FORCEINLINE HRESULT ID2D1ComputeTransform_MapOutputRectToInputRects(ID2D1ComputeTransform* This,const D2D1_RECT_L *output_rect,D2D1_RECT_L *input_rects,UINT32 input_rects_count) {
    return This->lpVtbl->MapOutputRectToInputRects(This,output_rect,input_rects,input_rects_count);
}
static FORCEINLINE HRESULT ID2D1ComputeTransform_MapInputRectsToOutputRect(ID2D1ComputeTransform* This,const D2D1_RECT_L *input_rects,const D2D1_RECT_L *input_opaque_rects,UINT32 input_rect_count,D2D1_RECT_L *output_rect,D2D1_RECT_L *output_opaque_rect) {
    return This->lpVtbl->MapInputRectsToOutputRect(This,input_rects,input_opaque_rects,input_rect_count,output_rect,output_opaque_rect);
}
static FORCEINLINE HRESULT ID2D1ComputeTransform_MapInvalidRect(ID2D1ComputeTransform* This,UINT32 index,D2D1_RECT_L input_rect,D2D1_RECT_L *output_rect) {
    return This->lpVtbl->MapInvalidRect(This,index,input_rect,output_rect);
}
/*** ID2D1ComputeTransform methods ***/
static FORCEINLINE HRESULT ID2D1ComputeTransform_SetComputeInfo(ID2D1ComputeTransform* This,ID2D1ComputeInfo *info) {
    return This->lpVtbl->SetComputeInfo(This,info);
}
static FORCEINLINE HRESULT ID2D1ComputeTransform_CalculateThreadgroups(ID2D1ComputeTransform* This,const D2D1_RECT_L *output_rect,UINT32 *dimension_x,UINT32 *dimension_y,UINT32 *dimension_z) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1AnalysisTransform_QueryInterface(ID2D1AnalysisTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1AnalysisTransform_AddRef(ID2D1AnalysisTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1AnalysisTransform_Release(ID2D1AnalysisTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1AnalysisTransform methods ***/
static FORCEINLINE HRESULT ID2D1AnalysisTransform_ProcessAnalysisResults(ID2D1AnalysisTransform* This,const BYTE *data,UINT32 size) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1SourceTransform_QueryInterface(ID2D1SourceTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1SourceTransform_AddRef(ID2D1SourceTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1SourceTransform_Release(ID2D1SourceTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1SourceTransform_GetInputCount(ID2D1SourceTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1Transform methods ***/
static FORCEINLINE HRESULT ID2D1SourceTransform_MapOutputRectToInputRects(ID2D1SourceTransform* This,const D2D1_RECT_L *output_rect,D2D1_RECT_L *input_rects,UINT32 input_rects_count) {
    return This->lpVtbl->MapOutputRectToInputRects(This,output_rect,input_rects,input_rects_count);
}
static FORCEINLINE HRESULT ID2D1SourceTransform_MapInputRectsToOutputRect(ID2D1SourceTransform* This,const D2D1_RECT_L *input_rects,const D2D1_RECT_L *input_opaque_rects,UINT32 input_rect_count,D2D1_RECT_L *output_rect,D2D1_RECT_L *output_opaque_rect) {
    return This->lpVtbl->MapInputRectsToOutputRect(This,input_rects,input_opaque_rects,input_rect_count,output_rect,output_opaque_rect);
}
static FORCEINLINE HRESULT ID2D1SourceTransform_MapInvalidRect(ID2D1SourceTransform* This,UINT32 index,D2D1_RECT_L input_rect,D2D1_RECT_L *output_rect) {
    return This->lpVtbl->MapInvalidRect(This,index,input_rect,output_rect);
}
/*** ID2D1SourceTransform methods ***/
static FORCEINLINE HRESULT ID2D1SourceTransform_SetRenderInfo(ID2D1SourceTransform* This,ID2D1RenderInfo *info) {
    return This->lpVtbl->SetRenderInfo(This,info);
}
static FORCEINLINE HRESULT ID2D1SourceTransform_Draw(ID2D1SourceTransform* This,ID2D1Bitmap1 *target,const D2D1_RECT_L *draw_rect,D2D1_POINT_2U target_origin) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ConcreteTransform_QueryInterface(ID2D1ConcreteTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ConcreteTransform_AddRef(ID2D1ConcreteTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ConcreteTransform_Release(ID2D1ConcreteTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1ConcreteTransform_GetInputCount(ID2D1ConcreteTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1ConcreteTransform methods ***/
static FORCEINLINE HRESULT ID2D1ConcreteTransform_SetOutputBuffer(ID2D1ConcreteTransform* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1ConcreteTransform_SetCached(ID2D1ConcreteTransform* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1BlendTransform_QueryInterface(ID2D1BlendTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1BlendTransform_AddRef(ID2D1BlendTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1BlendTransform_Release(ID2D1BlendTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1BlendTransform_GetInputCount(ID2D1BlendTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1ConcreteTransform methods ***/
static FORCEINLINE HRESULT ID2D1BlendTransform_SetOutputBuffer(ID2D1BlendTransform* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1BlendTransform_SetCached(ID2D1BlendTransform* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
/*** ID2D1BlendTransform methods ***/
static FORCEINLINE void ID2D1BlendTransform_SetDescription(ID2D1BlendTransform* This,const D2D1_BLEND_DESCRIPTION *description) {
    This->lpVtbl->SetDescription(This,description);
}
static FORCEINLINE void ID2D1BlendTransform_GetDescription(ID2D1BlendTransform* This,D2D1_BLEND_DESCRIPTION *description) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1BorderTransform_QueryInterface(ID2D1BorderTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1BorderTransform_AddRef(ID2D1BorderTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1BorderTransform_Release(ID2D1BorderTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1BorderTransform_GetInputCount(ID2D1BorderTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1ConcreteTransform methods ***/
static FORCEINLINE HRESULT ID2D1BorderTransform_SetOutputBuffer(ID2D1BorderTransform* This,D2D1_BUFFER_PRECISION precision,D2D1_CHANNEL_DEPTH depth) {
    return This->lpVtbl->SetOutputBuffer(This,precision,depth);
}
static FORCEINLINE void ID2D1BorderTransform_SetCached(ID2D1BorderTransform* This,BOOL is_cached) {
    This->lpVtbl->SetCached(This,is_cached);
}
/*** ID2D1BorderTransform methods ***/
static FORCEINLINE void ID2D1BorderTransform_SetExtendModeX(ID2D1BorderTransform* This,D2D1_EXTEND_MODE mode) {
    This->lpVtbl->SetExtendModeX(This,mode);
}
static FORCEINLINE void ID2D1BorderTransform_SetExtendModeY(ID2D1BorderTransform* This,D2D1_EXTEND_MODE mode) {
    This->lpVtbl->SetExtendModeY(This,mode);
}
static FORCEINLINE D2D1_EXTEND_MODE ID2D1BorderTransform_GetExtendModeX(ID2D1BorderTransform* This) {
    return This->lpVtbl->GetExtendModeX(This);
}
static FORCEINLINE D2D1_EXTEND_MODE ID2D1BorderTransform_GetExtendModeY(ID2D1BorderTransform* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1OffsetTransform_QueryInterface(ID2D1OffsetTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1OffsetTransform_AddRef(ID2D1OffsetTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1OffsetTransform_Release(ID2D1OffsetTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1OffsetTransform_GetInputCount(ID2D1OffsetTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1OffsetTransform methods ***/
static FORCEINLINE void ID2D1OffsetTransform_SetOffset(ID2D1OffsetTransform* This,D2D1_POINT_2L offset) {
    This->lpVtbl->SetOffset(This,offset);
}
static FORCEINLINE D2D1_POINT_2L ID2D1OffsetTransform_GetOffset(ID2D1OffsetTransform* This) {
    D2D1_POINT_2L __ret;
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1BoundsAdjustmentTransform_QueryInterface(ID2D1BoundsAdjustmentTransform* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1BoundsAdjustmentTransform_AddRef(ID2D1BoundsAdjustmentTransform* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1BoundsAdjustmentTransform_Release(ID2D1BoundsAdjustmentTransform* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1TransformNode methods ***/
static FORCEINLINE UINT32 ID2D1BoundsAdjustmentTransform_GetInputCount(ID2D1BoundsAdjustmentTransform* This) {
    return This->lpVtbl->GetInputCount(This);
}
/*** ID2D1BoundsAdjustmentTransform methods ***/
static FORCEINLINE void ID2D1BoundsAdjustmentTransform_SetOutputBounds(ID2D1BoundsAdjustmentTransform* This,const D2D1_RECT_L *bounds) {
    This->lpVtbl->SetOutputBounds(This,bounds);
}
static FORCEINLINE void ID2D1BoundsAdjustmentTransform_GetOutputBounds(ID2D1BoundsAdjustmentTransform* This,D2D1_RECT_L *bounds) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1EffectContext_QueryInterface(ID2D1EffectContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1EffectContext_AddRef(ID2D1EffectContext* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1EffectContext_Release(ID2D1EffectContext* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1EffectContext methods ***/
static FORCEINLINE void ID2D1EffectContext_GetDpi(ID2D1EffectContext* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateEffect(ID2D1EffectContext* This,REFCLSID clsid,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,clsid,effect);
}
static FORCEINLINE HRESULT ID2D1EffectContext_GetMaximumSupportedFeatureLevel(ID2D1EffectContext* This,const D3D_FEATURE_LEVEL *levels,UINT32 level_count,D3D_FEATURE_LEVEL *max_level) {
    return This->lpVtbl->GetMaximumSupportedFeatureLevel(This,levels,level_count,max_level);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateTransformNodeFromEffect(ID2D1EffectContext* This,ID2D1Effect *effect,ID2D1TransformNode **node) {
    return This->lpVtbl->CreateTransformNodeFromEffect(This,effect,node);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateBlendTransform(ID2D1EffectContext* This,UINT32 num_inputs,const D2D1_BLEND_DESCRIPTION *description,ID2D1BlendTransform **transform) {
    return This->lpVtbl->CreateBlendTransform(This,num_inputs,description,transform);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateBorderTransform(ID2D1EffectContext* This,D2D1_EXTEND_MODE mode_x,D2D1_EXTEND_MODE mode_y,ID2D1BorderTransform **transform) {
    return This->lpVtbl->CreateBorderTransform(This,mode_x,mode_y,transform);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateOffsetTransform(ID2D1EffectContext* This,D2D1_POINT_2L offset,ID2D1OffsetTransform **transform) {
    return This->lpVtbl->CreateOffsetTransform(This,offset,transform);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateBoundsAdjustmentTransform(ID2D1EffectContext* This,const D2D1_RECT_L *output_rect,ID2D1BoundsAdjustmentTransform **transform) {
    return This->lpVtbl->CreateBoundsAdjustmentTransform(This,output_rect,transform);
}
static FORCEINLINE HRESULT ID2D1EffectContext_LoadPixelShader(ID2D1EffectContext* This,REFGUID shader_id,const BYTE *buffer,UINT32 buffer_size) {
    return This->lpVtbl->LoadPixelShader(This,shader_id,buffer,buffer_size);
}
static FORCEINLINE HRESULT ID2D1EffectContext_LoadVertexShader(ID2D1EffectContext* This,REFGUID shader_id,const BYTE *buffer,UINT32 buffer_size) {
    return This->lpVtbl->LoadVertexShader(This,shader_id,buffer,buffer_size);
}
static FORCEINLINE HRESULT ID2D1EffectContext_LoadComputeShader(ID2D1EffectContext* This,REFGUID shader_id,const BYTE *buffer,UINT32 buffer_size) {
    return This->lpVtbl->LoadComputeShader(This,shader_id,buffer,buffer_size);
}
static FORCEINLINE BOOL ID2D1EffectContext_IsShaderLoaded(ID2D1EffectContext* This,REFGUID shader_id) {
    return This->lpVtbl->IsShaderLoaded(This,shader_id);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateResourceTexture(ID2D1EffectContext* This,const GUID *id,const D2D1_RESOURCE_TEXTURE_PROPERTIES *texture_properties,const BYTE *data,const UINT32 *strides,UINT32 data_size,ID2D1ResourceTexture **texture) {
    return This->lpVtbl->CreateResourceTexture(This,id,texture_properties,data,strides,data_size,texture);
}
static FORCEINLINE HRESULT ID2D1EffectContext_FindResourceTexture(ID2D1EffectContext* This,const GUID *id,ID2D1ResourceTexture **texture) {
    return This->lpVtbl->FindResourceTexture(This,id,texture);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateVertexBuffer(ID2D1EffectContext* This,const D2D1_VERTEX_BUFFER_PROPERTIES *buffer_properties,const GUID *id,const D2D1_CUSTOM_VERTEX_BUFFER_PROPERTIES *custom_buffer_properties,ID2D1VertexBuffer **buffer) {
    return This->lpVtbl->CreateVertexBuffer(This,buffer_properties,id,custom_buffer_properties,buffer);
}
static FORCEINLINE HRESULT ID2D1EffectContext_FindVertexBuffer(ID2D1EffectContext* This,const GUID *id,ID2D1VertexBuffer **buffer) {
    return This->lpVtbl->FindVertexBuffer(This,id,buffer);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateColorContext(ID2D1EffectContext* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateColorContextFromFilename(ID2D1EffectContext* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CreateColorContextFromWicColorContext(ID2D1EffectContext* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static FORCEINLINE HRESULT ID2D1EffectContext_CheckFeatureSupport(ID2D1EffectContext* This,D2D1_FEATURE feature,void *data,UINT32 data_size) {
    return This->lpVtbl->CheckFeatureSupport(This,feature,data,data_size);
}
static FORCEINLINE BOOL ID2D1EffectContext_IsBufferPrecisionSupported(ID2D1EffectContext* This,D2D1_BUFFER_PRECISION precision) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1EffectImpl_QueryInterface(ID2D1EffectImpl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1EffectImpl_AddRef(ID2D1EffectImpl* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1EffectImpl_Release(ID2D1EffectImpl* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1EffectImpl methods ***/
static FORCEINLINE HRESULT ID2D1EffectImpl_Initialize(ID2D1EffectImpl* This,ID2D1EffectContext *context,ID2D1TransformGraph *graph) {
    return This->lpVtbl->Initialize(This,context,graph);
}
static FORCEINLINE HRESULT ID2D1EffectImpl_PrepareForRender(ID2D1EffectImpl* This,D2D1_CHANGE_TYPE type) {
    return This->lpVtbl->PrepareForRender(This,type);
}
static FORCEINLINE HRESULT ID2D1EffectImpl_SetGraph(ID2D1EffectImpl* This,ID2D1TransformGraph *graph) {
