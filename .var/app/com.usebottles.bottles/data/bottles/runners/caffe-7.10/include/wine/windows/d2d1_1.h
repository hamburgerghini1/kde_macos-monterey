/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/d2d1_1.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1GdiMetafileSink_QueryInterface(ID2D1GdiMetafileSink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1GdiMetafileSink_AddRef(ID2D1GdiMetafileSink* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1GdiMetafileSink_Release(ID2D1GdiMetafileSink* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1GdiMetafileSink methods ***/
static FORCEINLINE HRESULT ID2D1GdiMetafileSink_ProcessRecord(ID2D1GdiMetafileSink* This,DWORD type,const void *data,DWORD size) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1GdiMetafile_QueryInterface(ID2D1GdiMetafile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1GdiMetafile_AddRef(ID2D1GdiMetafile* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1GdiMetafile_Release(ID2D1GdiMetafile* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1GdiMetafile_GetFactory(ID2D1GdiMetafile* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1GdiMetafile methods ***/
static FORCEINLINE HRESULT ID2D1GdiMetafile_Stream(ID2D1GdiMetafile* This,ID2D1GdiMetafileSink *sink) {
    return This->lpVtbl->Stream(This,sink);
}
static FORCEINLINE HRESULT ID2D1GdiMetafile_GetBounds(ID2D1GdiMetafile* This,D2D1_RECT_F *bounds) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1PathGeometry1_QueryInterface(ID2D1PathGeometry1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1PathGeometry1_AddRef(ID2D1PathGeometry1* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1PathGeometry1_Release(ID2D1PathGeometry1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1PathGeometry1_GetFactory(ID2D1PathGeometry1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Geometry methods ***/
static FORCEINLINE HRESULT ID2D1PathGeometry1_GetBounds(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetBounds(This,transform,bounds);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_GetWidenedBounds(ID2D1PathGeometry1* This,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetWidenedBounds(This,stroke_width,stroke_style,transform,tolerance,bounds);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_StrokeContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
    return This->lpVtbl->StrokeContainsPoint(This,point,stroke_width,stroke_style,transform,tolerance,contains);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_FillContainsPoint(ID2D1PathGeometry1* This,D2D1_POINT_2F point,const D2D1_MATRIX_3X2_F *transform,float tolerance,BOOL *contains) {
    return This->lpVtbl->FillContainsPoint(This,point,transform,tolerance,contains);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_CompareWithGeometry(ID2D1PathGeometry1* This,ID2D1Geometry *geometry,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_GEOMETRY_RELATION *relation) {
    return This->lpVtbl->CompareWithGeometry(This,geometry,transform,tolerance,relation);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_Simplify(ID2D1PathGeometry1* This,D2D1_GEOMETRY_SIMPLIFICATION_OPTION option,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Simplify(This,option,transform,tolerance,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_Tessellate(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1TessellationSink *sink) {
    return This->lpVtbl->Tessellate(This,transform,tolerance,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_CombineWithGeometry(ID2D1PathGeometry1* This,ID2D1Geometry *geometry,D2D1_COMBINE_MODE combine_mode,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->CombineWithGeometry(This,geometry,combine_mode,transform,tolerance,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_Outline(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Outline(This,transform,tolerance,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_ComputeArea(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,float *area) {
    return This->lpVtbl->ComputeArea(This,transform,tolerance,area);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_ComputeLength(ID2D1PathGeometry1* This,const D2D1_MATRIX_3X2_F *transform,float tolerance,float *length) {
    return This->lpVtbl->ComputeLength(This,transform,tolerance,length);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_ComputePointAtLength(ID2D1PathGeometry1* This,float length,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_POINT_2F *point,D2D1_POINT_2F *tangent) {
    return This->lpVtbl->ComputePointAtLength(This,length,transform,tolerance,point,tangent);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_Widen(ID2D1PathGeometry1* This,float stroke_width,ID2D1StrokeStyle *stroke_style,const D2D1_MATRIX_3X2_F *transform,float tolerance,ID2D1SimplifiedGeometrySink *sink) {
    return This->lpVtbl->Widen(This,stroke_width,stroke_style,transform,tolerance,sink);
}
/*** ID2D1PathGeometry methods ***/
static FORCEINLINE HRESULT ID2D1PathGeometry1_Open(ID2D1PathGeometry1* This,ID2D1GeometrySink **sink) {
    return This->lpVtbl->Open(This,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_Stream(ID2D1PathGeometry1* This,ID2D1GeometrySink *sink) {
    return This->lpVtbl->Stream(This,sink);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_GetSegmentCount(ID2D1PathGeometry1* This,UINT32 *count) {
    return This->lpVtbl->GetSegmentCount(This,count);
}
static FORCEINLINE HRESULT ID2D1PathGeometry1_GetFigureCount(ID2D1PathGeometry1* This,UINT32 *count) {
    return This->lpVtbl->GetFigureCount(This,count);
}
/*** ID2D1PathGeometry1 methods ***/
static FORCEINLINE HRESULT ID2D1PathGeometry1_ComputePointAndSegmentAtLength(ID2D1PathGeometry1* This,float length,UINT32 start_segment,const D2D1_MATRIX_3X2_F *transform,float tolerance,D2D1_POINT_DESCRIPTION *point_desc) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ColorContext_QueryInterface(ID2D1ColorContext* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ColorContext_AddRef(ID2D1ColorContext* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ColorContext_Release(ID2D1ColorContext* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1ColorContext_GetFactory(ID2D1ColorContext* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1ColorContext methods ***/
static FORCEINLINE D2D1_COLOR_SPACE ID2D1ColorContext_GetColorSpace(ID2D1ColorContext* This) {
    return This->lpVtbl->GetColorSpace(This);
}
static FORCEINLINE UINT32 ID2D1ColorContext_GetProfileSize(ID2D1ColorContext* This) {
    return This->lpVtbl->GetProfileSize(This);
}
static FORCEINLINE HRESULT ID2D1ColorContext_GetProfile(ID2D1ColorContext* This,BYTE *profile,UINT32 size) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1GradientStopCollection1_QueryInterface(ID2D1GradientStopCollection1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1GradientStopCollection1_AddRef(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1GradientStopCollection1_Release(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1GradientStopCollection1_GetFactory(ID2D1GradientStopCollection1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1GradientStopCollection methods ***/
static FORCEINLINE UINT32 ID2D1GradientStopCollection1_GetGradientStopCount(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetGradientStopCount(This);
}
static FORCEINLINE void ID2D1GradientStopCollection1_GetGradientStops(ID2D1GradientStopCollection1* This,D2D1_GRADIENT_STOP *stops,UINT32 stop_count) {
    This->lpVtbl->GetGradientStops(This,stops,stop_count);
}
static FORCEINLINE D2D1_GAMMA ID2D1GradientStopCollection1_GetColorInterpolationGamma(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetColorInterpolationGamma(This);
}
static FORCEINLINE D2D1_EXTEND_MODE ID2D1GradientStopCollection1_GetExtendMode(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetExtendMode(This);
}
/*** ID2D1GradientStopCollection1 methods ***/
static FORCEINLINE void ID2D1GradientStopCollection1_GetGradientStops1(ID2D1GradientStopCollection1* This,D2D1_GRADIENT_STOP *gradient,UINT32 count) {
    This->lpVtbl->GetGradientStops1(This,gradient,count);
}
static FORCEINLINE D2D1_COLOR_SPACE ID2D1GradientStopCollection1_GetPreInterpolationSpace(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetPreInterpolationSpace(This);
}
static FORCEINLINE D2D1_COLOR_SPACE ID2D1GradientStopCollection1_GetPostInterpolationSpace(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetPostInterpolationSpace(This);
}
static FORCEINLINE D2D1_BUFFER_PRECISION ID2D1GradientStopCollection1_GetBufferPrecision(ID2D1GradientStopCollection1* This) {
    return This->lpVtbl->GetBufferPrecision(This);
}
static FORCEINLINE D2D1_COLOR_INTERPOLATION_MODE ID2D1GradientStopCollection1_GetColorInterpolationMode(ID2D1GradientStopCollection1* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1PrintControl_QueryInterface(ID2D1PrintControl* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1PrintControl_AddRef(ID2D1PrintControl* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1PrintControl_Release(ID2D1PrintControl* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1PrintControl methods ***/
static FORCEINLINE HRESULT ID2D1PrintControl_AddPage(ID2D1PrintControl* This,ID2D1CommandList *list,D2D_SIZE_F size,IStream *stream,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->AddPage(This,list,size,stream,tag1,tag2);
}
static FORCEINLINE HRESULT ID2D1PrintControl_Close(ID2D1PrintControl* This) {
    return This->lpVtbl->Close(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ImageBrush_QueryInterface(ID2D1ImageBrush* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ImageBrush_AddRef(ID2D1ImageBrush* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ImageBrush_Release(ID2D1ImageBrush* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1ImageBrush_GetFactory(ID2D1ImageBrush* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Brush methods ***/
static FORCEINLINE void ID2D1ImageBrush_SetOpacity(ID2D1ImageBrush* This,float opacity) {
    This->lpVtbl->SetOpacity(This,opacity);
}
static FORCEINLINE void ID2D1ImageBrush_SetTransform(ID2D1ImageBrush* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static FORCEINLINE float ID2D1ImageBrush_GetOpacity(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetOpacity(This);
}
static FORCEINLINE void ID2D1ImageBrush_GetTransform(ID2D1ImageBrush* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
/*** ID2D1ImageBrush methods ***/
static FORCEINLINE void ID2D1ImageBrush_SetImage(ID2D1ImageBrush* This,ID2D1Image *image) {
    This->lpVtbl->SetImage(This,image);
}
static FORCEINLINE void ID2D1ImageBrush_SetExtendModeX(ID2D1ImageBrush* This,D2D1_EXTEND_MODE extend_mode) {
    This->lpVtbl->SetExtendModeX(This,extend_mode);
}
static FORCEINLINE void ID2D1ImageBrush_SetExtendModeY(ID2D1ImageBrush* This,D2D1_EXTEND_MODE extend_mode) {
    This->lpVtbl->SetExtendModeY(This,extend_mode);
}
static FORCEINLINE void ID2D1ImageBrush_SetInterpolationMode(ID2D1ImageBrush* This,D2D1_INTERPOLATION_MODE interpolation_mode) {
    This->lpVtbl->SetInterpolationMode(This,interpolation_mode);
}
static FORCEINLINE void ID2D1ImageBrush_SetSourceRectangle(ID2D1ImageBrush* This,const D2D1_RECT_F *rect) {
    This->lpVtbl->SetSourceRectangle(This,rect);
}
static FORCEINLINE void ID2D1ImageBrush_GetImage(ID2D1ImageBrush* This,ID2D1Image **image) {
    This->lpVtbl->GetImage(This,image);
}
static FORCEINLINE D2D1_EXTEND_MODE ID2D1ImageBrush_GetExtendModeX(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetExtendModeX(This);
}
static FORCEINLINE D2D1_EXTEND_MODE ID2D1ImageBrush_GetExtendModeY(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetExtendModeY(This);
}
static FORCEINLINE D2D1_INTERPOLATION_MODE ID2D1ImageBrush_GetInterpolationMode(ID2D1ImageBrush* This) {
    return This->lpVtbl->GetInterpolationMode(This);
}
static FORCEINLINE void ID2D1ImageBrush_GetSourceRectangle(ID2D1ImageBrush* This,D2D1_RECT_F *rect) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1StrokeStyle1_QueryInterface(ID2D1StrokeStyle1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1StrokeStyle1_AddRef(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1StrokeStyle1_Release(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1StrokeStyle1_GetFactory(ID2D1StrokeStyle1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1StrokeStyle methods ***/
static FORCEINLINE D2D1_CAP_STYLE ID2D1StrokeStyle1_GetStartCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetStartCap(This);
}
static FORCEINLINE D2D1_CAP_STYLE ID2D1StrokeStyle1_GetEndCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetEndCap(This);
}
static FORCEINLINE D2D1_CAP_STYLE ID2D1StrokeStyle1_GetDashCap(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashCap(This);
}
static FORCEINLINE float ID2D1StrokeStyle1_GetMiterLimit(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetMiterLimit(This);
}
static FORCEINLINE D2D1_LINE_JOIN ID2D1StrokeStyle1_GetLineJoin(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetLineJoin(This);
}
static FORCEINLINE float ID2D1StrokeStyle1_GetDashOffset(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashOffset(This);
}
static FORCEINLINE D2D1_DASH_STYLE ID2D1StrokeStyle1_GetDashStyle(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashStyle(This);
}
static FORCEINLINE UINT32 ID2D1StrokeStyle1_GetDashesCount(ID2D1StrokeStyle1* This) {
    return This->lpVtbl->GetDashesCount(This);
}
static FORCEINLINE void ID2D1StrokeStyle1_GetDashes(ID2D1StrokeStyle1* This,float *dashes,UINT32 count) {
    This->lpVtbl->GetDashes(This,dashes,count);
}
/*** ID2D1StrokeStyle1 methods ***/
static FORCEINLINE D2D1_STROKE_TRANSFORM_TYPE ID2D1StrokeStyle1_GetStrokeTransformType(ID2D1StrokeStyle1* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1Multithread_QueryInterface(ID2D1Multithread* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1Multithread_AddRef(ID2D1Multithread* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1Multithread_Release(ID2D1Multithread* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Multithread methods ***/
static FORCEINLINE BOOL ID2D1Multithread_GetMultithreadProtected(ID2D1Multithread* This) {
    return This->lpVtbl->GetMultithreadProtected(This);
}
static FORCEINLINE void ID2D1Multithread_Enter(ID2D1Multithread* This) {
    This->lpVtbl->Enter(This);
}
static FORCEINLINE void ID2D1Multithread_Leave(ID2D1Multithread* This) {
