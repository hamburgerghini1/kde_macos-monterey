/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/d2d1_2.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1GeometryRealization_QueryInterface(ID2D1GeometryRealization* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1GeometryRealization_AddRef(ID2D1GeometryRealization* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1GeometryRealization_Release(ID2D1GeometryRealization* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1GeometryRealization_GetFactory(ID2D1GeometryRealization* This,ID2D1Factory **factory) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext1_QueryInterface(ID2D1DeviceContext1* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1DeviceContext1_AddRef(ID2D1DeviceContext1* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1DeviceContext1_Release(ID2D1DeviceContext1* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1DeviceContext1_GetFactory(ID2D1DeviceContext1* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1RenderTarget methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateSharedBitmap(ID2D1DeviceContext1* This,REFIID iid,void *data,const D2D1_BITMAP_PROPERTIES *desc,ID2D1Bitmap **bitmap) {
    return This->lpVtbl->CreateSharedBitmap(This,iid,data,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateSolidColorBrush(ID2D1DeviceContext1* This,const D2D1_COLOR_F *color,const D2D1_BRUSH_PROPERTIES *desc,ID2D1SolidColorBrush **brush) {
    return This->lpVtbl->CreateSolidColorBrush(This,color,desc,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateLinearGradientBrush(ID2D1DeviceContext1* This,const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1LinearGradientBrush **brush) {
    return This->lpVtbl->CreateLinearGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateRadialGradientBrush(ID2D1DeviceContext1* This,const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1RadialGradientBrush **brush) {
    return This->lpVtbl->CreateRadialGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateCompatibleRenderTarget(ID2D1DeviceContext1* This,const D2D1_SIZE_F *size,const D2D1_SIZE_U *pixel_size,const D2D1_PIXEL_FORMAT *format,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options,ID2D1BitmapRenderTarget **render_target) {
    return This->lpVtbl->CreateCompatibleRenderTarget(This,size,pixel_size,format,options,render_target);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateLayer(ID2D1DeviceContext1* This,const D2D1_SIZE_F *size,ID2D1Layer **layer) {
    return This->lpVtbl->CreateLayer(This,size,layer);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateMesh(ID2D1DeviceContext1* This,ID2D1Mesh **mesh) {
    return This->lpVtbl->CreateMesh(This,mesh);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawLine(ID2D1DeviceContext1* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawRectangle(ID2D1DeviceContext1* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext1_FillRectangle(ID2D1DeviceContext1* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRectangle(This,rect,brush);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawRoundedRectangle(ID2D1DeviceContext1* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRoundedRectangle(This,rect,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext1_FillRoundedRectangle(ID2D1DeviceContext1* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRoundedRectangle(This,rect,brush);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawEllipse(ID2D1DeviceContext1* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawEllipse(This,ellipse,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext1_FillEllipse(ID2D1DeviceContext1* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush) {
    This->lpVtbl->FillEllipse(This,ellipse,brush);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawGeometry(ID2D1DeviceContext1* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext1_FillGeometry(ID2D1DeviceContext1* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static FORCEINLINE void ID2D1DeviceContext1_FillMesh(ID2D1DeviceContext1* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    This->lpVtbl->FillMesh(This,mesh,brush);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawText(ID2D1DeviceContext1* This,const WCHAR *string,UINT32 string_len,IDWriteTextFormat *text_format,const D2D1_RECT_F *layout_rect,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->DrawText(This,string,string_len,text_format,layout_rect,brush,options,measuring_mode);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawTextLayout(ID2D1DeviceContext1* This,D2D1_POINT_2F origin,IDWriteTextLayout *layout,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options) {
    This->lpVtbl->DrawTextLayout(This,origin,layout,brush,options);
}
static FORCEINLINE void ID2D1DeviceContext1_SetTransform(ID2D1DeviceContext1* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static FORCEINLINE void ID2D1DeviceContext1_GetTransform(ID2D1DeviceContext1* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
static FORCEINLINE void ID2D1DeviceContext1_SetAntialiasMode(ID2D1DeviceContext1* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static FORCEINLINE D2D1_ANTIALIAS_MODE ID2D1DeviceContext1_GetAntialiasMode(ID2D1DeviceContext1* This) {
    return This->lpVtbl->GetAntialiasMode(This);
}
static FORCEINLINE void ID2D1DeviceContext1_SetTextAntialiasMode(ID2D1DeviceContext1* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static FORCEINLINE D2D1_TEXT_ANTIALIAS_MODE ID2D1DeviceContext1_GetTextAntialiasMode(ID2D1DeviceContext1* This) {
    return This->lpVtbl->GetTextAntialiasMode(This);
}
static FORCEINLINE void ID2D1DeviceContext1_SetTextRenderingParams(ID2D1DeviceContext1* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static FORCEINLINE void ID2D1DeviceContext1_GetTextRenderingParams(ID2D1DeviceContext1* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
static FORCEINLINE void ID2D1DeviceContext1_SetTags(ID2D1DeviceContext1* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    This->lpVtbl->SetTags(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext1_GetTags(ID2D1DeviceContext1* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    This->lpVtbl->GetTags(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext1_PopLayer(ID2D1DeviceContext1* This) {
    This->lpVtbl->PopLayer(This);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_Flush(ID2D1DeviceContext1* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->Flush(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext1_SaveDrawingState(ID2D1DeviceContext1* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->SaveDrawingState(This,state_block);
}
static FORCEINLINE void ID2D1DeviceContext1_RestoreDrawingState(ID2D1DeviceContext1* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->RestoreDrawingState(This,state_block);
}
static FORCEINLINE void ID2D1DeviceContext1_PushAxisAlignedClip(ID2D1DeviceContext1* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static FORCEINLINE void ID2D1DeviceContext1_PopAxisAlignedClip(ID2D1DeviceContext1* This) {
    This->lpVtbl->PopAxisAlignedClip(This);
}
static FORCEINLINE void ID2D1DeviceContext1_Clear(ID2D1DeviceContext1* This,const D2D1_COLOR_F *color) {
    This->lpVtbl->Clear(This,color);
}
static FORCEINLINE void ID2D1DeviceContext1_BeginDraw(ID2D1DeviceContext1* This) {
    This->lpVtbl->BeginDraw(This);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_EndDraw(ID2D1DeviceContext1* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->EndDraw(This,tag1,tag2);
}
static FORCEINLINE D2D1_PIXEL_FORMAT ID2D1DeviceContext1_GetPixelFormat(ID2D1DeviceContext1* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static FORCEINLINE void ID2D1DeviceContext1_SetDpi(ID2D1DeviceContext1* This,float dpi_x,float dpi_y) {
    This->lpVtbl->SetDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE void ID2D1DeviceContext1_GetDpi(ID2D1DeviceContext1* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE D2D1_SIZE_F ID2D1DeviceContext1_GetSize(ID2D1DeviceContext1* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static FORCEINLINE D2D1_SIZE_U ID2D1DeviceContext1_GetPixelSize(ID2D1DeviceContext1* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static FORCEINLINE UINT32 ID2D1DeviceContext1_GetMaximumBitmapSize(ID2D1DeviceContext1* This) {
    return This->lpVtbl->GetMaximumBitmapSize(This);
}
static FORCEINLINE BOOL ID2D1DeviceContext1_IsSupported(ID2D1DeviceContext1* This,const D2D1_RENDER_TARGET_PROPERTIES *desc) {
    return This->lpVtbl->IsSupported(This,desc);
}
/*** ID2D1DeviceContext methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateBitmap(ID2D1DeviceContext1* This,D2D1_SIZE_U size,const void *src_data,UINT32 pitch,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmap(This,size,src_data,pitch,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateBitmapFromWicBitmap(ID2D1DeviceContext1* This,IWICBitmapSource *bitmap_source,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(This,bitmap_source,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateColorContext(ID2D1DeviceContext1* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateColorContextFromFilename(ID2D1DeviceContext1* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateColorContextFromWicColorContext(ID2D1DeviceContext1* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateBitmapFromDxgiSurface(ID2D1DeviceContext1* This,IDXGISurface *surface,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->CreateBitmapFromDxgiSurface(This,surface,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateEffect(ID2D1DeviceContext1* This,REFCLSID effect_id,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,effect_id,effect);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateGradientStopCollection(ID2D1DeviceContext1* This,const D2D1_GRADIENT_STOP *stops,UINT32 stop_count,D2D1_COLOR_SPACE preinterpolation_space,D2D1_COLOR_SPACE postinterpolation_space,D2D1_BUFFER_PRECISION buffer_precision,D2D1_EXTEND_MODE extend_mode,D2D1_COLOR_INTERPOLATION_MODE color_interpolation_mode,ID2D1GradientStopCollection1 **gradient) {
...
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateImageBrush(ID2D1DeviceContext1* This,ID2D1Image *image,const D2D1_IMAGE_BRUSH_PROPERTIES *image_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1ImageBrush **brush) {
    return This->lpVtbl->CreateImageBrush(This,image,image_brush_desc,brush_desc,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateBitmapBrush(ID2D1DeviceContext1* This,ID2D1Bitmap *bitmap,const D2D1_BITMAP_BRUSH_PROPERTIES1 *bitmap_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1BitmapBrush1 **bitmap_brush) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(This,bitmap,bitmap_brush_desc,brush_desc,bitmap_brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateCommandList(ID2D1DeviceContext1* This,ID2D1CommandList **command_list) {
    return This->lpVtbl->CreateCommandList(This,command_list);
}
static FORCEINLINE BOOL ID2D1DeviceContext1_IsDxgiFormatSupported(ID2D1DeviceContext1* This,DXGI_FORMAT format) {
    return This->lpVtbl->IsDxgiFormatSupported(This,format);
}
static FORCEINLINE BOOL ID2D1DeviceContext1_IsBufferPrecisionSupported(ID2D1DeviceContext1* This,D2D1_BUFFER_PRECISION buffer_precision) {
    return This->lpVtbl->IsBufferPrecisionSupported(This,buffer_precision);
}
static FORCEINLINE void ID2D1DeviceContext1_GetImageLocalBounds(ID2D1DeviceContext1* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
    This->lpVtbl->GetImageLocalBounds(This,image,local_bounds);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_GetImageWorldBounds(ID2D1DeviceContext1* This,ID2D1Image *image,D2D1_RECT_F *world_bounds) {
    return This->lpVtbl->GetImageWorldBounds(This,image,world_bounds);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_GetGlyphRunWorldBounds(ID2D1DeviceContext1* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGlyphRunWorldBounds(This,baseline_origin,glyph_run,measuring_mode,bounds);
}
static FORCEINLINE void ID2D1DeviceContext1_GetDevice(ID2D1DeviceContext1* This,ID2D1Device **device) {
    This->lpVtbl->GetDevice(This,device);
}
static FORCEINLINE void ID2D1DeviceContext1_SetTarget(ID2D1DeviceContext1* This,ID2D1Image *target) {
    This->lpVtbl->SetTarget(This,target);
}
static FORCEINLINE void ID2D1DeviceContext1_GetTarget(ID2D1DeviceContext1* This,ID2D1Image **target) {
    This->lpVtbl->GetTarget(This,target);
}
static FORCEINLINE void ID2D1DeviceContext1_SetRenderingControls(ID2D1DeviceContext1* This,const D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->SetRenderingControls(This,rendering_controls);
}
static FORCEINLINE void ID2D1DeviceContext1_GetRenderingControls(ID2D1DeviceContext1* This,D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->GetRenderingControls(This,rendering_controls);
}
static FORCEINLINE void ID2D1DeviceContext1_SetPrimitiveBlend(ID2D1DeviceContext1* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static FORCEINLINE D2D1_PRIMITIVE_BLEND ID2D1DeviceContext1_GetPrimitiveBlend(ID2D1DeviceContext1* This) {
    return This->lpVtbl->GetPrimitiveBlend(This);
}
static FORCEINLINE void ID2D1DeviceContext1_SetUnitMode(ID2D1DeviceContext1* This,D2D1_UNIT_MODE unit_mode) {
    This->lpVtbl->SetUnitMode(This,unit_mode);
}
static FORCEINLINE D2D1_UNIT_MODE ID2D1DeviceContext1_GetUnitMode(ID2D1DeviceContext1* This) {
    return This->lpVtbl->GetUnitMode(This);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawGlyphRun(ID2D1DeviceContext1* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawImage(ID2D1DeviceContext1* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawGdiMetafile(ID2D1DeviceContext1* This,ID2D1GdiMetafile *metafile,const D2D1_POINT_2F *target_offset) {
    This->lpVtbl->DrawGdiMetafile(This,metafile,target_offset);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawBitmap(ID2D1DeviceContext1* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    This->lpVtbl->ID2D1DeviceContext_DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static FORCEINLINE void ID2D1DeviceContext1_PushLayer(ID2D1DeviceContext1* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    This->lpVtbl->ID2D1DeviceContext_PushLayer(This,layer_parameters,layer);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_InvalidateEffectInputRectangle(ID2D1DeviceContext1* This,ID2D1Effect *effect,UINT32 input,const D2D1_RECT_F *input_rect) {
    return This->lpVtbl->InvalidateEffectInputRectangle(This,effect,input,input_rect);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_GetEffectInvalidRectangleCount(ID2D1DeviceContext1* This,ID2D1Effect *effect,UINT32 *rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangleCount(This,effect,rect_count);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_GetEffectInvalidRectangles(ID2D1DeviceContext1* This,ID2D1Effect *effect,D2D1_RECT_F *rectangles,UINT32 rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangles(This,effect,rectangles,rect_count);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_GetEffectRequiredInputRectangles(ID2D1DeviceContext1* This,ID2D1Effect *effect,const D2D1_RECT_F *image_rect,const D2D1_EFFECT_INPUT_DESCRIPTION *desc,D2D1_RECT_F *input_rect,UINT32 input_count) {
    return This->lpVtbl->GetEffectRequiredInputRectangles(This,effect,image_rect,desc,input_rect,input_count);
}
static FORCEINLINE void ID2D1DeviceContext1_FillOpacityMask(ID2D1DeviceContext1* This,ID2D1Bitmap *mask,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext_FillOpacityMask(This,mask,brush,dst_rect,src_rect);
}
/*** ID2D1DeviceContext1 methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateFilledGeometryRealization(ID2D1DeviceContext1* This,ID2D1Geometry *geometry,float tolerance,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateFilledGeometryRealization(This,geometry,tolerance,realization);
}
static FORCEINLINE HRESULT ID2D1DeviceContext1_CreateStrokedGeometryRealization(ID2D1DeviceContext1* This,ID2D1Geometry *geometry,float tolerance,float stroke_width,ID2D1StrokeStyle *stroke_style,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateStrokedGeometryRealization(This,geometry,tolerance,stroke_width,stroke_style,realization);
}
static FORCEINLINE void ID2D1DeviceContext1_DrawGeometryRealization(ID2D1DeviceContext1* This,ID2D1GeometryRealization *realization,ID2D1Brush *brush) {
