/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/mpegtype.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMpegAudioDecoder_QueryInterface(IMpegAudioDecoder* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMpegAudioDecoder_AddRef(IMpegAudioDecoder* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMpegAudioDecoder_Release(IMpegAudioDecoder* This) {
    return This->lpVtbl->Release(This);
}
/*** IMpegAudioDecoder methods ***/
static FORCEINLINE HRESULT IMpegAudioDecoder_get_FrequencyDivider(IMpegAudioDecoder* This,ULONG *divider) {
    return This->lpVtbl->get_FrequencyDivider(This,divider);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_FrequencyDivider(IMpegAudioDecoder* This,ULONG divider) {
    return This->lpVtbl->put_FrequencyDivider(This,divider);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_DecoderAccuracy(IMpegAudioDecoder* This,ULONG *accuracy) {
    return This->lpVtbl->get_DecoderAccuracy(This,accuracy);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_DecoderAccuracy(IMpegAudioDecoder* This,ULONG accuracy) {
    return This->lpVtbl->put_DecoderAccuracy(This,accuracy);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_Stereo(IMpegAudioDecoder* This,ULONG *stereo) {
    return This->lpVtbl->get_Stereo(This,stereo);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_Stereo(IMpegAudioDecoder* This,ULONG stereo) {
    return This->lpVtbl->put_Stereo(This,stereo);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_DecoderWordSize(IMpegAudioDecoder* This,ULONG *word_size) {
    return This->lpVtbl->get_DecoderWordSize(This,word_size);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_DecoderWordSize(IMpegAudioDecoder* This,ULONG word_size) {
    return This->lpVtbl->put_DecoderWordSize(This,word_size);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_IntegerDecode(IMpegAudioDecoder* This,ULONG *integer_decode) {
    return This->lpVtbl->get_IntegerDecode(This,integer_decode);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_IntegerDecode(IMpegAudioDecoder* This,ULONG integer_decode) {
    return This->lpVtbl->put_IntegerDecode(This,integer_decode);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_DualMode(IMpegAudioDecoder* This,ULONG *dual_mode) {
    return This->lpVtbl->get_DualMode(This,dual_mode);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_put_DualMode(IMpegAudioDecoder* This,ULONG dual_mode) {
    return This->lpVtbl->put_DualMode(This,dual_mode);
}
static FORCEINLINE HRESULT IMpegAudioDecoder_get_AudioFormat(IMpegAudioDecoder* This,MPEG1WAVEFORMAT *format) {
