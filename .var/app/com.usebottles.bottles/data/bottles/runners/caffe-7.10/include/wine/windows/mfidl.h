/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/mfidl.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFTopologyNodeAttributeEditor_QueryInterface(IMFTopologyNodeAttributeEditor* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFTopologyNodeAttributeEditor_AddRef(IMFTopologyNodeAttributeEditor* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFTopologyNodeAttributeEditor_Release(IMFTopologyNodeAttributeEditor* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFTopologyNodeAttributeEditor methods ***/
static FORCEINLINE HRESULT IMFTopologyNodeAttributeEditor_UpdateNodeAttributes(IMFTopologyNodeAttributeEditor* This,TOPOID id,DWORD count,MFTOPONODE_ATTRIBUTE_UPDATE *attr_updates) {
...
/*** IMFMetadata methods ***/
static FORCEINLINE HRESULT IMFMetadata_SetLanguage(IMFMetadata* This,const WCHAR *lang) {
    return This->lpVtbl->SetLanguage(This,lang);
}
static FORCEINLINE HRESULT IMFMetadata_GetLanguage(IMFMetadata* This,WCHAR **lang) {
    return This->lpVtbl->GetLanguage(This,lang);
}
static FORCEINLINE HRESULT IMFMetadata_GetAllLanguages(IMFMetadata* This,PROPVARIANT *languages) {
    return This->lpVtbl->GetAllLanguages(This,languages);
}
static FORCEINLINE HRESULT IMFMetadata_SetProperty(IMFMetadata* This,const WCHAR *name,const PROPVARIANT *values) {
    return This->lpVtbl->SetProperty(This,name,values);
}
static FORCEINLINE HRESULT IMFMetadata_GetProperty(IMFMetadata* This,const WCHAR *name,PROPVARIANT *values) {
    return This->lpVtbl->GetProperty(This,name,values);
}
static FORCEINLINE HRESULT IMFMetadata_DeleteProperty(IMFMetadata* This,const WCHAR *name) {
    return This->lpVtbl->DeleteProperty(This,name);
}
static FORCEINLINE HRESULT IMFMetadata_GetAllPropertyNames(IMFMetadata* This,PROPVARIANT *names) {
...
/*** IMFMetadataProvider methods ***/
static FORCEINLINE HRESULT IMFMetadataProvider_GetMFMetadata(IMFMetadataProvider* This,IMFPresentationDescriptor *descriptor,DWORD identifier,DWORD flags,IMFMetadata **metadata) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFSeekInfo_QueryInterface(IMFSeekInfo* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFSeekInfo_AddRef(IMFSeekInfo* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFSeekInfo_Release(IMFSeekInfo* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFSeekInfo methods ***/
static FORCEINLINE HRESULT IMFSeekInfo_GetNearestKeyFrames(IMFSeekInfo* This,const GUID *format,const PROPVARIANT *position,PROPVARIANT *prev_frame,PROPVARIANT *next_frame) {
...
/*** IMFMediaSource methods ***/
static FORCEINLINE HRESULT IMFMediaSourceEx_GetCharacteristics(IMFMediaSourceEx* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static FORCEINLINE HRESULT IMFMediaSourceEx_CreatePresentationDescriptor(IMFMediaSourceEx* This,IMFPresentationDescriptor **descriptor) {
    return This->lpVtbl->CreatePresentationDescriptor(This,descriptor);
}
static FORCEINLINE HRESULT IMFMediaSourceEx_Start(IMFMediaSourceEx* This,IMFPresentationDescriptor *descriptor,const GUID *time_format,const PROPVARIANT *start_position) {
    return This->lpVtbl->Start(This,descriptor,time_format,start_position);
}
...
/*** IMFMediaSourceEx methods ***/
static FORCEINLINE HRESULT IMFMediaSourceEx_GetSourceAttributes(IMFMediaSourceEx* This,IMFAttributes **attributes) {
    return This->lpVtbl->GetSourceAttributes(This,attributes);
}
static FORCEINLINE HRESULT IMFMediaSourceEx_GetStreamAttributes(IMFMediaSourceEx* This,DWORD streamid,IMFAttributes **attributes) {
    return This->lpVtbl->GetStreamAttributes(This,streamid,attributes);
}
static FORCEINLINE HRESULT IMFMediaSourceEx_SetD3DManager(IMFMediaSourceEx* This,IUnknown *manager) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFClockConsumer_QueryInterface(IMFClockConsumer* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFClockConsumer_AddRef(IMFClockConsumer* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFClockConsumer_Release(IMFClockConsumer* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFClockConsumer methods ***/
static FORCEINLINE HRESULT IMFClockConsumer_SetPresentationClock(IMFClockConsumer* This,IMFPresentationClock *clock) {
    return This->lpVtbl->SetPresentationClock(This,clock);
}
static FORCEINLINE HRESULT IMFClockConsumer_GetPresentationClock(IMFClockConsumer* This,IMFPresentationClock **clock) {
...
/*** IMFMediaSink methods ***/
static FORCEINLINE HRESULT IMFFinalizableMediaSink_GetCharacteristics(IMFFinalizableMediaSink* This,DWORD *characteristics) {
    return This->lpVtbl->GetCharacteristics(This,characteristics);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_AddStreamSink(IMFFinalizableMediaSink* This,DWORD stream_sink_id,IMFMediaType *media_type,IMFStreamSink **stream_sink) {
    return This->lpVtbl->AddStreamSink(This,stream_sink_id,media_type,stream_sink);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_RemoveStreamSink(IMFFinalizableMediaSink* This,DWORD stream_sink_id) {
    return This->lpVtbl->RemoveStreamSink(This,stream_sink_id);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_GetStreamSinkCount(IMFFinalizableMediaSink* This,DWORD *count) {
    return This->lpVtbl->GetStreamSinkCount(This,count);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_GetStreamSinkByIndex(IMFFinalizableMediaSink* This,DWORD index,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkByIndex(This,index,sink);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_GetStreamSinkById(IMFFinalizableMediaSink* This,DWORD stream_sink_id,IMFStreamSink **sink) {
    return This->lpVtbl->GetStreamSinkById(This,stream_sink_id,sink);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_SetPresentationClock(IMFFinalizableMediaSink* This,IMFPresentationClock *clock) {
    return This->lpVtbl->SetPresentationClock(This,clock);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_GetPresentationClock(IMFFinalizableMediaSink* This,IMFPresentationClock **clock) {
    return This->lpVtbl->GetPresentationClock(This,clock);
}
...
/*** IMFFinalizableMediaSink methods ***/
static FORCEINLINE HRESULT IMFFinalizableMediaSink_BeginFinalize(IMFFinalizableMediaSink* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginFinalize(This,callback,state);
}
static FORCEINLINE HRESULT IMFFinalizableMediaSink_EndFinalize(IMFFinalizableMediaSink* This,IMFAsyncResult *result) {
...
/*** IMFMediaSinkPreroll methods ***/
static FORCEINLINE HRESULT IMFMediaSinkPreroll_NotifyPreroll(IMFMediaSinkPreroll* This,MFTIME start_time) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFStreamingSinkConfig_QueryInterface(IMFStreamingSinkConfig* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFStreamingSinkConfig_AddRef(IMFStreamingSinkConfig* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFStreamingSinkConfig_Release(IMFStreamingSinkConfig* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFStreamingSinkConfig methods ***/
static FORCEINLINE HRESULT IMFStreamingSinkConfig_StartStreaming(IMFStreamingSinkConfig* This,BOOL is_byte_offset,QWORD seek_offset) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFQualityAdvise_QueryInterface(IMFQualityAdvise* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFQualityAdvise_AddRef(IMFQualityAdvise* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFQualityAdvise_Release(IMFQualityAdvise* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdvise methods ***/
static FORCEINLINE HRESULT IMFQualityAdvise_SetDropMode(IMFQualityAdvise* This,MF_QUALITY_DROP_MODE mode) {
    return This->lpVtbl->SetDropMode(This,mode);
}
static FORCEINLINE HRESULT IMFQualityAdvise_SetQualityLevel(IMFQualityAdvise* This,MF_QUALITY_LEVEL level) {
    return This->lpVtbl->SetQualityLevel(This,level);
}
static FORCEINLINE HRESULT IMFQualityAdvise_GetDropMode(IMFQualityAdvise* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetDropMode(This,mode);
}
static FORCEINLINE HRESULT IMFQualityAdvise_GetQualityLevel(IMFQualityAdvise* This,MF_QUALITY_LEVEL *level) {
    return This->lpVtbl->GetQualityLevel(This,level);
}
static FORCEINLINE HRESULT IMFQualityAdvise_DropTime(IMFQualityAdvise* This,LONGLONG interval) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFQualityAdvise2_QueryInterface(IMFQualityAdvise2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFQualityAdvise2_AddRef(IMFQualityAdvise2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFQualityAdvise2_Release(IMFQualityAdvise2* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdvise methods ***/
static FORCEINLINE HRESULT IMFQualityAdvise2_SetDropMode(IMFQualityAdvise2* This,MF_QUALITY_DROP_MODE mode) {
    return This->lpVtbl->SetDropMode(This,mode);
}
static FORCEINLINE HRESULT IMFQualityAdvise2_SetQualityLevel(IMFQualityAdvise2* This,MF_QUALITY_LEVEL level) {
    return This->lpVtbl->SetQualityLevel(This,level);
}
static FORCEINLINE HRESULT IMFQualityAdvise2_GetDropMode(IMFQualityAdvise2* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetDropMode(This,mode);
}
static FORCEINLINE HRESULT IMFQualityAdvise2_GetQualityLevel(IMFQualityAdvise2* This,MF_QUALITY_LEVEL *level) {
    return This->lpVtbl->GetQualityLevel(This,level);
}
static FORCEINLINE HRESULT IMFQualityAdvise2_DropTime(IMFQualityAdvise2* This,LONGLONG interval) {
    return This->lpVtbl->DropTime(This,interval);
}
/*** IMFQualityAdvise2 methods ***/
static FORCEINLINE HRESULT IMFQualityAdvise2_NotifyQualityEvent(IMFQualityAdvise2* This,IMFMediaEvent *event,DWORD *flags) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFQualityAdviseLimits_QueryInterface(IMFQualityAdviseLimits* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFQualityAdviseLimits_AddRef(IMFQualityAdviseLimits* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFQualityAdviseLimits_Release(IMFQualityAdviseLimits* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFQualityAdviseLimits methods ***/
static FORCEINLINE HRESULT IMFQualityAdviseLimits_GetMaximumDropMode(IMFQualityAdviseLimits* This,MF_QUALITY_DROP_MODE *mode) {
    return This->lpVtbl->GetMaximumDropMode(This,mode);
}
static FORCEINLINE HRESULT IMFQualityAdviseLimits_GetMinimumQualityLevel(IMFQualityAdviseLimits* This,MF_QUALITY_LEVEL *level) {
...
/*** IMFTrackedSample methods ***/
static FORCEINLINE HRESULT IMFTrackedSample_SetAllocator(IMFTrackedSample* This,IMFAsyncCallback *sample_allocator,IUnknown *state) {
...
/*** IMFSimpleAudioVolume methods ***/
static FORCEINLINE HRESULT IMFSimpleAudioVolume_SetMasterVolume(IMFSimpleAudioVolume* This,float level) {
    return This->lpVtbl->SetMasterVolume(This,level);
}
static FORCEINLINE HRESULT IMFSimpleAudioVolume_GetMasterVolume(IMFSimpleAudioVolume* This,float *level) {
    return This->lpVtbl->GetMasterVolume(This,level);
}
static FORCEINLINE HRESULT IMFSimpleAudioVolume_SetMute(IMFSimpleAudioVolume* This,BOOL mute) {
    return This->lpVtbl->SetMute(This,mute);
}
static FORCEINLINE HRESULT IMFSimpleAudioVolume_GetMute(IMFSimpleAudioVolume* This,BOOL *mute) {
...
/*** IMFAudioStreamVolume methods ***/
static FORCEINLINE HRESULT IMFAudioStreamVolume_GetChannelCount(IMFAudioStreamVolume* This,UINT32 *count) {
    return This->lpVtbl->GetChannelCount(This,count);
}
static FORCEINLINE HRESULT IMFAudioStreamVolume_SetChannelVolume(IMFAudioStreamVolume* This,UINT32 index,const float level) {
    return This->lpVtbl->SetChannelVolume(This,index,level);
}
static FORCEINLINE HRESULT IMFAudioStreamVolume_GetChannelVolume(IMFAudioStreamVolume* This,UINT32 index,float *level) {
    return This->lpVtbl->GetChannelVolume(This,index,level);
}
static FORCEINLINE HRESULT IMFAudioStreamVolume_SetAllVolumes(IMFAudioStreamVolume* This,UINT32 count,const float *volumes) {
    return This->lpVtbl->SetAllVolumes(This,count,volumes);
}
static FORCEINLINE HRESULT IMFAudioStreamVolume_GetAllVolumes(IMFAudioStreamVolume* This,UINT32 count,float *volumes) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFAudioPolicy_QueryInterface(IMFAudioPolicy* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFAudioPolicy_AddRef(IMFAudioPolicy* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFAudioPolicy_Release(IMFAudioPolicy* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFAudioPolicy methods ***/
static FORCEINLINE HRESULT IMFAudioPolicy_SetGroupingParam(IMFAudioPolicy* This,REFGUID param) {
    return This->lpVtbl->SetGroupingParam(This,param);
}
static FORCEINLINE HRESULT IMFAudioPolicy_GetGroupingParam(IMFAudioPolicy* This,GUID *param) {
    return This->lpVtbl->GetGroupingParam(This,param);
}
static FORCEINLINE HRESULT IMFAudioPolicy_SetDisplayName(IMFAudioPolicy* This,LPCWSTR name) {
    return This->lpVtbl->SetDisplayName(This,name);
}
static FORCEINLINE HRESULT IMFAudioPolicy_GetDisplayName(IMFAudioPolicy* This,LPWSTR *name) {
    return This->lpVtbl->GetDisplayName(This,name);
}
static FORCEINLINE HRESULT IMFAudioPolicy_SetIconPath(IMFAudioPolicy* This,LPCWSTR path) {
    return This->lpVtbl->SetIconPath(This,path);
}
static FORCEINLINE HRESULT IMFAudioPolicy_GetIconPath(IMFAudioPolicy* This,LPWSTR *path) {
...
/*** IMFVideoSampleAllocator methods ***/
static FORCEINLINE HRESULT IMFVideoSampleAllocator_SetDirectXManager(IMFVideoSampleAllocator* This,IUnknown *manager) {
...
static FORCEINLINE HRESULT IMFVideoSampleAllocator_InitializeSampleAllocator(IMFVideoSampleAllocator* This,DWORD sample_count,IMFMediaType *media_type) {
    return This->lpVtbl->InitializeSampleAllocator(This,sample_count,media_type);
}
static FORCEINLINE HRESULT IMFVideoSampleAllocator_AllocateSample(IMFVideoSampleAllocator* This,IMFSample **sample) {
...
/*** IMFVideoSampleAllocatorNotifyEx methods ***/
static FORCEINLINE HRESULT IMFVideoSampleAllocatorNotifyEx_NotifyPrune(IMFVideoSampleAllocatorNotifyEx* This,IMFSample *sample) {
...
/*** IMFVideoSampleAllocatorCallback methods ***/
static FORCEINLINE HRESULT IMFVideoSampleAllocatorCallback_SetCallback(IMFVideoSampleAllocatorCallback* This,IMFVideoSampleAllocatorNotify *callback) {
    return This->lpVtbl->SetCallback(This,callback);
}
static FORCEINLINE HRESULT IMFVideoSampleAllocatorCallback_GetFreeSampleCount(IMFVideoSampleAllocatorCallback* This,LONG *count) {
...
/*** IMFVideoSampleAllocator methods ***/
static FORCEINLINE HRESULT IMFVideoSampleAllocatorEx_SetDirectXManager(IMFVideoSampleAllocatorEx* This,IUnknown *manager) {
    return This->lpVtbl->SetDirectXManager(This,manager);
}
static FORCEINLINE HRESULT IMFVideoSampleAllocatorEx_UninitializeSampleAllocator(IMFVideoSampleAllocatorEx* This) {
    return This->lpVtbl->UninitializeSampleAllocator(This);
}
static FORCEINLINE HRESULT IMFVideoSampleAllocatorEx_InitializeSampleAllocator(IMFVideoSampleAllocatorEx* This,DWORD sample_count,IMFMediaType *media_type) {
    return This->lpVtbl->InitializeSampleAllocator(This,sample_count,media_type);
}
static FORCEINLINE HRESULT IMFVideoSampleAllocatorEx_AllocateSample(IMFVideoSampleAllocatorEx* This,IMFSample **sample) {
    return This->lpVtbl->AllocateSample(This,sample);
}
/*** IMFVideoSampleAllocatorEx methods ***/
static FORCEINLINE HRESULT IMFVideoSampleAllocatorEx_InitializeSampleAllocatorEx(IMFVideoSampleAllocatorEx* This,DWORD initial_sample_count,DWORD max_sample_count,IMFAttributes *attributes,IMFMediaType *media_type) {
...
/*** IMFVideoProcessorControl methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetBorderColor(IMFVideoProcessorControl* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetSourceRectangle(IMFVideoProcessorControl* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetDestinationRectangle(IMFVideoProcessorControl* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetMirror(IMFVideoProcessorControl* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetRotation(IMFVideoProcessorControl* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl_SetConstrictionSize(IMFVideoProcessorControl* This,SIZE *size) {
...
/*** IMFVideoProcessorControl methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetBorderColor(IMFVideoProcessorControl2* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetSourceRectangle(IMFVideoProcessorControl2* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetDestinationRectangle(IMFVideoProcessorControl2* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetMirror(IMFVideoProcessorControl2* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetRotation(IMFVideoProcessorControl2* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetConstrictionSize(IMFVideoProcessorControl2* This,SIZE *size) {
    return This->lpVtbl->SetConstrictionSize(This,size);
}
/*** IMFVideoProcessorControl2 methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl2_SetRotationOverride(IMFVideoProcessorControl2* This,UINT rotation) {
    return This->lpVtbl->SetRotationOverride(This,rotation);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_EnableHardwareEffects(IMFVideoProcessorControl2* This,BOOL enabled) {
    return This->lpVtbl->EnableHardwareEffects(This,enabled);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl2_GetSupportedHardwareEffects(IMFVideoProcessorControl2* This,UINT *support) {
...
/*** IMFVideoProcessorControl methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetBorderColor(IMFVideoProcessorControl3* This,MFARGB *color) {
    return This->lpVtbl->SetBorderColor(This,color);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetSourceRectangle(IMFVideoProcessorControl3* This,RECT *rect) {
    return This->lpVtbl->SetSourceRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetDestinationRectangle(IMFVideoProcessorControl3* This,RECT *rect) {
    return This->lpVtbl->SetDestinationRectangle(This,rect);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetMirror(IMFVideoProcessorControl3* This,MF_VIDEO_PROCESSOR_MIRROR mirror) {
    return This->lpVtbl->SetMirror(This,mirror);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetRotation(IMFVideoProcessorControl3* This,MF_VIDEO_PROCESSOR_ROTATION rotation) {
    return This->lpVtbl->SetRotation(This,rotation);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetConstrictionSize(IMFVideoProcessorControl3* This,SIZE *size) {
    return This->lpVtbl->SetConstrictionSize(This,size);
}
/*** IMFVideoProcessorControl2 methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetRotationOverride(IMFVideoProcessorControl3* This,UINT rotation) {
    return This->lpVtbl->SetRotationOverride(This,rotation);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_EnableHardwareEffects(IMFVideoProcessorControl3* This,BOOL enabled) {
    return This->lpVtbl->EnableHardwareEffects(This,enabled);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_GetSupportedHardwareEffects(IMFVideoProcessorControl3* This,UINT *support) {
    return This->lpVtbl->GetSupportedHardwareEffects(This,support);
}
/*** IMFVideoProcessorControl3 methods ***/
static FORCEINLINE HRESULT IMFVideoProcessorControl3_GetNaturalOutputType(IMFVideoProcessorControl3* This,IMFMediaType **media_type) {
    return This->lpVtbl->GetNaturalOutputType(This,media_type);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_EnableSphericalVideoProcessing(IMFVideoProcessorControl3* This,BOOL enable,MFVideoSphericalFormat format,MFVideoSphericalProjectionMode projection_mode) {
    return This->lpVtbl->EnableSphericalVideoProcessing(This,enable,format,projection_mode);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetSphericalVideoProperties(IMFVideoProcessorControl3* This,float x,float y,float z,float w,float fov) {
    return This->lpVtbl->SetSphericalVideoProperties(This,x,y,z,w,fov);
}
static FORCEINLINE HRESULT IMFVideoProcessorControl3_SetOutputDevice(IMFVideoProcessorControl3* This,IUnknown *output_device) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFRealTimeClient_QueryInterface(IMFRealTimeClient* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFRealTimeClient_AddRef(IMFRealTimeClient* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFRealTimeClient_Release(IMFRealTimeClient* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFRealTimeClient methods ***/
static FORCEINLINE HRESULT IMFRealTimeClient_RegisterThreads(IMFRealTimeClient* This,DWORD task_index,LPCWSTR classname) {
    return This->lpVtbl->RegisterThreads(This,task_index,classname);
}
static FORCEINLINE HRESULT IMFRealTimeClient_UnregisterThreads(IMFRealTimeClient* This) {
    return This->lpVtbl->UnregisterThreads(This);
}
static FORCEINLINE HRESULT IMFRealTimeClient_SetWorkQueue(IMFRealTimeClient* This,DWORD queue_id) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFRealTimeClientEx_QueryInterface(IMFRealTimeClientEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFRealTimeClientEx_AddRef(IMFRealTimeClientEx* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFRealTimeClientEx_Release(IMFRealTimeClientEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFRealTimeClientEx methods ***/
static FORCEINLINE HRESULT IMFRealTimeClientEx_RegisterThreadsEx(IMFRealTimeClientEx* This,DWORD *task_index,LPCWSTR classname,LONG basepriority) {
    return This->lpVtbl->RegisterThreadsEx(This,task_index,classname,basepriority);
}
static FORCEINLINE HRESULT IMFRealTimeClientEx_UnregisterThreads(IMFRealTimeClientEx* This) {
    return This->lpVtbl->UnregisterThreads(This);
}
static FORCEINLINE HRESULT IMFRealTimeClientEx_SetWorkQueueEx(IMFRealTimeClientEx* This,DWORD mtqueue_id,LONG base_priority) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFWorkQueueServices_QueryInterface(IMFWorkQueueServices* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFWorkQueueServices_AddRef(IMFWorkQueueServices* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFWorkQueueServices_Release(IMFWorkQueueServices* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFWorkQueueServices methods ***/
static FORCEINLINE HRESULT IMFWorkQueueServices_BeginRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_EndRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndRegisterTopologyWorkQueuesWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_BeginUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_EndUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterTopologyWorkQueuesWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_GetTopologyWorkQueueMMCSSClass(IMFWorkQueueServices* This,DWORD queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSClass(This,queue,classname,classname_len);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_GetTopologyWorkQueueMMCSSTaskId(IMFWorkQueueServices* This,DWORD queue,DWORD *taksid) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSTaskId(This,queue,taksid);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_BeginRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterPlatformWorkQueueWithMMCSS(This,platform_queue,classname,taskid,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_EndRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result,DWORD *taskid) {
    return This->lpVtbl->EndRegisterPlatformWorkQueueWithMMCSS(This,result,taskid);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_BeginUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,DWORD platform_queue,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterPlatformWorkQueueWithMMCSS(This,platform_queue,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_EndUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServices* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterPlatformWorkQueueWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_GetPlaftormWorkQueueMMCSSClass(IMFWorkQueueServices* This,DWORD platform_queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetPlaftormWorkQueueMMCSSClass(This,platform_queue,classname,classname_len);
}
static FORCEINLINE HRESULT IMFWorkQueueServices_GetPlatformWorkQueueMMCSSTaskId(IMFWorkQueueServices* This,DWORD platform_queue,DWORD *taskid) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_QueryInterface(IMFWorkQueueServicesEx* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMFWorkQueueServicesEx_AddRef(IMFWorkQueueServicesEx* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMFWorkQueueServicesEx_Release(IMFWorkQueueServicesEx* This) {
    return This->lpVtbl->Release(This);
}
/*** IMFWorkQueueServices methods ***/
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_BeginRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_EndRegisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndRegisterTopologyWorkQueuesWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_BeginUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterTopologyWorkQueuesWithMMCSS(This,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_EndUnregisterTopologyWorkQueuesWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterTopologyWorkQueuesWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSClass(IMFWorkQueueServicesEx* This,DWORD queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSClass(This,queue,classname,classname_len);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSTaskId(IMFWorkQueueServicesEx* This,DWORD queue,DWORD *taksid) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSTaskId(This,queue,taksid);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_BeginRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginRegisterPlatformWorkQueueWithMMCSS(This,platform_queue,classname,taskid,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_EndRegisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result,DWORD *taskid) {
    return This->lpVtbl->EndRegisterPlatformWorkQueueWithMMCSS(This,result,taskid);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_BeginUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,DWORD platform_queue,IMFAsyncCallback *callback,IUnknown *state) {
    return This->lpVtbl->BeginUnregisterPlatformWorkQueueWithMMCSS(This,platform_queue,callback,state);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_EndUnregisterPlatformWorkQueueWithMMCSS(IMFWorkQueueServicesEx* This,IMFAsyncResult *result) {
    return This->lpVtbl->EndUnregisterPlatformWorkQueueWithMMCSS(This,result);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetPlaftormWorkQueueMMCSSClass(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPWSTR classname,DWORD *classname_len) {
    return This->lpVtbl->GetPlaftormWorkQueueMMCSSClass(This,platform_queue,classname,classname_len);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetPlatformWorkQueueMMCSSTaskId(IMFWorkQueueServicesEx* This,DWORD platform_queue,DWORD *taskid) {
    return This->lpVtbl->GetPlatformWorkQueueMMCSSTaskId(This,platform_queue,taskid);
}
/*** IMFWorkQueueServicesEx methods ***/
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetTopologyWorkQueueMMCSSPriority(IMFWorkQueueServicesEx* This,DWORD queueid,LONG *priority) {
    return This->lpVtbl->GetTopologyWorkQueueMMCSSPriority(This,queueid,priority);
}
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_BeginRegisterPlatformWorkQueueWithMMCSSEx(IMFWorkQueueServicesEx* This,DWORD platform_queue,LPCWSTR classname,DWORD taskid,LONG priority,IMFAsyncCallback *callback,IUnknown *state) {
...
static FORCEINLINE HRESULT IMFWorkQueueServicesEx_GetPlatformWorkQueueMMCSSPriority(IMFWorkQueueServicesEx* This,DWORD platform_queue,LONG *priority) {
