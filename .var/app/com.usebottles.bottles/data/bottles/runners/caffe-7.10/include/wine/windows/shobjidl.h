/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/shobjidl.idl - Do not edit ***/
...
/*** IParentAndItem methods ***/
static FORCEINLINE HRESULT IParentAndItem_SetParentAndItem(IParentAndItem* This,PCIDLIST_ABSOLUTE parent,IShellFolder *folder,PCUITEMID_CHILD child) {
    return This->lpVtbl->SetParentAndItem(This,parent,folder,child);
}
static FORCEINLINE HRESULT IParentAndItem_GetParentAndItem(IParentAndItem* This,PIDLIST_ABSOLUTE *parent,IShellFolder **folder,PITEMID_CHILD *child) {
...
static FORCEINLINE HRESULT IApplicationDocumentLists_GetList(IApplicationDocumentLists* This,APPDOCLISTTYPE list_type,UINT item_count,REFIID riid,void **ppv) {
...
/*** IOperationsProgressDialog methods ***/
static FORCEINLINE HRESULT IOperationsProgressDialog_StartProgressDialog(IOperationsProgressDialog* This,HWND owner,OPPROGDLGF flags) {
...
static FORCEINLINE HRESULT IOperationsProgressDialog_UpdateProgress(IOperationsProgressDialog* This,ULONGLONG current_points,ULONGLONG total_points,ULONGLONG current_size,ULONGLONG total_size,ULONGLONG current_item,ULONGLONG total_item) {
    return This->lpVtbl->UpdateProgress(This,current_points,total_points,current_size,total_size,current_item,total_item);
}
static FORCEINLINE HRESULT IOperationsProgressDialog_UpdateLocations(IOperationsProgressDialog* This,IShellItem *source,IShellItem *target,IShellItem *item) {
...
static FORCEINLINE HRESULT IOperationsProgressDialog_GetMilliseconds(IOperationsProgressDialog* This,ULONGLONG *elapsed,ULONGLONG *remaining) {
    return This->lpVtbl->GetMilliseconds(This,elapsed,remaining);
}
static FORCEINLINE HRESULT IOperationsProgressDialog_GetOperationStatus(IOperationsProgressDialog* This,PDOPSTATUS *status) {
...
/*** IFileOperation methods ***/
static FORCEINLINE HRESULT IFileOperation_Advise(IFileOperation* This,IFileOperationProgressSink *sink,DWORD *cookie) {
    return This->lpVtbl->Advise(This,sink,cookie);
}
static FORCEINLINE HRESULT IFileOperation_Unadvise(IFileOperation* This,DWORD cookie) {
    return This->lpVtbl->Unadvise(This,cookie);
}
static FORCEINLINE HRESULT IFileOperation_SetOperationFlags(IFileOperation* This,DWORD flags) {
    return This->lpVtbl->SetOperationFlags(This,flags);
}
static FORCEINLINE HRESULT IFileOperation_SetProgressMessage(IFileOperation* This,LPCWSTR message) {
    return This->lpVtbl->SetProgressMessage(This,message);
}
static FORCEINLINE HRESULT IFileOperation_SetProgressDialog(IFileOperation* This,IOperationsProgressDialog *dialog) {
    return This->lpVtbl->SetProgressDialog(This,dialog);
}
static FORCEINLINE HRESULT IFileOperation_SetProperties(IFileOperation* This,IPropertyChangeArray *array) {
    return This->lpVtbl->SetProperties(This,array);
}
static FORCEINLINE HRESULT IFileOperation_SetOwnerWindow(IFileOperation* This,HWND owner) {
    return This->lpVtbl->SetOwnerWindow(This,owner);
}
static FORCEINLINE HRESULT IFileOperation_ApplyPropertiesToItem(IFileOperation* This,IShellItem *item) {
    return This->lpVtbl->ApplyPropertiesToItem(This,item);
}
static FORCEINLINE HRESULT IFileOperation_ApplyPropertiesToItems(IFileOperation* This,IUnknown *items) {
    return This->lpVtbl->ApplyPropertiesToItems(This,items);
}
static FORCEINLINE HRESULT IFileOperation_RenameItem(IFileOperation* This,IShellItem *item,LPCWSTR name,IFileOperationProgressSink *sink) {
    return This->lpVtbl->RenameItem(This,item,name,sink);
}
static FORCEINLINE HRESULT IFileOperation_RenameItems(IFileOperation* This,IUnknown *items,LPCWSTR name) {
    return This->lpVtbl->RenameItems(This,items,name);
}
static FORCEINLINE HRESULT IFileOperation_MoveItem(IFileOperation* This,IShellItem *item,IShellItem *folder,LPCWSTR name,IFileOperationProgressSink *sink) {
    return This->lpVtbl->MoveItem(This,item,folder,name,sink);
}
static FORCEINLINE HRESULT IFileOperation_MoveItems(IFileOperation* This,IUnknown *items,IShellItem *folder) {
    return This->lpVtbl->MoveItems(This,items,folder);
}
static FORCEINLINE HRESULT IFileOperation_CopyItem(IFileOperation* This,IShellItem *item,IShellItem *folder,LPCWSTR name,IFileOperationProgressSink *sink) {
    return This->lpVtbl->CopyItem(This,item,folder,name,sink);
}
static FORCEINLINE HRESULT IFileOperation_CopyItems(IFileOperation* This,IUnknown *items,IShellItem *folder) {
    return This->lpVtbl->CopyItems(This,items,folder);
}
static FORCEINLINE HRESULT IFileOperation_DeleteItem(IFileOperation* This,IShellItem *item,IFileOperationProgressSink *sink) {
    return This->lpVtbl->DeleteItem(This,item,sink);
}
static FORCEINLINE HRESULT IFileOperation_DeleteItems(IFileOperation* This,IUnknown *items) {
    return This->lpVtbl->DeleteItems(This,items);
}
static FORCEINLINE HRESULT IFileOperation_NewItem(IFileOperation* This,IShellItem *folder,DWORD attributes,LPCWSTR name,LPCWSTR template_name,IFileOperationProgressSink *sink) {
...
static FORCEINLINE HRESULT IFileOperation_GetAnyOperationsAborted(IFileOperation* This,BOOL *aborted) {
