/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/iads.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDirectoryObject_QueryInterface(IDirectoryObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDirectoryObject_AddRef(IDirectoryObject* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDirectoryObject_Release(IDirectoryObject* This) {
    return This->lpVtbl->Release(This);
}
/*** IDirectoryObject methods ***/
static FORCEINLINE HRESULT IDirectoryObject_GetObjectInformation(IDirectoryObject* This,PADS_OBJECT_INFO *info) {
    return This->lpVtbl->GetObjectInformation(This,info);
}
static FORCEINLINE HRESULT IDirectoryObject_GetObjectAttributes(IDirectoryObject* This,LPWSTR *names,DWORD count,PADS_ATTR_INFO *attrs,DWORD *count_returned) {
    return This->lpVtbl->GetObjectAttributes(This,names,count,attrs,count_returned);
}
static FORCEINLINE HRESULT IDirectoryObject_SetObjectAttributes(IDirectoryObject* This,PADS_ATTR_INFO attrs,DWORD count,DWORD *count_set) {
    return This->lpVtbl->SetObjectAttributes(This,attrs,count,count_set);
}
static FORCEINLINE HRESULT IDirectoryObject_CreateDSObject(IDirectoryObject* This,LPWSTR name,PADS_ATTR_INFO attrs,DWORD count,IDispatch **obj) {
    return This->lpVtbl->CreateDSObject(This,name,attrs,count,obj);
}
static FORCEINLINE HRESULT IDirectoryObject_DeleteDSObject(IDirectoryObject* This,LPWSTR name) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IADsOpenDSObject_QueryInterface(IADsOpenDSObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IADsOpenDSObject_AddRef(IADsOpenDSObject* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IADsOpenDSObject_Release(IADsOpenDSObject* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IADsOpenDSObject_GetTypeInfoCount(IADsOpenDSObject* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IADsOpenDSObject_GetTypeInfo(IADsOpenDSObject* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IADsOpenDSObject_GetIDsOfNames(IADsOpenDSObject* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IADsOpenDSObject_Invoke(IADsOpenDSObject* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IADsOpenDSObject methods ***/
static FORCEINLINE HRESULT IADsOpenDSObject_OpenDSObject(IADsOpenDSObject* This,BSTR path,BSTR user,BSTR password,LONG reserved,IDispatch **obj) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IADsPathname_QueryInterface(IADsPathname* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IADsPathname_AddRef(IADsPathname* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IADsPathname_Release(IADsPathname* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IADsPathname_GetTypeInfoCount(IADsPathname* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IADsPathname_GetTypeInfo(IADsPathname* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IADsPathname_GetIDsOfNames(IADsPathname* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IADsPathname_Invoke(IADsPathname* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IADsPathname methods ***/
static FORCEINLINE HRESULT IADsPathname_Set(IADsPathname* This,BSTR path,LONG type) {
    return This->lpVtbl->Set(This,path,type);
}
static FORCEINLINE HRESULT IADsPathname_SetDisplayType(IADsPathname* This,LONG type) {
    return This->lpVtbl->SetDisplayType(This,type);
}
static FORCEINLINE HRESULT IADsPathname_Retrieve(IADsPathname* This,LONG type,BSTR *path) {
    return This->lpVtbl->Retrieve(This,type,path);
}
static FORCEINLINE HRESULT IADsPathname_GetNumElements(IADsPathname* This,LONG *count) {
    return This->lpVtbl->GetNumElements(This,count);
}
static FORCEINLINE HRESULT IADsPathname_GetElement(IADsPathname* This,LONG index,BSTR *element) {
    return This->lpVtbl->GetElement(This,index,element);
}
static FORCEINLINE HRESULT IADsPathname_AddLeafElement(IADsPathname* This,BSTR element) {
    return This->lpVtbl->AddLeafElement(This,element);
}
static FORCEINLINE HRESULT IADsPathname_RemoveLeafElement(IADsPathname* This) {
    return This->lpVtbl->RemoveLeafElement(This);
}
static FORCEINLINE HRESULT IADsPathname_CopyPath(IADsPathname* This,IDispatch **path) {
    return This->lpVtbl->CopyPath(This,path);
}
static FORCEINLINE HRESULT IADsPathname_GetEscapedElement(IADsPathname* This,LONG reserved,BSTR element,BSTR *str) {
    return This->lpVtbl->GetEscapedElement(This,reserved,element,str);
}
static FORCEINLINE HRESULT IADsPathname_get_EscapedMode(IADsPathname* This,LONG *mode) {
    return This->lpVtbl->get_EscapedMode(This,mode);
}
static FORCEINLINE HRESULT IADsPathname_put_EscapedMode(IADsPathname* This,LONG mode) {
