/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/strmif.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IAMCrossbar_get_CrossbarPinInfo(IAMCrossbar* This,BOOL is_input,LONG index,LONG *related,LONG *type) {
...
static FORCEINLINE HRESULT IDvdControl_SubpictureStreamChange(IDvdControl* This,ULONG subpicture,BOOL enable) {
...
static FORCEINLINE HRESULT IDvdInfo_GetCurrentSubpicture(IDvdInfo* This,ULONG *count,ULONG *current,BOOL *enable) {
...
static FORCEINLINE HRESULT IDvdControl2_Pause(IDvdControl2* This,BOOL enable) {
...
static FORCEINLINE HRESULT IDvdControl2_SetSubpictureState(IDvdControl2* This,BOOL enable,DWORD flags,IDvdCmd **cmd) {
...
static FORCEINLINE HRESULT IDvdControl2_AcceptParentalLevelChange(IDvdControl2* This,BOOL accept) {
    return This->lpVtbl->AcceptParentalLevelChange(This,accept);
}
static FORCEINLINE HRESULT IDvdControl2_SetOption(IDvdControl2* This,DVD_OPTION_FLAG flag,BOOL option) {
...
static FORCEINLINE HRESULT IDvdInfo2_GetCurrentSubpicture(IDvdInfo2* This,ULONG *count,ULONG *current,BOOL *enable) {
    return This->lpVtbl->GetCurrentSubpicture(This,count,current,enable);
}
...
static FORCEINLINE HRESULT IDvdInfo2_IsAudioStreamEnabled(IDvdInfo2* This,ULONG stream,BOOL *enable) {
...
static FORCEINLINE HRESULT IDvdInfo2_IsSubpictureStreamEnabled(IDvdInfo2* This,ULONG stream,BOOL *enable) {
