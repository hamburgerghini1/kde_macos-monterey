/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/mfobjects.idl - Do not edit ***/
...
typedef struct __WIDL_mfobjects_generated_name_0000002D {
    WORD wFormatTag;
    WORD nChannels;
    DWORD nSamplesPerSec;
    DWORD nAvgBytesPerSec;
...
typedef struct __WIDL_mfobjects_generated_name_0000002D *PWAVEFORMATEXTENSIBLE;
typedef struct __WIDL_mfobjects_generated_name_0000002E {
    WAVEFORMATEX wfx;
    WORD fwHeadLayer;
    DWORD dwHeadBitrate;
    WORD fwHeadMode;
...
/*** IMF2DBuffer methods ***/
static FORCEINLINE HRESULT IMF2DBuffer2_Lock2D(IMF2DBuffer2* This,BYTE **pbScanline0,LONG *plPitch) {
    return This->lpVtbl->Lock2D(This,pbScanline0,plPitch);
}
...
static FORCEINLINE HRESULT IMF2DBuffer2_IsContiguousFormat(IMF2DBuffer2* This,BOOL *pfIsContiguous) {
    return This->lpVtbl->IsContiguousFormat(This,pfIsContiguous);
}
...
/*** IMF2DBuffer2 methods ***/
static FORCEINLINE HRESULT IMF2DBuffer2_Lock2DSize(IMF2DBuffer2* This,MF2DBuffer_LockFlags flags,BYTE **scanline0,LONG *pitch,BYTE **buffer_start,DWORD *buffer_length) {
    return This->lpVtbl->Lock2DSize(This,flags,scanline0,pitch,buffer_start,buffer_length);
}
static FORCEINLINE HRESULT IMF2DBuffer2_Copy2DTo(IMF2DBuffer2* This,IMF2DBuffer2 *dest_buffer) {
...
/*** IMFDXGIBuffer methods ***/
static FORCEINLINE HRESULT IMFDXGIBuffer_GetResource(IMFDXGIBuffer* This,REFIID riid,void **object) {
    return This->lpVtbl->GetResource(This,riid,object);
}
static FORCEINLINE HRESULT IMFDXGIBuffer_GetSubresourceIndex(IMFDXGIBuffer* This,UINT *index) {
    return This->lpVtbl->GetSubresourceIndex(This,index);
}
static FORCEINLINE HRESULT IMFDXGIBuffer_GetUnknown(IMFDXGIBuffer* This,REFIID guid,REFIID riid,void **object) {
    return This->lpVtbl->GetUnknown(This,guid,riid,object);
}
static FORCEINLINE HRESULT IMFDXGIBuffer_SetUnknown(IMFDXGIBuffer* This,REFIID guid,IUnknown *data) {
...
typedef struct __WIDL_mfobjects_generated_name_0000002F {
    GUID guidMajorType;
    GUID guidSubtype;
...
typedef enum __WIDL_mfobjects_generated_name_00000030 {
...
typedef enum __WIDL_mfobjects_generated_name_00000031 {
