/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/cdosys.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IDataSource_QueryInterface(IDataSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IDataSource_AddRef(IDataSource* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IDataSource_Release(IDataSource* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IDataSource_GetTypeInfoCount(IDataSource* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IDataSource_GetTypeInfo(IDataSource* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IDataSource_GetIDsOfNames(IDataSource* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IDataSource_Invoke(IDataSource* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IDataSource methods ***/
static FORCEINLINE HRESULT IDataSource_get_SourceClass(IDataSource* This,BSTR *source) {
    return This->lpVtbl->get_SourceClass(This,source);
}
static FORCEINLINE HRESULT IDataSource_Source(IDataSource* This,IUnknown **source) {
    return This->lpVtbl->Source(This,source);
}
static FORCEINLINE HRESULT IDataSource_get_IsDirty(IDataSource* This,VARIANT_BOOL *dirty) {
    return This->lpVtbl->get_IsDirty(This,dirty);
}
static FORCEINLINE HRESULT IDataSource_put_IsDirty(IDataSource* This,VARIANT_BOOL dirty) {
    return This->lpVtbl->put_IsDirty(This,dirty);
}
static FORCEINLINE HRESULT IDataSource_get_SourceURL(IDataSource* This,BSTR *url) {
    return This->lpVtbl->get_SourceURL(This,url);
}
static FORCEINLINE HRESULT IDataSource_get_ActiveConnection(IDataSource* This,_Connection **connection) {
    return This->lpVtbl->get_ActiveConnection(This,connection);
}
static FORCEINLINE HRESULT IDataSource_SaveToObject(IDataSource* This,IUnknown *source,BSTR iname) {
    return This->lpVtbl->SaveToObject(This,source,iname);
}
static FORCEINLINE HRESULT IDataSource_OpenObject(IDataSource* This,IUnknown *source,BSTR iname) {
    return This->lpVtbl->OpenObject(This,source,iname);
}
static FORCEINLINE HRESULT IDataSource_SaveTo(IDataSource* This,BSTR url,IDispatch *connection,ConnectModeEnum mode,RecordCreateOptionsEnum create,RecordOpenOptionsEnum options,BSTR username,BSTR password) {
    return This->lpVtbl->SaveTo(This,url,connection,mode,create,options,username,password);
}
static FORCEINLINE HRESULT IDataSource_Open(IDataSource* This,BSTR url,IDispatch *connection,ConnectModeEnum mode,RecordCreateOptionsEnum create,RecordOpenOptionsEnum options,BSTR username,BSTR password) {
    return This->lpVtbl->Open(This,url,connection,mode,create,options,username,password);
}
static FORCEINLINE HRESULT IDataSource_Save(IDataSource* This) {
    return This->lpVtbl->Save(This);
}
static FORCEINLINE HRESULT IDataSource_SaveToContainer(IDataSource* This,BSTR url,IDispatch *connection,ConnectModeEnum mode,RecordCreateOptionsEnum create,RecordOpenOptionsEnum options,BSTR username,BSTR password) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IBodyParts_QueryInterface(IBodyParts* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IBodyParts_AddRef(IBodyParts* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IBodyParts_Release(IBodyParts* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IBodyParts_GetTypeInfoCount(IBodyParts* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IBodyParts_GetTypeInfo(IBodyParts* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IBodyParts_GetIDsOfNames(IBodyParts* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IBodyParts_Invoke(IBodyParts* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBodyParts methods ***/
static FORCEINLINE HRESULT IBodyParts_get_Count(IBodyParts* This,LONG *count) {
    return This->lpVtbl->get_Count(This,count);
}
static FORCEINLINE HRESULT IBodyParts_get_Item(IBodyParts* This,LONG index,IBodyPart **body) {
    return This->lpVtbl->get_Item(This,index,body);
}
static FORCEINLINE HRESULT IBodyParts_get__NewEnum(IBodyParts* This,IUnknown **retval) {
    return This->lpVtbl->get__NewEnum(This,retval);
}
static FORCEINLINE HRESULT IBodyParts_Delete(IBodyParts* This,VARIANT bodypart) {
    return This->lpVtbl->Delete(This,bodypart);
}
static FORCEINLINE HRESULT IBodyParts_DeleteAll(IBodyParts* This) {
    return This->lpVtbl->DeleteAll(This);
}
static FORCEINLINE HRESULT IBodyParts_Add(IBodyParts* This,LONG index,IBodyPart **bodypart) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IBodyPart_QueryInterface(IBodyPart* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IBodyPart_AddRef(IBodyPart* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IBodyPart_Release(IBodyPart* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IBodyPart_GetTypeInfoCount(IBodyPart* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IBodyPart_GetTypeInfo(IBodyPart* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IBodyPart_GetIDsOfNames(IBodyPart* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IBodyPart_Invoke(IBodyPart* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IBodyPart methods ***/
static FORCEINLINE HRESULT IBodyPart_get_BodyParts(IBodyPart* This,IBodyParts **bodypart) {
    return This->lpVtbl->get_BodyParts(This,bodypart);
}
static FORCEINLINE HRESULT IBodyPart_get_ContentTransferEncoding(IBodyPart* This,BSTR *encoding) {
    return This->lpVtbl->get_ContentTransferEncoding(This,encoding);
}
static FORCEINLINE HRESULT IBodyPart_put_ContentTransferEncoding(IBodyPart* This,BSTR encoding) {
    return This->lpVtbl->put_ContentTransferEncoding(This,encoding);
}
static FORCEINLINE HRESULT IBodyPart_get_ContentMediaType(IBodyPart* This,BSTR *mediatype) {
    return This->lpVtbl->get_ContentMediaType(This,mediatype);
}
static FORCEINLINE HRESULT IBodyPart_put_ContentMediaType(IBodyPart* This,BSTR mediatype) {
    return This->lpVtbl->put_ContentMediaType(This,mediatype);
}
static FORCEINLINE HRESULT IBodyPart_get_Fields(IBodyPart* This,Fields *fields) {
    return This->lpVtbl->get_Fields(This,fields);
}
static FORCEINLINE HRESULT IBodyPart_get_Charset(IBodyPart* This,BSTR *charset) {
    return This->lpVtbl->get_Charset(This,charset);
}
static FORCEINLINE HRESULT IBodyPart_put_Charset(IBodyPart* This,BSTR charset) {
    return This->lpVtbl->put_Charset(This,charset);
}
static FORCEINLINE HRESULT IBodyPart_get_FileName(IBodyPart* This,BSTR *filename) {
    return This->lpVtbl->get_FileName(This,filename);
}
static FORCEINLINE HRESULT IBodyPart_get_DataSource(IBodyPart* This,IDataSource *datasource) {
    return This->lpVtbl->get_DataSource(This,datasource);
}
static FORCEINLINE HRESULT IBodyPart_get_ContentClass(IBodyPart* This,BSTR *content) {
    return This->lpVtbl->get_ContentClass(This,content);
}
static FORCEINLINE HRESULT IBodyPart_put_ContentClass(IBodyPart* This,BSTR content) {
    return This->lpVtbl->put_ContentClass(This,content);
}
static FORCEINLINE HRESULT IBodyPart_get_ContentClassName(IBodyPart* This,BSTR *name) {
    return This->lpVtbl->get_ContentClassName(This,name);
}
static FORCEINLINE HRESULT IBodyPart_put_ContentClassName(IBodyPart* This,BSTR name) {
    return This->lpVtbl->put_ContentClassName(This,name);
}
static FORCEINLINE HRESULT IBodyPart_get_Parent(IBodyPart* This,IBodyPart **parent) {
    return This->lpVtbl->get_Parent(This,parent);
}
static FORCEINLINE HRESULT IBodyPart_AddBodyPart(IBodyPart* This,LONG index,IBodyPart **bodypart) {
    return This->lpVtbl->AddBodyPart(This,index,bodypart);
}
static FORCEINLINE HRESULT IBodyPart_SaveToFile(IBodyPart* This,BSTR filename) {
    return This->lpVtbl->SaveToFile(This,filename);
}
static FORCEINLINE HRESULT IBodyPart_GetEncodedContentStream(IBodyPart* This,_Stream **stream) {
    return This->lpVtbl->GetEncodedContentStream(This,stream);
}
static FORCEINLINE HRESULT IBodyPart_GetDecodedContentStream(IBodyPart* This,_Stream **stream) {
    return This->lpVtbl->GetDecodedContentStream(This,stream);
}
static FORCEINLINE HRESULT IBodyPart_GetStream(IBodyPart* This,_Stream **stream) {
    return This->lpVtbl->GetStream(This,stream);
}
static FORCEINLINE HRESULT IBodyPart_GetFieldParameter(IBodyPart* This,BSTR fieldname,BSTR parameter,BSTR *streamalue) {
    return This->lpVtbl->GetFieldParameter(This,fieldname,parameter,streamalue);
}
static FORCEINLINE HRESULT IBodyPart_GetInterface(IBodyPart* This,BSTR iface,IDispatch **unk) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IConfiguration_QueryInterface(IConfiguration* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IConfiguration_AddRef(IConfiguration* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IConfiguration_Release(IConfiguration* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IConfiguration_GetTypeInfoCount(IConfiguration* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IConfiguration_GetTypeInfo(IConfiguration* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IConfiguration_GetIDsOfNames(IConfiguration* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IConfiguration_Invoke(IConfiguration* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IConfiguration methods ***/
static FORCEINLINE HRESULT IConfiguration_get_Fields(IConfiguration* This,Fields **fields) {
    return This->lpVtbl->get_Fields(This,fields);
}
static FORCEINLINE HRESULT IConfiguration_Load(IConfiguration* This,CdoConfigSource source,BSTR url) {
    return This->lpVtbl->Load(This,source,url);
}
static FORCEINLINE HRESULT IConfiguration_GetInterface(IConfiguration* This,BSTR iname,IDispatch **unk) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMessage_QueryInterface(IMessage* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMessage_AddRef(IMessage* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMessage_Release(IMessage* This) {
    return This->lpVtbl->Release(This);
}
/*** IDispatch methods ***/
static FORCEINLINE HRESULT IMessage_GetTypeInfoCount(IMessage* This,UINT *pctinfo) {
    return This->lpVtbl->GetTypeInfoCount(This,pctinfo);
}
static FORCEINLINE HRESULT IMessage_GetTypeInfo(IMessage* This,UINT iTInfo,LCID lcid,ITypeInfo **ppTInfo) {
    return This->lpVtbl->GetTypeInfo(This,iTInfo,lcid,ppTInfo);
}
static FORCEINLINE HRESULT IMessage_GetIDsOfNames(IMessage* This,REFIID riid,LPOLESTR *rgszNames,UINT cNames,LCID lcid,DISPID *rgDispId) {
    return This->lpVtbl->GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId);
}
static FORCEINLINE HRESULT IMessage_Invoke(IMessage* This,DISPID dispIdMember,REFIID riid,LCID lcid,WORD wFlags,DISPPARAMS *pDispParams,VARIANT *pVarResult,EXCEPINFO *pExcepInfo,UINT *puArgErr) {
    return This->lpVtbl->Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr);
}
/*** IMessage methods ***/
static FORCEINLINE HRESULT IMessage_get_BCC(IMessage* This,BSTR *bcc) {
    return This->lpVtbl->get_BCC(This,bcc);
}
static FORCEINLINE HRESULT IMessage_put_BCC(IMessage* This,BSTR bcc) {
    return This->lpVtbl->put_BCC(This,bcc);
}
static FORCEINLINE HRESULT IMessage_get_CC(IMessage* This,BSTR *cc) {
    return This->lpVtbl->get_CC(This,cc);
}
static FORCEINLINE HRESULT IMessage_put_CC(IMessage* This,BSTR cc) {
    return This->lpVtbl->put_CC(This,cc);
}
static FORCEINLINE HRESULT IMessage_get_FollowUpTo(IMessage* This,BSTR *follow) {
    return This->lpVtbl->get_FollowUpTo(This,follow);
}
static FORCEINLINE HRESULT IMessage_put_FollowUpTo(IMessage* This,BSTR follow) {
    return This->lpVtbl->put_FollowUpTo(This,follow);
}
static FORCEINLINE HRESULT IMessage_get_From(IMessage* This,BSTR *from) {
    return This->lpVtbl->get_From(This,from);
}
static FORCEINLINE HRESULT IMessage_put_From(IMessage* This,BSTR from) {
    return This->lpVtbl->put_From(This,from);
}
static FORCEINLINE HRESULT IMessage_get_Keywords(IMessage* This,BSTR *keywords) {
    return This->lpVtbl->get_Keywords(This,keywords);
}
static FORCEINLINE HRESULT IMessage_put_Keywords(IMessage* This,BSTR keywords) {
    return This->lpVtbl->put_Keywords(This,keywords);
}
static FORCEINLINE HRESULT IMessage_get_MimeFormatted(IMessage* This,VARIANT_BOOL *formatted) {
    return This->lpVtbl->get_MimeFormatted(This,formatted);
}
static FORCEINLINE HRESULT IMessage_put_MimeFormatted(IMessage* This,VARIANT_BOOL formatted) {
    return This->lpVtbl->put_MimeFormatted(This,formatted);
}
static FORCEINLINE HRESULT IMessage_get_Newsgroups(IMessage* This,BSTR *newsgroups) {
    return This->lpVtbl->get_Newsgroups(This,newsgroups);
}
static FORCEINLINE HRESULT IMessage_put_Newsgroups(IMessage* This,BSTR newsgroups) {
    return This->lpVtbl->put_Newsgroups(This,newsgroups);
}
static FORCEINLINE HRESULT IMessage_get_Organization(IMessage* This,BSTR *organization) {
    return This->lpVtbl->get_Organization(This,organization);
}
static FORCEINLINE HRESULT IMessage_put_Organization(IMessage* This,BSTR organization) {
    return This->lpVtbl->put_Organization(This,organization);
}
static FORCEINLINE HRESULT IMessage_get_ReceivedTime(IMessage* This,DATE *received) {
    return This->lpVtbl->get_ReceivedTime(This,received);
}
static FORCEINLINE HRESULT IMessage_get_ReplyTo(IMessage* This,BSTR *reply) {
    return This->lpVtbl->get_ReplyTo(This,reply);
}
static FORCEINLINE HRESULT IMessage_put_ReplyTo(IMessage* This,BSTR reply) {
    return This->lpVtbl->put_ReplyTo(This,reply);
}
static FORCEINLINE HRESULT IMessage_get_DSNOptions(IMessage* This,CdoDSNOptions *options) {
    return This->lpVtbl->get_DSNOptions(This,options);
}
static FORCEINLINE HRESULT IMessage_put_DSNOptions(IMessage* This,CdoDSNOptions options) {
    return This->lpVtbl->put_DSNOptions(This,options);
}
static FORCEINLINE HRESULT IMessage_get_SentOn(IMessage* This,DATE *sent) {
    return This->lpVtbl->get_SentOn(This,sent);
}
static FORCEINLINE HRESULT IMessage_get_Subject(IMessage* This,BSTR *subject) {
    return This->lpVtbl->get_Subject(This,subject);
}
static FORCEINLINE HRESULT IMessage_put_Subject(IMessage* This,BSTR subject) {
    return This->lpVtbl->put_Subject(This,subject);
}
static FORCEINLINE HRESULT IMessage_get_To(IMessage* This,BSTR *to) {
    return This->lpVtbl->get_To(This,to);
}
static FORCEINLINE HRESULT IMessage_put_To(IMessage* This,BSTR to) {
    return This->lpVtbl->put_To(This,to);
}
static FORCEINLINE HRESULT IMessage_get_TextBody(IMessage* This,BSTR *body) {
    return This->lpVtbl->get_TextBody(This,body);
}
static FORCEINLINE HRESULT IMessage_put_TextBody(IMessage* This,BSTR body) {
    return This->lpVtbl->put_TextBody(This,body);
}
static FORCEINLINE HRESULT IMessage_HTMLBody(IMessage* This,BSTR *body) {
    return This->lpVtbl->HTMLBody(This,body);
}
static FORCEINLINE HRESULT IMessage_put_HTMLBody(IMessage* This,BSTR body) {
    return This->lpVtbl->put_HTMLBody(This,body);
}
static FORCEINLINE HRESULT IMessage_get_Attachments(IMessage* This,IBodyParts **attachments) {
    return This->lpVtbl->get_Attachments(This,attachments);
}
static FORCEINLINE HRESULT IMessage_get_Sender(IMessage* This,BSTR *sender) {
    return This->lpVtbl->get_Sender(This,sender);
}
static FORCEINLINE HRESULT IMessage_put_Sender(IMessage* This,BSTR sender) {
    return This->lpVtbl->put_Sender(This,sender);
}
static FORCEINLINE HRESULT IMessage_get_Configuration(IMessage* This,IConfiguration **config) {
    return This->lpVtbl->get_Configuration(This,config);
}
static FORCEINLINE HRESULT IMessage_put_Configuration(IMessage* This,IConfiguration *config) {
    return This->lpVtbl->put_Configuration(This,config);
}
static FORCEINLINE HRESULT IMessage_putref_Configuration(IMessage* This,IConfiguration *config) {
    return This->lpVtbl->putref_Configuration(This,config);
}
static FORCEINLINE HRESULT IMessage_get_AutoGenerateTextBody(IMessage* This,VARIANT_BOOL *body) {
    return This->lpVtbl->get_AutoGenerateTextBody(This,body);
}
static FORCEINLINE HRESULT IMessage_put_AutoGenerateTextBody(IMessage* This,VARIANT_BOOL body) {
    return This->lpVtbl->put_AutoGenerateTextBody(This,body);
}
static FORCEINLINE HRESULT IMessage_get_EnvelopeFields(IMessage* This,Fields **fields) {
    return This->lpVtbl->get_EnvelopeFields(This,fields);
}
static FORCEINLINE HRESULT IMessage_get_TextBodyPart(IMessage* This,IBodyPart **body) {
    return This->lpVtbl->get_TextBodyPart(This,body);
}
static FORCEINLINE HRESULT IMessage_get_HTMLBodyPart(IMessage* This,IBodyPart **body) {
    return This->lpVtbl->get_HTMLBodyPart(This,body);
}
static FORCEINLINE HRESULT IMessage_get_BodyPart(IMessage* This,IBodyPart **part) {
    return This->lpVtbl->get_BodyPart(This,part);
}
static FORCEINLINE HRESULT IMessage_get_DataSource(IMessage* This,IDataSource **datasource) {
    return This->lpVtbl->get_DataSource(This,datasource);
}
static FORCEINLINE HRESULT IMessage_get_Fields(IMessage* This,Fields **fields) {
    return This->lpVtbl->get_Fields(This,fields);
}
static FORCEINLINE HRESULT IMessage_get_MDNRequested(IMessage* This,VARIANT_BOOL *requested) {
    return This->lpVtbl->get_MDNRequested(This,requested);
}
static FORCEINLINE HRESULT IMessage_put_MDNRequested(IMessage* This,VARIANT_BOOL requested) {
    return This->lpVtbl->put_MDNRequested(This,requested);
}
static FORCEINLINE HRESULT IMessage_AddRelatedBodyPart(IMessage* This,BSTR url,BSTR Reference,CdoReferenceType ReferenceType,BSTR username,BSTR password,IBodyPart **body) {
    return This->lpVtbl->AddRelatedBodyPart(This,url,Reference,ReferenceType,username,password,body);
}
static FORCEINLINE HRESULT IMessage_AddAttachment(IMessage* This,BSTR url,BSTR username,BSTR password,IBodyPart **body) {
    return This->lpVtbl->AddAttachment(This,url,username,password,body);
}
static FORCEINLINE HRESULT IMessage_CreateMHTMLBody(IMessage* This,BSTR url,CdoMHTMLFlags flags,BSTR username,BSTR password) {
    return This->lpVtbl->CreateMHTMLBody(This,url,flags,username,password);
}
static FORCEINLINE HRESULT IMessage_Forward(IMessage* This,IMessage **msg) {
    return This->lpVtbl->Forward(This,msg);
}
static FORCEINLINE HRESULT IMessage_Post(IMessage* This) {
    return This->lpVtbl->Post(This);
}
static FORCEINLINE HRESULT IMessage_PostReply(IMessage* This,IMessage **msg) {
    return This->lpVtbl->PostReply(This,msg);
}
static FORCEINLINE HRESULT IMessage_Reply(IMessage* This,IMessage **msg) {
    return This->lpVtbl->Reply(This,msg);
}
static FORCEINLINE HRESULT IMessage_ReplyAll(IMessage* This,IMessage **msg) {
    return This->lpVtbl->ReplyAll(This,msg);
}
static FORCEINLINE HRESULT IMessage_Send(IMessage* This) {
    return This->lpVtbl->Send(This);
}
static FORCEINLINE HRESULT IMessage_GetStream(IMessage* This,_Stream **stream) {
    return This->lpVtbl->GetStream(This,stream);
}
static FORCEINLINE HRESULT IMessage_GetInterface(IMessage* This,BSTR name,IDispatch **unknown) {
