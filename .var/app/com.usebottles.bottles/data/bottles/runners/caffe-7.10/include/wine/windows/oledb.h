/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/oledb.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IColumnsRowset_QueryInterface(IColumnsRowset* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IColumnsRowset_AddRef(IColumnsRowset* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IColumnsRowset_Release(IColumnsRowset* This) {
    return This->lpVtbl->Release(This);
}
/*** IColumnsRowset methods ***/
static FORCEINLINE HRESULT IColumnsRowset_GetAvailableColumns(IColumnsRowset* This,DBORDINAL *count,DBID **columns) {
    return This->lpVtbl->GetAvailableColumns(This,count,columns);
}
static FORCEINLINE HRESULT IColumnsRowset_GetColumnsRowset(IColumnsRowset* This,IUnknown *outer,DBORDINAL count,const DBID columns[],REFIID riid,ULONG property_cnt,DBPROPSET property_sets[],IUnknown **rowset) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IGetDataSource_QueryInterface(IGetDataSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IGetDataSource_AddRef(IGetDataSource* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IGetDataSource_Release(IGetDataSource* This) {
    return This->lpVtbl->Release(This);
}
/*** IGetDataSource methods ***/
static FORCEINLINE HRESULT IGetDataSource_GetDataSource(IGetDataSource* This,REFIID riid,IUnknown **datasource) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ICommandStream_QueryInterface(ICommandStream* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ICommandStream_AddRef(ICommandStream* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ICommandStream_Release(ICommandStream* This) {
    return This->lpVtbl->Release(This);
}
/*** ICommandStream methods ***/
static FORCEINLINE HRESULT ICommandStream_GetCommandStream(ICommandStream* This,IID *iid,GUID *dialect,IUnknown **commandstream) {
    return This->lpVtbl->GetCommandStream(This,iid,dialect,commandstream);
}
static FORCEINLINE HRESULT ICommandStream_SetCommandStream(ICommandStream* This,REFIID riid,REFGUID dialect,IUnknown *commandstream) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ICommandProperties_QueryInterface(ICommandProperties* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ICommandProperties_AddRef(ICommandProperties* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ICommandProperties_Release(ICommandProperties* This) {
    return This->lpVtbl->Release(This);
}
/*** ICommandProperties methods ***/
static FORCEINLINE HRESULT ICommandProperties_GetProperties(ICommandProperties* This,ULONG count,const DBPROPIDSET propertyidsets[],ULONG *sets_cnt,DBPROPSET **propertyset) {
    return This->lpVtbl->GetProperties(This,count,propertyidsets,sets_cnt,propertyset);
}
static FORCEINLINE HRESULT ICommandProperties_SetProperties(ICommandProperties* This,ULONG count,DBPROPSET propertyset[]) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IConvertType_QueryInterface(IConvertType* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IConvertType_AddRef(IConvertType* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IConvertType_Release(IConvertType* This) {
    return This->lpVtbl->Release(This);
}
/*** IConvertType methods ***/
static FORCEINLINE HRESULT IConvertType_CanConvert(IConvertType* This,DBTYPE from,DBTYPE to,DBCONVERTFLAGS flags) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ICommandPrepare_QueryInterface(ICommandPrepare* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ICommandPrepare_AddRef(ICommandPrepare* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ICommandPrepare_Release(ICommandPrepare* This) {
    return This->lpVtbl->Release(This);
}
/*** ICommandPrepare methods ***/
static FORCEINLINE HRESULT ICommandPrepare_Prepare(ICommandPrepare* This,ULONG runs) {
    return This->lpVtbl->Prepare(This,runs);
}
static FORCEINLINE HRESULT ICommandPrepare_Unprepare(ICommandPrepare* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IRowsetChange_QueryInterface(IRowsetChange* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IRowsetChange_AddRef(IRowsetChange* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IRowsetChange_Release(IRowsetChange* This) {
    return This->lpVtbl->Release(This);
}
/*** IRowsetChange methods ***/
static FORCEINLINE HRESULT IRowsetChange_DeleteRows(IRowsetChange* This,HCHAPTER reserved,DBCOUNTITEM count,const HROW rows[],DBROWSTATUS status[]) {
    return This->lpVtbl->DeleteRows(This,reserved,count,rows,status);
}
static FORCEINLINE HRESULT IRowsetChange_SetData(IRowsetChange* This,HROW row,HACCESSOR accessor,void *data) {
    return This->lpVtbl->SetData(This,row,accessor,data);
}
static FORCEINLINE HRESULT IRowsetChange_InsertRow(IRowsetChange* This,HCHAPTER reserved,HACCESSOR accessor,void *data,HROW *row) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IRowsetUpdate_QueryInterface(IRowsetUpdate* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IRowsetUpdate_AddRef(IRowsetUpdate* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IRowsetUpdate_Release(IRowsetUpdate* This) {
    return This->lpVtbl->Release(This);
}
/*** IRowsetChange methods ***/
static FORCEINLINE HRESULT IRowsetUpdate_DeleteRows(IRowsetUpdate* This,HCHAPTER reserved,DBCOUNTITEM count,const HROW rows[],DBROWSTATUS status[]) {
    return This->lpVtbl->DeleteRows(This,reserved,count,rows,status);
}
static FORCEINLINE HRESULT IRowsetUpdate_SetData(IRowsetUpdate* This,HROW row,HACCESSOR accessor,void *data) {
    return This->lpVtbl->SetData(This,row,accessor,data);
}
static FORCEINLINE HRESULT IRowsetUpdate_InsertRow(IRowsetUpdate* This,HCHAPTER reserved,HACCESSOR accessor,void *data,HROW *row) {
    return This->lpVtbl->InsertRow(This,reserved,accessor,data,row);
}
/*** IRowsetUpdate methods ***/
static FORCEINLINE HRESULT IRowsetUpdate_GetOriginalData(IRowsetUpdate* This,HROW row,HACCESSOR accessor,void *data) {
    return This->lpVtbl->GetOriginalData(This,row,accessor,data);
}
static FORCEINLINE HRESULT IRowsetUpdate_GetPendingRows(IRowsetUpdate* This,HCHAPTER reserved,DBPENDINGSTATUS status,DBCOUNTITEM *pending_cnt,HROW **rending_rows,DBPENDINGSTATUS **pending_status) {
    return This->lpVtbl->GetPendingRows(This,reserved,status,pending_cnt,rending_rows,pending_status);
}
static FORCEINLINE HRESULT IRowsetUpdate_GetRowStatus(IRowsetUpdate* This,HCHAPTER reserved,DBCOUNTITEM count,const HROW rows[],DBPENDINGSTATUS status[]) {
    return This->lpVtbl->GetRowStatus(This,reserved,count,rows,status);
}
static FORCEINLINE HRESULT IRowsetUpdate_Undo(IRowsetUpdate* This,HCHAPTER reserved,DBCOUNTITEM count,const HROW rows[],DBCOUNTITEM *undone_cnt,HROW **undone,DBROWSTATUS **status) {
    return This->lpVtbl->Undo(This,reserved,count,rows,undone_cnt,undone,status);
}
static FORCEINLINE HRESULT IRowsetUpdate_Update(IRowsetUpdate* This,HCHAPTER reserved,DBCOUNTITEM count,const HROW rows[],DBCOUNTITEM *row_cnt,HROW **hrows,DBROWSTATUS **status) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IMultipleResults_QueryInterface(IMultipleResults* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IMultipleResults_AddRef(IMultipleResults* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IMultipleResults_Release(IMultipleResults* This) {
    return This->lpVtbl->Release(This);
}
/*** IMultipleResults methods ***/
static FORCEINLINE HRESULT IMultipleResults_GetResult(IMultipleResults* This,IUnknown *outer,DBRESULTFLAG result,REFIID riid,DBROWCOUNT *affected,IUnknown **rowset) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITransactionJoin_QueryInterface(ITransactionJoin* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITransactionJoin_AddRef(ITransactionJoin* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITransactionJoin_Release(ITransactionJoin* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionJoin methods ***/
static FORCEINLINE HRESULT ITransactionJoin_GetOptionsObject(ITransactionJoin* This,ITransactionOptions **options) {
    return This->lpVtbl->GetOptionsObject(This,options);
}
static FORCEINLINE HRESULT ITransactionJoin_JoinTransaction(ITransactionJoin* This,IUnknown *unk,ISOLEVEL level,ULONG flags,ITransactionOptions *options) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITransactionLocal_QueryInterface(ITransactionLocal* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITransactionLocal_AddRef(ITransactionLocal* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITransactionLocal_Release(ITransactionLocal* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransaction methods ***/
static FORCEINLINE HRESULT ITransactionLocal_Commit(ITransactionLocal* This,BOOL fRetaining,DWORD grfTC,DWORD grfRM) {
    return This->lpVtbl->Commit(This,fRetaining,grfTC,grfRM);
}
static FORCEINLINE HRESULT ITransactionLocal_Abort(ITransactionLocal* This,BOID *pboidReason,BOOL fRetaining,BOOL fAsync) {
    return This->lpVtbl->Abort(This,pboidReason,fRetaining,fAsync);
}
static FORCEINLINE HRESULT ITransactionLocal_GetTransactionInfo(ITransactionLocal* This,XACTTRANSINFO *pinfo) {
    return This->lpVtbl->GetTransactionInfo(This,pinfo);
}
/*** ITransactionLocal methods ***/
static FORCEINLINE HRESULT ITransactionLocal_GetOptionsObject(ITransactionLocal* This,ITransactionOptions **options) {
    return This->lpVtbl->GetOptionsObject(This,options);
}
static FORCEINLINE HRESULT ITransactionLocal_StartTransaction(ITransactionLocal* This,ISOLEVEL level,ULONG flags,ITransactionOptions *options,ULONG *trans_level) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ITransactionObject_QueryInterface(ITransactionObject* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ITransactionObject_AddRef(ITransactionObject* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ITransactionObject_Release(ITransactionObject* This) {
    return This->lpVtbl->Release(This);
}
/*** ITransactionObject methods ***/
static FORCEINLINE HRESULT ITransactionObject_GetTransactionObject(ITransactionObject* This,ULONG level,ITransaction **transaction) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ICommandWithParameters_QueryInterface(ICommandWithParameters* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ICommandWithParameters_AddRef(ICommandWithParameters* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ICommandWithParameters_Release(ICommandWithParameters* This) {
    return This->lpVtbl->Release(This);
}
/*** ICommandWithParameters methods ***/
static FORCEINLINE HRESULT ICommandWithParameters_GetParameterInfo(ICommandWithParameters* This,DB_UPARAMS *uparams,DBPARAMINFO **info,OLECHAR **buffer) {
    return This->lpVtbl->GetParameterInfo(This,uparams,info,buffer);
}
static FORCEINLINE HRESULT ICommandWithParameters_MapParameterNames(ICommandWithParameters* This,DB_UPARAMS uparams,LPCWSTR names[],DB_LPARAMS ordinals[]) {
    return This->lpVtbl->MapParameterNames(This,uparams,names,ordinals);
}
static FORCEINLINE HRESULT ICommandWithParameters_SetParameterInfo(ICommandWithParameters* This,DB_UPARAMS uparams,const DB_UPARAMS ordinals[],const DBPARAMBINDINFO bindinfo[]) {
