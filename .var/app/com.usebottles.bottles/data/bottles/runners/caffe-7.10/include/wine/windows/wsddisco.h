/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/wsddisco.idl - Do not edit ***/
...
/*** IWSDiscoveryProviderNotify methods ***/
static FORCEINLINE HRESULT IWSDiscoveryProviderNotify_Add(IWSDiscoveryProviderNotify* This,IWSDiscoveredService *service) {
    return This->lpVtbl->Add(This,service);
}
static FORCEINLINE HRESULT IWSDiscoveryProviderNotify_Remove(IWSDiscoveryProviderNotify* This,IWSDiscoveredService *service) {
    return This->lpVtbl->Remove(This,service);
}
static FORCEINLINE HRESULT IWSDiscoveryProviderNotify_SearchFailed(IWSDiscoveryProviderNotify* This,HRESULT hr,LPCWSTR tag) {
    return This->lpVtbl->SearchFailed(This,hr,tag);
}
static FORCEINLINE HRESULT IWSDiscoveryProviderNotify_SearchComplete(IWSDiscoveryProviderNotify* This,LPCWSTR tag) {
...
/*** IWSDiscoveredService methods ***/
static FORCEINLINE HRESULT IWSDiscoveredService_GetEndpointReference(IWSDiscoveredService* This,WSD_ENDPOINT_REFERENCE **endpoint_reference) {
    return This->lpVtbl->GetEndpointReference(This,endpoint_reference);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetTypes(IWSDiscoveredService* This,WSD_NAME_LIST **types_list) {
    return This->lpVtbl->GetTypes(This,types_list);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetScopes(IWSDiscoveredService* This,WSD_URI_LIST **scopes_list) {
    return This->lpVtbl->GetScopes(This,scopes_list);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetXAddrs(IWSDiscoveredService* This,WSD_URI_LIST **x_addrs_list) {
    return This->lpVtbl->GetXAddrs(This,x_addrs_list);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetMetadataVersion(IWSDiscoveredService* This,ULONGLONG *metadata_version) {
    return This->lpVtbl->GetMetadataVersion(This,metadata_version);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetExtendedDiscoXML(IWSDiscoveredService* This,WSDXML_ELEMENT **header_any,WSDXML_ELEMENT **body_any) {
    return This->lpVtbl->GetExtendedDiscoXML(This,header_any,body_any);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetProbeResolveTag(IWSDiscoveredService* This,LPCWSTR *tag) {
    return This->lpVtbl->GetProbeResolveTag(This,tag);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetRemoteTransportAddress(IWSDiscoveredService* This,LPCWSTR *remote_transport_address) {
    return This->lpVtbl->GetRemoteTransportAddress(This,remote_transport_address);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetLocalTransportAddress(IWSDiscoveredService* This,LPCWSTR *local_transport_address) {
    return This->lpVtbl->GetLocalTransportAddress(This,local_transport_address);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetLocalInterfaceGUID(IWSDiscoveredService* This,GUID *guid) {
    return This->lpVtbl->GetLocalInterfaceGUID(This,guid);
}
static FORCEINLINE HRESULT IWSDiscoveredService_GetInstanceId(IWSDiscoveredService* This,ULONGLONG *instance_id) {
...
/*** IWSDiscoveryProvider methods ***/
static FORCEINLINE HRESULT IWSDiscoveryProvider_SetAddressFamily(IWSDiscoveryProvider* This,DWORD address_family) {
    return This->lpVtbl->SetAddressFamily(This,address_family);
}
static FORCEINLINE HRESULT IWSDiscoveryProvider_Attach(IWSDiscoveryProvider* This,IWSDiscoveryProviderNotify *sink) {
...
static FORCEINLINE HRESULT IWSDiscoveryProvider_SearchById(IWSDiscoveryProvider* This,LPCWSTR id,LPCWSTR tag) {
    return This->lpVtbl->SearchById(This,id,tag);
}
static FORCEINLINE HRESULT IWSDiscoveryProvider_SearchByAddress(IWSDiscoveryProvider* This,LPCWSTR address,LPCWSTR tag) {
    return This->lpVtbl->SearchByAddress(This,address,tag);
}
static FORCEINLINE HRESULT IWSDiscoveryProvider_SearchByType(IWSDiscoveryProvider* This,const WSD_NAME_LIST *types_list,const WSD_URI_LIST *scopes_list,LPCWSTR match_by,LPCWSTR tag) {
    return This->lpVtbl->SearchByType(This,types_list,scopes_list,match_by,tag);
}
static FORCEINLINE HRESULT IWSDiscoveryProvider_GetXMLContext(IWSDiscoveryProvider* This,IWSDXMLContext **context) {
