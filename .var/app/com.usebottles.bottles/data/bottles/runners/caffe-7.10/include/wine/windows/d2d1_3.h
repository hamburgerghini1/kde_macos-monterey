/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/d2d1_3.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1InkStyle_QueryInterface(ID2D1InkStyle* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1InkStyle_AddRef(ID2D1InkStyle* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1InkStyle_Release(ID2D1InkStyle* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1InkStyle_GetFactory(ID2D1InkStyle* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1InkStyle methods ***/
static FORCEINLINE void ID2D1InkStyle_SetNibTransform(ID2D1InkStyle* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetNibTransform(This,transform);
}
static FORCEINLINE void ID2D1InkStyle_GetNibTransform(ID2D1InkStyle* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetNibTransform(This,transform);
}
static FORCEINLINE void ID2D1InkStyle_SetNibShape(ID2D1InkStyle* This,D2D1_INK_NIB_SHAPE shape) {
    This->lpVtbl->SetNibShape(This,shape);
}
static FORCEINLINE D2D1_INK_NIB_SHAPE ID2D1InkStyle_GetNibShape(ID2D1InkStyle* This) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1Ink_QueryInterface(ID2D1Ink* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1Ink_AddRef(ID2D1Ink* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1Ink_Release(ID2D1Ink* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1Ink_GetFactory(ID2D1Ink* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Ink methods ***/
static FORCEINLINE void ID2D1Ink_SetStartPoint(ID2D1Ink* This,const D2D1_INK_POINT *start_point) {
    This->lpVtbl->SetStartPoint(This,start_point);
}
static FORCEINLINE D2D1_INK_POINT ID2D1Ink_GetStartPoint(ID2D1Ink* This) {
    D2D1_INK_POINT __ret;
    return *This->lpVtbl->GetStartPoint(This,&__ret);
}
static FORCEINLINE HRESULT ID2D1Ink_AddSegments(ID2D1Ink* This,const D2D1_INK_BEZIER_SEGMENT *segments,UINT32 segment_count) {
    return This->lpVtbl->AddSegments(This,segments,segment_count);
}
static FORCEINLINE HRESULT ID2D1Ink_RemoveSegmentsAtEnd(ID2D1Ink* This,UINT32 segment_count) {
    return This->lpVtbl->RemoveSegmentsAtEnd(This,segment_count);
}
static FORCEINLINE HRESULT ID2D1Ink_SetSegments(ID2D1Ink* This,UINT32 start_segment,const D2D1_INK_BEZIER_SEGMENT *segments,UINT32 segment_count) {
    return This->lpVtbl->SetSegments(This,start_segment,segments,segment_count);
}
static FORCEINLINE HRESULT ID2D1Ink_SetSegmentAtEnd(ID2D1Ink* This,const D2D1_INK_BEZIER_SEGMENT *segment) {
    return This->lpVtbl->SetSegmentAtEnd(This,segment);
}
static FORCEINLINE UINT32 ID2D1Ink_GetSegmentCount(ID2D1Ink* This) {
    return This->lpVtbl->GetSegmentCount(This);
}
static FORCEINLINE HRESULT ID2D1Ink_GetSegments(ID2D1Ink* This,UINT32 start_segment,D2D1_INK_BEZIER_SEGMENT *segments,UINT32 segment_count) {
    return This->lpVtbl->GetSegments(This,start_segment,segments,segment_count);
}
static FORCEINLINE HRESULT ID2D1Ink_StreamAsGeometry(ID2D1Ink* This,ID2D1InkStyle *ink_style,const D2D1_MATRIX_3X2_F *world_transform,float flattening_tolerance,ID2D1SimplifiedGeometrySink *geometry_sink) {
    return This->lpVtbl->StreamAsGeometry(This,ink_style,world_transform,flattening_tolerance,geometry_sink);
}
static FORCEINLINE HRESULT ID2D1Ink_GetBounds(ID2D1Ink* This,ID2D1InkStyle *ink_style,const D2D1_MATRIX_3X2_F *world_transform,D2D1_RECT_F *bounds) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1GradientMesh_QueryInterface(ID2D1GradientMesh* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1GradientMesh_AddRef(ID2D1GradientMesh* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1GradientMesh_Release(ID2D1GradientMesh* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1GradientMesh_GetFactory(ID2D1GradientMesh* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1GradientMesh methods ***/
static FORCEINLINE UINT32 ID2D1GradientMesh_GetPatchCount(ID2D1GradientMesh* This) {
    return This->lpVtbl->GetPatchCount(This);
}
static FORCEINLINE HRESULT ID2D1GradientMesh_GetPatches(ID2D1GradientMesh* This,UINT32 start_index,D2D1_GRADIENT_MESH_PATCH *patches,UINT32 patch_count) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ImageSource_QueryInterface(ID2D1ImageSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ImageSource_AddRef(ID2D1ImageSource* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ImageSource_Release(ID2D1ImageSource* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1ImageSource_GetFactory(ID2D1ImageSource* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1ImageSource methods ***/
static FORCEINLINE HRESULT ID2D1ImageSource_OfferResources(ID2D1ImageSource* This) {
    return This->lpVtbl->OfferResources(This);
}
static FORCEINLINE HRESULT ID2D1ImageSource_TryReclaimResources(ID2D1ImageSource* This,BOOL *resources_discarded) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1ImageSourceFromWic_QueryInterface(ID2D1ImageSourceFromWic* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1ImageSourceFromWic_AddRef(ID2D1ImageSourceFromWic* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1ImageSourceFromWic_Release(ID2D1ImageSourceFromWic* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1ImageSourceFromWic_GetFactory(ID2D1ImageSourceFromWic* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1ImageSource methods ***/
static FORCEINLINE HRESULT ID2D1ImageSourceFromWic_OfferResources(ID2D1ImageSourceFromWic* This) {
    return This->lpVtbl->OfferResources(This);
}
static FORCEINLINE HRESULT ID2D1ImageSourceFromWic_TryReclaimResources(ID2D1ImageSourceFromWic* This,BOOL *resources_discarded) {
    return This->lpVtbl->TryReclaimResources(This,resources_discarded);
}
/*** ID2D1ImageSourceFromWic methods ***/
static FORCEINLINE HRESULT ID2D1ImageSourceFromWic_EnsureCached(ID2D1ImageSourceFromWic* This,const D2D1_RECT_U *rect_to_fill) {
    return This->lpVtbl->EnsureCached(This,rect_to_fill);
}
static FORCEINLINE HRESULT ID2D1ImageSourceFromWic_TrimCache(ID2D1ImageSourceFromWic* This,const D2D1_RECT_U *rect_to_preserve) {
    return This->lpVtbl->TrimCache(This,rect_to_preserve);
}
static FORCEINLINE void ID2D1ImageSourceFromWic_GetSource(ID2D1ImageSourceFromWic* This,IWICBitmapSource **source) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1TransformedImageSource_QueryInterface(ID2D1TransformedImageSource* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1TransformedImageSource_AddRef(ID2D1TransformedImageSource* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1TransformedImageSource_Release(ID2D1TransformedImageSource* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1TransformedImageSource_GetFactory(ID2D1TransformedImageSource* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1TransformedImageSource methods ***/
static FORCEINLINE void ID2D1TransformedImageSource_GetSource(ID2D1TransformedImageSource* This,ID2D1ImageSource **source) {
    This->lpVtbl->GetSource(This,source);
}
static FORCEINLINE void ID2D1TransformedImageSource_GetProperties(ID2D1TransformedImageSource* This,D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES *out) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1LookupTable3D_QueryInterface(ID2D1LookupTable3D* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1LookupTable3D_AddRef(ID2D1LookupTable3D* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1LookupTable3D_Release(ID2D1LookupTable3D* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1LookupTable3D_GetFactory(ID2D1LookupTable3D* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext2_QueryInterface(ID2D1DeviceContext2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1DeviceContext2_AddRef(ID2D1DeviceContext2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1DeviceContext2_Release(ID2D1DeviceContext2* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1DeviceContext2_GetFactory(ID2D1DeviceContext2* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1RenderTarget methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateSharedBitmap(ID2D1DeviceContext2* This,REFIID iid,void *data,const D2D1_BITMAP_PROPERTIES *desc,ID2D1Bitmap **bitmap) {
    return This->lpVtbl->CreateSharedBitmap(This,iid,data,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateSolidColorBrush(ID2D1DeviceContext2* This,const D2D1_COLOR_F *color,const D2D1_BRUSH_PROPERTIES *desc,ID2D1SolidColorBrush **brush) {
    return This->lpVtbl->CreateSolidColorBrush(This,color,desc,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateLinearGradientBrush(ID2D1DeviceContext2* This,const D2D1_LINEAR_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1LinearGradientBrush **brush) {
    return This->lpVtbl->CreateLinearGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateRadialGradientBrush(ID2D1DeviceContext2* This,const D2D1_RADIAL_GRADIENT_BRUSH_PROPERTIES *gradient_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1GradientStopCollection *gradient,ID2D1RadialGradientBrush **brush) {
    return This->lpVtbl->CreateRadialGradientBrush(This,gradient_brush_desc,brush_desc,gradient,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateCompatibleRenderTarget(ID2D1DeviceContext2* This,const D2D1_SIZE_F *size,const D2D1_SIZE_U *pixel_size,const D2D1_PIXEL_FORMAT *format,D2D1_COMPATIBLE_RENDER_TARGET_OPTIONS options,ID2D1BitmapRenderTarget **render_target) {
    return This->lpVtbl->CreateCompatibleRenderTarget(This,size,pixel_size,format,options,render_target);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateLayer(ID2D1DeviceContext2* This,const D2D1_SIZE_F *size,ID2D1Layer **layer) {
    return This->lpVtbl->CreateLayer(This,size,layer);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateMesh(ID2D1DeviceContext2* This,ID2D1Mesh **mesh) {
    return This->lpVtbl->CreateMesh(This,mesh);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawLine(ID2D1DeviceContext2* This,D2D1_POINT_2F p0,D2D1_POINT_2F p1,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawLine(This,p0,p1,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawRectangle(ID2D1DeviceContext2* This,const D2D1_RECT_F *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRectangle(This,rect,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext2_FillRectangle(ID2D1DeviceContext2* This,const D2D1_RECT_F *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRectangle(This,rect,brush);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawRoundedRectangle(ID2D1DeviceContext2* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawRoundedRectangle(This,rect,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext2_FillRoundedRectangle(ID2D1DeviceContext2* This,const D2D1_ROUNDED_RECT *rect,ID2D1Brush *brush) {
    This->lpVtbl->FillRoundedRectangle(This,rect,brush);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawEllipse(ID2D1DeviceContext2* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawEllipse(This,ellipse,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext2_FillEllipse(ID2D1DeviceContext2* This,const D2D1_ELLIPSE *ellipse,ID2D1Brush *brush) {
    This->lpVtbl->FillEllipse(This,ellipse,brush);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawGeometry(ID2D1DeviceContext2* This,ID2D1Geometry *geometry,ID2D1Brush *brush,float stroke_width,ID2D1StrokeStyle *stroke_style) {
    This->lpVtbl->DrawGeometry(This,geometry,brush,stroke_width,stroke_style);
}
static FORCEINLINE void ID2D1DeviceContext2_FillGeometry(ID2D1DeviceContext2* This,ID2D1Geometry *geometry,ID2D1Brush *brush,ID2D1Brush *opacity_brush) {
    This->lpVtbl->FillGeometry(This,geometry,brush,opacity_brush);
}
static FORCEINLINE void ID2D1DeviceContext2_FillMesh(ID2D1DeviceContext2* This,ID2D1Mesh *mesh,ID2D1Brush *brush) {
    This->lpVtbl->FillMesh(This,mesh,brush);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawText(ID2D1DeviceContext2* This,const WCHAR *string,UINT32 string_len,IDWriteTextFormat *text_format,const D2D1_RECT_F *layout_rect,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->DrawText(This,string,string_len,text_format,layout_rect,brush,options,measuring_mode);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawTextLayout(ID2D1DeviceContext2* This,D2D1_POINT_2F origin,IDWriteTextLayout *layout,ID2D1Brush *brush,D2D1_DRAW_TEXT_OPTIONS options) {
    This->lpVtbl->DrawTextLayout(This,origin,layout,brush,options);
}
static FORCEINLINE void ID2D1DeviceContext2_SetTransform(ID2D1DeviceContext2* This,const D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->SetTransform(This,transform);
}
static FORCEINLINE void ID2D1DeviceContext2_GetTransform(ID2D1DeviceContext2* This,D2D1_MATRIX_3X2_F *transform) {
    This->lpVtbl->GetTransform(This,transform);
}
static FORCEINLINE void ID2D1DeviceContext2_SetAntialiasMode(ID2D1DeviceContext2* This,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetAntialiasMode(This,antialias_mode);
}
static FORCEINLINE D2D1_ANTIALIAS_MODE ID2D1DeviceContext2_GetAntialiasMode(ID2D1DeviceContext2* This) {
    return This->lpVtbl->GetAntialiasMode(This);
}
static FORCEINLINE void ID2D1DeviceContext2_SetTextAntialiasMode(ID2D1DeviceContext2* This,D2D1_TEXT_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->SetTextAntialiasMode(This,antialias_mode);
}
static FORCEINLINE D2D1_TEXT_ANTIALIAS_MODE ID2D1DeviceContext2_GetTextAntialiasMode(ID2D1DeviceContext2* This) {
    return This->lpVtbl->GetTextAntialiasMode(This);
}
static FORCEINLINE void ID2D1DeviceContext2_SetTextRenderingParams(ID2D1DeviceContext2* This,IDWriteRenderingParams *text_rendering_params) {
    This->lpVtbl->SetTextRenderingParams(This,text_rendering_params);
}
static FORCEINLINE void ID2D1DeviceContext2_GetTextRenderingParams(ID2D1DeviceContext2* This,IDWriteRenderingParams **text_rendering_params) {
    This->lpVtbl->GetTextRenderingParams(This,text_rendering_params);
}
static FORCEINLINE void ID2D1DeviceContext2_SetTags(ID2D1DeviceContext2* This,D2D1_TAG tag1,D2D1_TAG tag2) {
    This->lpVtbl->SetTags(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext2_GetTags(ID2D1DeviceContext2* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    This->lpVtbl->GetTags(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext2_PopLayer(ID2D1DeviceContext2* This) {
    This->lpVtbl->PopLayer(This);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_Flush(ID2D1DeviceContext2* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->Flush(This,tag1,tag2);
}
static FORCEINLINE void ID2D1DeviceContext2_SaveDrawingState(ID2D1DeviceContext2* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->SaveDrawingState(This,state_block);
}
static FORCEINLINE void ID2D1DeviceContext2_RestoreDrawingState(ID2D1DeviceContext2* This,ID2D1DrawingStateBlock *state_block) {
    This->lpVtbl->RestoreDrawingState(This,state_block);
}
static FORCEINLINE void ID2D1DeviceContext2_PushAxisAlignedClip(ID2D1DeviceContext2* This,const D2D1_RECT_F *clip_rect,D2D1_ANTIALIAS_MODE antialias_mode) {
    This->lpVtbl->PushAxisAlignedClip(This,clip_rect,antialias_mode);
}
static FORCEINLINE void ID2D1DeviceContext2_PopAxisAlignedClip(ID2D1DeviceContext2* This) {
    This->lpVtbl->PopAxisAlignedClip(This);
}
static FORCEINLINE void ID2D1DeviceContext2_Clear(ID2D1DeviceContext2* This,const D2D1_COLOR_F *color) {
    This->lpVtbl->Clear(This,color);
}
static FORCEINLINE void ID2D1DeviceContext2_BeginDraw(ID2D1DeviceContext2* This) {
    This->lpVtbl->BeginDraw(This);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_EndDraw(ID2D1DeviceContext2* This,D2D1_TAG *tag1,D2D1_TAG *tag2) {
    return This->lpVtbl->EndDraw(This,tag1,tag2);
}
static FORCEINLINE D2D1_PIXEL_FORMAT ID2D1DeviceContext2_GetPixelFormat(ID2D1DeviceContext2* This) {
    D2D1_PIXEL_FORMAT __ret;
    return *This->lpVtbl->GetPixelFormat(This,&__ret);
}
static FORCEINLINE void ID2D1DeviceContext2_SetDpi(ID2D1DeviceContext2* This,float dpi_x,float dpi_y) {
    This->lpVtbl->SetDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE void ID2D1DeviceContext2_GetDpi(ID2D1DeviceContext2* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE D2D1_SIZE_F ID2D1DeviceContext2_GetSize(ID2D1DeviceContext2* This) {
    D2D1_SIZE_F __ret;
    return *This->lpVtbl->GetSize(This,&__ret);
}
static FORCEINLINE D2D1_SIZE_U ID2D1DeviceContext2_GetPixelSize(ID2D1DeviceContext2* This) {
    D2D1_SIZE_U __ret;
    return *This->lpVtbl->GetPixelSize(This,&__ret);
}
static FORCEINLINE UINT32 ID2D1DeviceContext2_GetMaximumBitmapSize(ID2D1DeviceContext2* This) {
    return This->lpVtbl->GetMaximumBitmapSize(This);
}
static FORCEINLINE BOOL ID2D1DeviceContext2_IsSupported(ID2D1DeviceContext2* This,const D2D1_RENDER_TARGET_PROPERTIES *desc) {
    return This->lpVtbl->IsSupported(This,desc);
}
/*** ID2D1DeviceContext methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateBitmap(ID2D1DeviceContext2* This,D2D1_SIZE_U size,const void *src_data,UINT32 pitch,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmap(This,size,src_data,pitch,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateBitmapFromWicBitmap(ID2D1DeviceContext2* This,IWICBitmapSource *bitmap_source,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapFromWicBitmap(This,bitmap_source,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateColorContext(ID2D1DeviceContext2* This,D2D1_COLOR_SPACE space,const BYTE *profile,UINT32 profile_size,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContext(This,space,profile,profile_size,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateColorContextFromFilename(ID2D1DeviceContext2* This,const WCHAR *filename,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromFilename(This,filename,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateColorContextFromWicColorContext(ID2D1DeviceContext2* This,IWICColorContext *wic_color_context,ID2D1ColorContext **color_context) {
    return This->lpVtbl->CreateColorContextFromWicColorContext(This,wic_color_context,color_context);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateBitmapFromDxgiSurface(ID2D1DeviceContext2* This,IDXGISurface *surface,const D2D1_BITMAP_PROPERTIES1 *desc,ID2D1Bitmap1 **bitmap) {
    return This->lpVtbl->CreateBitmapFromDxgiSurface(This,surface,desc,bitmap);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateEffect(ID2D1DeviceContext2* This,REFCLSID effect_id,ID2D1Effect **effect) {
    return This->lpVtbl->CreateEffect(This,effect_id,effect);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateGradientStopCollection(ID2D1DeviceContext2* This,const D2D1_GRADIENT_STOP *stops,UINT32 stop_count,D2D1_COLOR_SPACE preinterpolation_space,D2D1_COLOR_SPACE postinterpolation_space,D2D1_BUFFER_PRECISION buffer_precision,D2D1_EXTEND_MODE extend_mode,D2D1_COLOR_INTERPOLATION_MODE color_interpolation_mode,ID2D1GradientStopCollection1 **gradient) {
...
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateImageBrush(ID2D1DeviceContext2* This,ID2D1Image *image,const D2D1_IMAGE_BRUSH_PROPERTIES *image_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1ImageBrush **brush) {
    return This->lpVtbl->CreateImageBrush(This,image,image_brush_desc,brush_desc,brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateBitmapBrush(ID2D1DeviceContext2* This,ID2D1Bitmap *bitmap,const D2D1_BITMAP_BRUSH_PROPERTIES1 *bitmap_brush_desc,const D2D1_BRUSH_PROPERTIES *brush_desc,ID2D1BitmapBrush1 **bitmap_brush) {
    return This->lpVtbl->ID2D1DeviceContext_CreateBitmapBrush(This,bitmap,bitmap_brush_desc,brush_desc,bitmap_brush);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateCommandList(ID2D1DeviceContext2* This,ID2D1CommandList **command_list) {
    return This->lpVtbl->CreateCommandList(This,command_list);
}
static FORCEINLINE BOOL ID2D1DeviceContext2_IsDxgiFormatSupported(ID2D1DeviceContext2* This,DXGI_FORMAT format) {
    return This->lpVtbl->IsDxgiFormatSupported(This,format);
}
static FORCEINLINE BOOL ID2D1DeviceContext2_IsBufferPrecisionSupported(ID2D1DeviceContext2* This,D2D1_BUFFER_PRECISION buffer_precision) {
    return This->lpVtbl->IsBufferPrecisionSupported(This,buffer_precision);
}
static FORCEINLINE void ID2D1DeviceContext2_GetImageLocalBounds(ID2D1DeviceContext2* This,ID2D1Image *image,D2D1_RECT_F *local_bounds) {
    This->lpVtbl->GetImageLocalBounds(This,image,local_bounds);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetImageWorldBounds(ID2D1DeviceContext2* This,ID2D1Image *image,D2D1_RECT_F *world_bounds) {
    return This->lpVtbl->GetImageWorldBounds(This,image,world_bounds);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetGlyphRunWorldBounds(ID2D1DeviceContext2* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,DWRITE_MEASURING_MODE measuring_mode,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGlyphRunWorldBounds(This,baseline_origin,glyph_run,measuring_mode,bounds);
}
static FORCEINLINE void ID2D1DeviceContext2_GetDevice(ID2D1DeviceContext2* This,ID2D1Device **device) {
    This->lpVtbl->GetDevice(This,device);
}
static FORCEINLINE void ID2D1DeviceContext2_SetTarget(ID2D1DeviceContext2* This,ID2D1Image *target) {
    This->lpVtbl->SetTarget(This,target);
}
static FORCEINLINE void ID2D1DeviceContext2_GetTarget(ID2D1DeviceContext2* This,ID2D1Image **target) {
    This->lpVtbl->GetTarget(This,target);
}
static FORCEINLINE void ID2D1DeviceContext2_SetRenderingControls(ID2D1DeviceContext2* This,const D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->SetRenderingControls(This,rendering_controls);
}
static FORCEINLINE void ID2D1DeviceContext2_GetRenderingControls(ID2D1DeviceContext2* This,D2D1_RENDERING_CONTROLS *rendering_controls) {
    This->lpVtbl->GetRenderingControls(This,rendering_controls);
}
static FORCEINLINE void ID2D1DeviceContext2_SetPrimitiveBlend(ID2D1DeviceContext2* This,D2D1_PRIMITIVE_BLEND primitive_blend) {
    This->lpVtbl->SetPrimitiveBlend(This,primitive_blend);
}
static FORCEINLINE D2D1_PRIMITIVE_BLEND ID2D1DeviceContext2_GetPrimitiveBlend(ID2D1DeviceContext2* This) {
    return This->lpVtbl->GetPrimitiveBlend(This);
}
static FORCEINLINE void ID2D1DeviceContext2_SetUnitMode(ID2D1DeviceContext2* This,D2D1_UNIT_MODE unit_mode) {
    This->lpVtbl->SetUnitMode(This,unit_mode);
}
static FORCEINLINE D2D1_UNIT_MODE ID2D1DeviceContext2_GetUnitMode(ID2D1DeviceContext2* This) {
    return This->lpVtbl->GetUnitMode(This);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawGlyphRun(ID2D1DeviceContext2* This,D2D1_POINT_2F baseline_origin,const DWRITE_GLYPH_RUN *glyph_run,const DWRITE_GLYPH_RUN_DESCRIPTION *glyph_run_desc,ID2D1Brush *brush,DWRITE_MEASURING_MODE measuring_mode) {
    This->lpVtbl->ID2D1DeviceContext_DrawGlyphRun(This,baseline_origin,glyph_run,glyph_run_desc,brush,measuring_mode);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawImage(ID2D1DeviceContext2* This,ID2D1Image *image,const D2D1_POINT_2F *target_offset,const D2D1_RECT_F *image_rect,D2D1_INTERPOLATION_MODE interpolation_mode,D2D1_COMPOSITE_MODE composite_mode) {
    This->lpVtbl->DrawImage(This,image,target_offset,image_rect,interpolation_mode,composite_mode);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawBitmap(ID2D1DeviceContext2* This,ID2D1Bitmap *bitmap,const D2D1_RECT_F *dst_rect,float opacity,D2D1_INTERPOLATION_MODE interpolation_mode,const D2D1_RECT_F *src_rect,const D2D1_MATRIX_4X4_F *perspective_transform) {
    This->lpVtbl->ID2D1DeviceContext_DrawBitmap(This,bitmap,dst_rect,opacity,interpolation_mode,src_rect,perspective_transform);
}
static FORCEINLINE void ID2D1DeviceContext2_PushLayer(ID2D1DeviceContext2* This,const D2D1_LAYER_PARAMETERS1 *layer_parameters,ID2D1Layer *layer) {
    This->lpVtbl->ID2D1DeviceContext_PushLayer(This,layer_parameters,layer);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_InvalidateEffectInputRectangle(ID2D1DeviceContext2* This,ID2D1Effect *effect,UINT32 input,const D2D1_RECT_F *input_rect) {
    return This->lpVtbl->InvalidateEffectInputRectangle(This,effect,input,input_rect);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetEffectInvalidRectangleCount(ID2D1DeviceContext2* This,ID2D1Effect *effect,UINT32 *rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangleCount(This,effect,rect_count);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetEffectInvalidRectangles(ID2D1DeviceContext2* This,ID2D1Effect *effect,D2D1_RECT_F *rectangles,UINT32 rect_count) {
    return This->lpVtbl->GetEffectInvalidRectangles(This,effect,rectangles,rect_count);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetEffectRequiredInputRectangles(ID2D1DeviceContext2* This,ID2D1Effect *effect,const D2D1_RECT_F *image_rect,const D2D1_EFFECT_INPUT_DESCRIPTION *desc,D2D1_RECT_F *input_rect,UINT32 input_count) {
    return This->lpVtbl->GetEffectRequiredInputRectangles(This,effect,image_rect,desc,input_rect,input_count);
}
static FORCEINLINE void ID2D1DeviceContext2_FillOpacityMask(ID2D1DeviceContext2* This,ID2D1Bitmap *mask,ID2D1Brush *brush,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext_FillOpacityMask(This,mask,brush,dst_rect,src_rect);
}
/*** ID2D1DeviceContext1 methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateFilledGeometryRealization(ID2D1DeviceContext2* This,ID2D1Geometry *geometry,float tolerance,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateFilledGeometryRealization(This,geometry,tolerance,realization);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateStrokedGeometryRealization(ID2D1DeviceContext2* This,ID2D1Geometry *geometry,float tolerance,float stroke_width,ID2D1StrokeStyle *stroke_style,ID2D1GeometryRealization **realization) {
    return This->lpVtbl->CreateStrokedGeometryRealization(This,geometry,tolerance,stroke_width,stroke_style,realization);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawGeometryRealization(ID2D1DeviceContext2* This,ID2D1GeometryRealization *realization,ID2D1Brush *brush) {
    This->lpVtbl->DrawGeometryRealization(This,realization,brush);
}
/*** ID2D1DeviceContext2 methods ***/
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateInk(ID2D1DeviceContext2* This,const D2D1_INK_POINT *start_point,ID2D1Ink **ink) {
    return This->lpVtbl->CreateInk(This,start_point,ink);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateInkStyle(ID2D1DeviceContext2* This,const D2D1_INK_STYLE_PROPERTIES *ink_style_properties,ID2D1InkStyle **ink_style) {
    return This->lpVtbl->CreateInkStyle(This,ink_style_properties,ink_style);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateGradientMesh(ID2D1DeviceContext2* This,const D2D1_GRADIENT_MESH_PATCH *patches,UINT32 patches_count,ID2D1GradientMesh **gradient_mesh) {
    return This->lpVtbl->CreateGradientMesh(This,patches,patches_count,gradient_mesh);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateImageSourceFromWic(ID2D1DeviceContext2* This,IWICBitmapSource *wic_bitmap_source,D2D1_IMAGE_SOURCE_LOADING_OPTIONS loading_options,D2D1_ALPHA_MODE alpha_mode,ID2D1ImageSourceFromWic **image_source) {
    return This->lpVtbl->CreateImageSourceFromWic(This,wic_bitmap_source,loading_options,alpha_mode,image_source);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateLookupTable3D(ID2D1DeviceContext2* This,D2D1_BUFFER_PRECISION precision,const UINT32 *extents,const BYTE *data,UINT32 data_count,const UINT32 *strides,ID2D1LookupTable3D **lookup_table) {
    return This->lpVtbl->CreateLookupTable3D(This,precision,extents,data,data_count,strides,lookup_table);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateImageSourceFromDxgi(ID2D1DeviceContext2* This,IDXGISurface **surfaces,UINT32 surface_count,DXGI_COLOR_SPACE_TYPE color_space,D2D1_IMAGE_SOURCE_FROM_DXGI_OPTIONS options,ID2D1ImageSource **image_source) {
    return This->lpVtbl->CreateImageSourceFromDxgi(This,surfaces,surface_count,color_space,options,image_source);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_GetGradientMeshWorldBounds(ID2D1DeviceContext2* This,ID2D1GradientMesh *gradient_mesh,D2D1_RECT_F *bounds) {
    return This->lpVtbl->GetGradientMeshWorldBounds(This,gradient_mesh,bounds);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawInk(ID2D1DeviceContext2* This,ID2D1Ink *ink,ID2D1Brush *brush,ID2D1InkStyle *ink_style) {
    This->lpVtbl->DrawInk(This,ink,brush,ink_style);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawGradientMesh(ID2D1DeviceContext2* This,ID2D1GradientMesh *gradient_mesh) {
    This->lpVtbl->DrawGradientMesh(This,gradient_mesh);
}
static FORCEINLINE void ID2D1DeviceContext2_DrawGdiMetafile(ID2D1DeviceContext2* This,ID2D1GdiMetafile *gdi_metafile,const D2D1_RECT_F *dst_rect,const D2D1_RECT_F *src_rect) {
    This->lpVtbl->ID2D1DeviceContext2_DrawGdiMetafile(This,gdi_metafile,dst_rect,src_rect);
}
static FORCEINLINE HRESULT ID2D1DeviceContext2_CreateTransformedImageSource(ID2D1DeviceContext2* This,ID2D1ImageSource *source,const D2D1_TRANSFORMED_IMAGE_SOURCE_PROPERTIES *props,ID2D1TransformedImageSource **transformed) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1Device2_QueryInterface(ID2D1Device2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1Device2_AddRef(ID2D1Device2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1Device2_Release(ID2D1Device2* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Resource methods ***/
static FORCEINLINE void ID2D1Device2_GetFactory(ID2D1Device2* This,ID2D1Factory **factory) {
    This->lpVtbl->GetFactory(This,factory);
}
/*** ID2D1Device methods ***/
static FORCEINLINE HRESULT ID2D1Device2_CreatePrintControl(ID2D1Device2* This,IWICImagingFactory *wic_factory,IPrintDocumentPackageTarget *document_target,const D2D1_PRINT_CONTROL_PROPERTIES *desc,ID2D1PrintControl **print_control) {
    return This->lpVtbl->CreatePrintControl(This,wic_factory,document_target,desc,print_control);
}
static FORCEINLINE void ID2D1Device2_SetMaximumTextureMemory(ID2D1Device2* This,UINT64 max_texture_memory) {
    This->lpVtbl->SetMaximumTextureMemory(This,max_texture_memory);
}
static FORCEINLINE UINT64 ID2D1Device2_GetMaximumTextureMemory(ID2D1Device2* This) {
    return This->lpVtbl->GetMaximumTextureMemory(This);
}
static FORCEINLINE HRESULT ID2D1Device2_ClearResources(ID2D1Device2* This,UINT msec_since_use) {
    return This->lpVtbl->ClearResources(This,msec_since_use);
}
/*** ID2D1Device1 methods ***/
static FORCEINLINE D2D1_RENDERING_PRIORITY ID2D1Device2_GetRenderingPriority(ID2D1Device2* This) {
    return This->lpVtbl->GetRenderingPriority(This);
}
static FORCEINLINE void ID2D1Device2_SetRenderingPriority(ID2D1Device2* This,D2D1_RENDERING_PRIORITY priority) {
    This->lpVtbl->SetRenderingPriority(This,priority);
}
/*** ID2D1Device2 methods ***/
static FORCEINLINE HRESULT ID2D1Device2_CreateDeviceContext(ID2D1Device2* This,D2D1_DEVICE_CONTEXT_OPTIONS options,ID2D1DeviceContext2 **context) {
    return This->lpVtbl->ID2D1Device2_CreateDeviceContext(This,options,context);
}
static FORCEINLINE void ID2D1Device2_FlushDeviceContexts(ID2D1Device2* This,ID2D1Bitmap *bitmap) {
    This->lpVtbl->FlushDeviceContexts(This,bitmap);
}
static FORCEINLINE HRESULT ID2D1Device2_GetDxgiDevice(ID2D1Device2* This,IDXGIDevice **dxgi_device) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ID2D1Factory3_QueryInterface(ID2D1Factory3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ID2D1Factory3_AddRef(ID2D1Factory3* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ID2D1Factory3_Release(ID2D1Factory3* This) {
    return This->lpVtbl->Release(This);
}
/*** ID2D1Factory methods ***/
static FORCEINLINE HRESULT ID2D1Factory3_ReloadSystemMetrics(ID2D1Factory3* This) {
    return This->lpVtbl->ReloadSystemMetrics(This);
}
static FORCEINLINE void ID2D1Factory3_GetDesktopDpi(ID2D1Factory3* This,float *dpi_x,float *dpi_y) {
    This->lpVtbl->GetDesktopDpi(This,dpi_x,dpi_y);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateRectangleGeometry(ID2D1Factory3* This,const D2D1_RECT_F *rect,ID2D1RectangleGeometry **geometry) {
    return This->lpVtbl->CreateRectangleGeometry(This,rect,geometry);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateRoundedRectangleGeometry(ID2D1Factory3* This,const D2D1_ROUNDED_RECT *rect,ID2D1RoundedRectangleGeometry **geometry) {
    return This->lpVtbl->CreateRoundedRectangleGeometry(This,rect,geometry);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateEllipseGeometry(ID2D1Factory3* This,const D2D1_ELLIPSE *ellipse,ID2D1EllipseGeometry **geometry) {
    return This->lpVtbl->CreateEllipseGeometry(This,ellipse,geometry);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateGeometryGroup(ID2D1Factory3* This,D2D1_FILL_MODE fill_mode,ID2D1Geometry **geometries,UINT32 geometry_count,ID2D1GeometryGroup **group) {
    return This->lpVtbl->CreateGeometryGroup(This,fill_mode,geometries,geometry_count,group);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateTransformedGeometry(ID2D1Factory3* This,ID2D1Geometry *src_geometry,const D2D1_MATRIX_3X2_F *transform,ID2D1TransformedGeometry **transformed_geometry) {
    return This->lpVtbl->CreateTransformedGeometry(This,src_geometry,transform,transformed_geometry);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateWicBitmapRenderTarget(ID2D1Factory3* This,IWICBitmap *target,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1RenderTarget **render_target) {
    return This->lpVtbl->CreateWicBitmapRenderTarget(This,target,desc,render_target);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateHwndRenderTarget(ID2D1Factory3* This,const D2D1_RENDER_TARGET_PROPERTIES *desc,const D2D1_HWND_RENDER_TARGET_PROPERTIES *hwnd_rt_desc,ID2D1HwndRenderTarget **render_target) {
    return This->lpVtbl->CreateHwndRenderTarget(This,desc,hwnd_rt_desc,render_target);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateDxgiSurfaceRenderTarget(ID2D1Factory3* This,IDXGISurface *surface,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1RenderTarget **render_target) {
    return This->lpVtbl->CreateDxgiSurfaceRenderTarget(This,surface,desc,render_target);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateDCRenderTarget(ID2D1Factory3* This,const D2D1_RENDER_TARGET_PROPERTIES *desc,ID2D1DCRenderTarget **render_target) {
    return This->lpVtbl->CreateDCRenderTarget(This,desc,render_target);
}
/*** ID2D1Factory1 methods ***/
static FORCEINLINE HRESULT ID2D1Factory3_CreateStrokeStyle(ID2D1Factory3* This,const D2D1_STROKE_STYLE_PROPERTIES1 *desc,const float *dashes,UINT32 dash_count,ID2D1StrokeStyle1 **stroke_style) {
    return This->lpVtbl->ID2D1Factory1_CreateStrokeStyle(This,desc,dashes,dash_count,stroke_style);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreatePathGeometry(ID2D1Factory3* This,ID2D1PathGeometry1 **geometry) {
    return This->lpVtbl->ID2D1Factory1_CreatePathGeometry(This,geometry);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateDrawingStateBlock(ID2D1Factory3* This,const D2D1_DRAWING_STATE_DESCRIPTION1 *desc,IDWriteRenderingParams *text_rendering_params,ID2D1DrawingStateBlock1 **state_block) {
    return This->lpVtbl->ID2D1Factory1_CreateDrawingStateBlock(This,desc,text_rendering_params,state_block);
}
static FORCEINLINE HRESULT ID2D1Factory3_CreateGdiMetafile(ID2D1Factory3* This,IStream *stream,ID2D1GdiMetafile **metafile) {
    return This->lpVtbl->CreateGdiMetafile(This,stream,metafile);
}
static FORCEINLINE HRESULT ID2D1Factory3_RegisterEffectFromStream(ID2D1Factory3* This,REFCLSID effect_id,IStream *property_xml,const D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromStream(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static FORCEINLINE HRESULT ID2D1Factory3_RegisterEffectFromString(ID2D1Factory3* This,REFCLSID effect_id,const WCHAR *property_xml,const D2D1_PROPERTY_BINDING *bindings,UINT32 binding_count,PD2D1_EFFECT_FACTORY effect_factory) {
    return This->lpVtbl->RegisterEffectFromString(This,effect_id,property_xml,bindings,binding_count,effect_factory);
}
static FORCEINLINE HRESULT ID2D1Factory3_UnregisterEffect(ID2D1Factory3* This,REFCLSID effect_id) {
    return This->lpVtbl->UnregisterEffect(This,effect_id);
}
static FORCEINLINE HRESULT ID2D1Factory3_GetRegisteredEffects(ID2D1Factory3* This,CLSID *effects,UINT32 effect_count,UINT32 *returned,UINT32 *registered) {
    return This->lpVtbl->GetRegisteredEffects(This,effects,effect_count,returned,registered);
}
static FORCEINLINE HRESULT ID2D1Factory3_GetEffectProperties(ID2D1Factory3* This,REFCLSID effect_id,ID2D1Properties **props) {
    return This->lpVtbl->GetEffectProperties(This,effect_id,props);
}
/*** ID2D1Factory2 methods ***/
/*** ID2D1Factory3 methods ***/
static FORCEINLINE HRESULT ID2D1Factory3_CreateDevice(ID2D1Factory3* This,IDXGIDevice *dxgi_device,ID2D1Device2 **d2d_device) {
