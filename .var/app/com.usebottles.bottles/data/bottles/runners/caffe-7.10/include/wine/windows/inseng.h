/*** Autogenerated by WIDL 7.10 from ../wine-mirror-git/include/inseng.idl - Do not edit ***/
...
#else
/*** ICifComponent methods ***/
static FORCEINLINE HRESULT ICifComponent_GetID(ICifComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifComponent_GetGUID(ICifComponent* This,char *guid,DWORD size) {
    return This->lpVtbl->GetGUID(This,guid,size);
}
static FORCEINLINE HRESULT ICifComponent_GetDescription(ICifComponent* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE HRESULT ICifComponent_GetDetails(ICifComponent* This,char *details,DWORD size) {
    return This->lpVtbl->GetDetails(This,details,size);
}
static FORCEINLINE HRESULT ICifComponent_GetUrl(ICifComponent* This,UINT index,char *url,DWORD size,DWORD *flags) {
    return This->lpVtbl->GetUrl(This,index,url,size,flags);
}
static FORCEINLINE HRESULT ICifComponent_GetFileExtractList(ICifComponent* This,UINT index,char *extract,DWORD size) {
    return This->lpVtbl->GetFileExtractList(This,index,extract,size);
}
static FORCEINLINE HRESULT ICifComponent_GetUrlCheckRange(ICifComponent* This,UINT index,DWORD *min,DWORD *max) {
    return This->lpVtbl->GetUrlCheckRange(This,index,min,max);
}
static FORCEINLINE HRESULT ICifComponent_GetCommand(ICifComponent* This,UINT index,char *cmd,DWORD cmd_size,char *switches,DWORD switch_size,DWORD *type) {
    return This->lpVtbl->GetCommand(This,index,cmd,cmd_size,switches,switch_size,type);
}
static FORCEINLINE HRESULT ICifComponent_GetVersion(ICifComponent* This,DWORD *version,DWORD *build) {
    return This->lpVtbl->GetVersion(This,version,build);
}
static FORCEINLINE HRESULT ICifComponent_GetLocale(ICifComponent* This,char *pszLocale,DWORD size) {
    return This->lpVtbl->GetLocale(This,pszLocale,size);
}
static FORCEINLINE HRESULT ICifComponent_GetUninstallKey(ICifComponent* This,char *key,DWORD size) {
    return This->lpVtbl->GetUninstallKey(This,key,size);
}
static FORCEINLINE HRESULT ICifComponent_GetInstalledSize(ICifComponent* This,DWORD *win,DWORD *app) {
    return This->lpVtbl->GetInstalledSize(This,win,app);
}
static FORCEINLINE DWORD ICifComponent_GetDownloadSize(ICifComponent* This) {
    return This->lpVtbl->GetDownloadSize(This);
}
static FORCEINLINE DWORD ICifComponent_GetExtractSize(ICifComponent* This) {
    return This->lpVtbl->GetExtractSize(This);
}
static FORCEINLINE HRESULT ICifComponent_GetSuccessKey(ICifComponent* This,char *key,DWORD size) {
    return This->lpVtbl->GetSuccessKey(This,key,size);
}
static FORCEINLINE HRESULT ICifComponent_GetProgressKeys(ICifComponent* This,char *progress,DWORD progress_size,char *cancel,DWORD cancel_size) {
    return This->lpVtbl->GetProgressKeys(This,progress,progress_size,cancel,cancel_size);
}
static FORCEINLINE HRESULT ICifComponent_IsActiveSetupAware(ICifComponent* This) {
    return This->lpVtbl->IsActiveSetupAware(This);
}
static FORCEINLINE HRESULT ICifComponent_IsRebootRequired(ICifComponent* This) {
    return This->lpVtbl->IsRebootRequired(This);
}
static FORCEINLINE HRESULT ICifComponent_RequiresAdminRights(ICifComponent* This) {
    return This->lpVtbl->RequiresAdminRights(This);
}
static FORCEINLINE DWORD ICifComponent_GetPriority(ICifComponent* This) {
    return This->lpVtbl->GetPriority(This);
}
static FORCEINLINE HRESULT ICifComponent_GetDependency(ICifComponent* This,UINT index,char *id,DWORD buf,char *type,DWORD *ver,DWORD *build) {
    return This->lpVtbl->GetDependency(This,index,id,buf,type,ver,build);
}
static FORCEINLINE DWORD ICifComponent_GetPlatform(ICifComponent* This) {
    return This->lpVtbl->GetPlatform(This);
}
static FORCEINLINE HRESULT ICifComponent_GetMode(ICifComponent* This,UINT index,char *mode,DWORD size) {
    return This->lpVtbl->GetMode(This,index,mode,size);
}
static FORCEINLINE HRESULT ICifComponent_GetGroup(ICifComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetGroup(This,id,size);
}
static FORCEINLINE HRESULT ICifComponent_IsUIVisible(ICifComponent* This) {
    return This->lpVtbl->IsUIVisible(This);
}
static FORCEINLINE HRESULT ICifComponent_GetPatchID(ICifComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetPatchID(This,id,size);
}
static FORCEINLINE HRESULT ICifComponent_GetDetVersion(ICifComponent* This,char *dll,DWORD dll_size,char *entry,DWORD entry_size) {
    return This->lpVtbl->GetDetVersion(This,dll,dll_size,entry,entry_size);
}
static FORCEINLINE HRESULT ICifComponent_GetTreatAsOneComponents(ICifComponent* This,UINT index,char *id,DWORD buf) {
    return This->lpVtbl->GetTreatAsOneComponents(This,index,id,buf);
}
static FORCEINLINE HRESULT ICifComponent_GetCustomData(ICifComponent* This,char *key,char *data,DWORD size) {
    return This->lpVtbl->GetCustomData(This,key,data,size);
}
static FORCEINLINE DWORD ICifComponent_IsComponentInstalled(ICifComponent* This) {
    return This->lpVtbl->IsComponentInstalled(This);
}
static FORCEINLINE HRESULT ICifComponent_IsComponentDownloaded(ICifComponent* This) {
    return This->lpVtbl->IsComponentDownloaded(This);
}
static FORCEINLINE DWORD ICifComponent_IsThisVersionInstalled(ICifComponent* This,DWORD version,DWORD build,DWORD *ret_version,DWORD *ret_build) {
    return This->lpVtbl->IsThisVersionInstalled(This,version,build,ret_version,ret_build);
}
static FORCEINLINE DWORD ICifComponent_GetInstallQueueState(ICifComponent* This) {
    return This->lpVtbl->GetInstallQueueState(This);
}
static FORCEINLINE HRESULT ICifComponent_SetInstallQueueState(ICifComponent* This,DWORD state) {
    return This->lpVtbl->SetInstallQueueState(This,state);
}
static FORCEINLINE DWORD ICifComponent_GetActualDownloadSize(ICifComponent* This) {
    return This->lpVtbl->GetActualDownloadSize(This);
}
static FORCEINLINE DWORD ICifComponent_GetCurrentPriority(ICifComponent* This) {
    return This->lpVtbl->GetCurrentPriority(This);
}
static FORCEINLINE HRESULT ICifComponent_SetCurrentPriority(ICifComponent* This,DWORD priority) {
...
#else
/*** ICifComponent methods ***/
static FORCEINLINE HRESULT ICifRWComponent_GetID(ICifRWComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetGUID(ICifRWComponent* This,char *guid,DWORD size) {
    return This->lpVtbl->GetGUID(This,guid,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetDescription(ICifRWComponent* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetDetails(ICifRWComponent* This,char *details,DWORD size) {
    return This->lpVtbl->GetDetails(This,details,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetUrl(ICifRWComponent* This,UINT index,char *url,DWORD size,DWORD *flags) {
    return This->lpVtbl->GetUrl(This,index,url,size,flags);
}
static FORCEINLINE HRESULT ICifRWComponent_GetFileExtractList(ICifRWComponent* This,UINT index,char *extract,DWORD size) {
    return This->lpVtbl->GetFileExtractList(This,index,extract,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetUrlCheckRange(ICifRWComponent* This,UINT index,DWORD *min,DWORD *max) {
    return This->lpVtbl->GetUrlCheckRange(This,index,min,max);
}
static FORCEINLINE HRESULT ICifRWComponent_GetCommand(ICifRWComponent* This,UINT index,char *cmd,DWORD cmd_size,char *switches,DWORD switch_size,DWORD *type) {
    return This->lpVtbl->GetCommand(This,index,cmd,cmd_size,switches,switch_size,type);
}
static FORCEINLINE HRESULT ICifRWComponent_GetVersion(ICifRWComponent* This,DWORD *version,DWORD *build) {
    return This->lpVtbl->GetVersion(This,version,build);
}
static FORCEINLINE HRESULT ICifRWComponent_GetLocale(ICifRWComponent* This,char *pszLocale,DWORD size) {
    return This->lpVtbl->GetLocale(This,pszLocale,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetUninstallKey(ICifRWComponent* This,char *key,DWORD size) {
    return This->lpVtbl->GetUninstallKey(This,key,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetInstalledSize(ICifRWComponent* This,DWORD *win,DWORD *app) {
    return This->lpVtbl->GetInstalledSize(This,win,app);
}
static FORCEINLINE DWORD ICifRWComponent_GetDownloadSize(ICifRWComponent* This) {
    return This->lpVtbl->GetDownloadSize(This);
}
static FORCEINLINE DWORD ICifRWComponent_GetExtractSize(ICifRWComponent* This) {
    return This->lpVtbl->GetExtractSize(This);
}
static FORCEINLINE HRESULT ICifRWComponent_GetSuccessKey(ICifRWComponent* This,char *key,DWORD size) {
    return This->lpVtbl->GetSuccessKey(This,key,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetProgressKeys(ICifRWComponent* This,char *progress,DWORD progress_size,char *cancel,DWORD cancel_size) {
    return This->lpVtbl->GetProgressKeys(This,progress,progress_size,cancel,cancel_size);
}
static FORCEINLINE HRESULT ICifRWComponent_IsActiveSetupAware(ICifRWComponent* This) {
    return This->lpVtbl->IsActiveSetupAware(This);
}
static FORCEINLINE HRESULT ICifRWComponent_IsRebootRequired(ICifRWComponent* This) {
    return This->lpVtbl->IsRebootRequired(This);
}
static FORCEINLINE HRESULT ICifRWComponent_RequiresAdminRights(ICifRWComponent* This) {
    return This->lpVtbl->RequiresAdminRights(This);
}
static FORCEINLINE DWORD ICifRWComponent_GetPriority(ICifRWComponent* This) {
    return This->lpVtbl->GetPriority(This);
}
static FORCEINLINE HRESULT ICifRWComponent_GetDependency(ICifRWComponent* This,UINT index,char *id,DWORD buf,char *type,DWORD *ver,DWORD *build) {
    return This->lpVtbl->GetDependency(This,index,id,buf,type,ver,build);
}
static FORCEINLINE DWORD ICifRWComponent_GetPlatform(ICifRWComponent* This) {
    return This->lpVtbl->GetPlatform(This);
}
static FORCEINLINE HRESULT ICifRWComponent_GetMode(ICifRWComponent* This,UINT index,char *mode,DWORD size) {
    return This->lpVtbl->GetMode(This,index,mode,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetGroup(ICifRWComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetGroup(This,id,size);
}
static FORCEINLINE HRESULT ICifRWComponent_IsUIVisible(ICifRWComponent* This) {
    return This->lpVtbl->IsUIVisible(This);
}
static FORCEINLINE HRESULT ICifRWComponent_GetPatchID(ICifRWComponent* This,char *id,DWORD size) {
    return This->lpVtbl->GetPatchID(This,id,size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetDetVersion(ICifRWComponent* This,char *dll,DWORD dll_size,char *entry,DWORD entry_size) {
    return This->lpVtbl->GetDetVersion(This,dll,dll_size,entry,entry_size);
}
static FORCEINLINE HRESULT ICifRWComponent_GetTreatAsOneComponents(ICifRWComponent* This,UINT index,char *id,DWORD buf) {
    return This->lpVtbl->GetTreatAsOneComponents(This,index,id,buf);
}
static FORCEINLINE HRESULT ICifRWComponent_GetCustomData(ICifRWComponent* This,char *key,char *data,DWORD size) {
    return This->lpVtbl->GetCustomData(This,key,data,size);
}
static FORCEINLINE DWORD ICifRWComponent_IsComponentInstalled(ICifRWComponent* This) {
    return This->lpVtbl->IsComponentInstalled(This);
}
static FORCEINLINE HRESULT ICifRWComponent_IsComponentDownloaded(ICifRWComponent* This) {
    return This->lpVtbl->IsComponentDownloaded(This);
}
static FORCEINLINE DWORD ICifRWComponent_IsThisVersionInstalled(ICifRWComponent* This,DWORD version,DWORD build,DWORD *ret_version,DWORD *ret_build) {
    return This->lpVtbl->IsThisVersionInstalled(This,version,build,ret_version,ret_build);
}
static FORCEINLINE DWORD ICifRWComponent_GetInstallQueueState(ICifRWComponent* This) {
    return This->lpVtbl->GetInstallQueueState(This);
}
static FORCEINLINE HRESULT ICifRWComponent_SetInstallQueueState(ICifRWComponent* This,DWORD state) {
    return This->lpVtbl->SetInstallQueueState(This,state);
}
static FORCEINLINE DWORD ICifRWComponent_GetActualDownloadSize(ICifRWComponent* This) {
    return This->lpVtbl->GetActualDownloadSize(This);
}
static FORCEINLINE DWORD ICifRWComponent_GetCurrentPriority(ICifRWComponent* This) {
    return This->lpVtbl->GetCurrentPriority(This);
}
static FORCEINLINE HRESULT ICifRWComponent_SetCurrentPriority(ICifRWComponent* This,DWORD priority) {
    return This->lpVtbl->SetCurrentPriority(This,priority);
}
/*** ICifRWComponent methods ***/
static FORCEINLINE HRESULT ICifRWComponent_SetGUID(ICifRWComponent* This,const char *guid) {
    return This->lpVtbl->SetGUID(This,guid);
}
static FORCEINLINE HRESULT ICifRWComponent_SetDescription(ICifRWComponent* This,const char *desc) {
    return This->lpVtbl->SetDescription(This,desc);
}
static FORCEINLINE HRESULT ICifRWComponent_SetUrl(ICifRWComponent* This,UINT index,const char *url,DWORD url_flags) {
    return This->lpVtbl->SetUrl(This,index,url,url_flags);
}
static FORCEINLINE HRESULT ICifRWComponent_SetCommand(ICifRWComponent* This,UINT index,const char *cmd,const char *switches,DWORD type) {
    return This->lpVtbl->SetCommand(This,index,cmd,switches,type);
}
static FORCEINLINE HRESULT ICifRWComponent_SetVersion(ICifRWComponent* This,const char *version) {
    return This->lpVtbl->SetVersion(This,version);
}
static FORCEINLINE HRESULT ICifRWComponent_SetUninstallKey(ICifRWComponent* This,const char *key) {
    return This->lpVtbl->SetUninstallKey(This,key);
}
static FORCEINLINE HRESULT ICifRWComponent_SetInstalledSize(ICifRWComponent* This,DWORD win,DWORD app) {
    return This->lpVtbl->SetInstalledSize(This,win,app);
}
static FORCEINLINE HRESULT ICifRWComponent_SetDownloadSize(ICifRWComponent* This,DWORD size) {
    return This->lpVtbl->SetDownloadSize(This,size);
}
static FORCEINLINE HRESULT ICifRWComponent_SetExtractSize(ICifRWComponent* This,DWORD size) {
    return This->lpVtbl->SetExtractSize(This,size);
}
static FORCEINLINE HRESULT ICifRWComponent_DeleteDependency(ICifRWComponent* This,const char *id,char type) {
    return This->lpVtbl->DeleteDependency(This,id,type);
}
static FORCEINLINE HRESULT ICifRWComponent_AddDependency(ICifRWComponent* This,const char *id,char type) {
    return This->lpVtbl->AddDependency(This,id,type);
}
static FORCEINLINE HRESULT ICifRWComponent_SetUIVisible(ICifRWComponent* This,BOOL visible) {
    return This->lpVtbl->SetUIVisible(This,visible);
}
static FORCEINLINE HRESULT ICifRWComponent_SetGroup(ICifRWComponent* This,const char *id) {
    return This->lpVtbl->SetGroup(This,id);
}
static FORCEINLINE HRESULT ICifRWComponent_SetPlatform(ICifRWComponent* This,DWORD platform) {
    return This->lpVtbl->SetPlatform(This,platform);
}
static FORCEINLINE HRESULT ICifRWComponent_SetPriority(ICifRWComponent* This,DWORD priority) {
    return This->lpVtbl->SetPriority(This,priority);
}
static FORCEINLINE HRESULT ICifRWComponent_SetReboot(ICifRWComponent* This,BOOL reboot) {
    return This->lpVtbl->SetReboot(This,reboot);
}
static FORCEINLINE HRESULT ICifRWComponent_DeleteFromModes(ICifRWComponent* This,const char *mode) {
    return This->lpVtbl->DeleteFromModes(This,mode);
}
static FORCEINLINE HRESULT ICifRWComponent_AddToMode(ICifRWComponent* This,const char *mode) {
    return This->lpVtbl->AddToMode(This,mode);
}
static FORCEINLINE HRESULT ICifRWComponent_SetModes(ICifRWComponent* This,const char *mode) {
    return This->lpVtbl->SetModes(This,mode);
}
static FORCEINLINE HRESULT ICifRWComponent_CopyComponent(ICifRWComponent* This,const char *ciffile) {
    return This->lpVtbl->CopyComponent(This,ciffile);
}
static FORCEINLINE HRESULT ICifRWComponent_AddToTreatAsOne(ICifRWComponent* This,const char *compid) {
    return This->lpVtbl->AddToTreatAsOne(This,compid);
}
static FORCEINLINE HRESULT ICifRWComponent_SetDetails(ICifRWComponent* This,const char *desc) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IEnumCifComponents_QueryInterface(IEnumCifComponents* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IEnumCifComponents_AddRef(IEnumCifComponents* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IEnumCifComponents_Release(IEnumCifComponents* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumCifComponents methods ***/
static FORCEINLINE HRESULT IEnumCifComponents_Next(IEnumCifComponents* This,ICifComponent **a) {
    return This->lpVtbl->Next(This,a);
}
static FORCEINLINE HRESULT IEnumCifComponents_Reset(IEnumCifComponents* This) {
...
#else
/*** ICifGroup methods ***/
static FORCEINLINE HRESULT ICifGroup_GetID(ICifGroup* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifGroup_GetDescription(ICifGroup* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE DWORD ICifGroup_GetPriority(ICifGroup* This) {
    return This->lpVtbl->GetPriority(This);
}
static FORCEINLINE HRESULT ICifGroup_EnumComponents(ICifGroup* This,IEnumCifComponents **a,DWORD filter,void *pv) {
    return This->lpVtbl->EnumComponents(This,a,filter,pv);
}
static FORCEINLINE DWORD ICifGroup_GetCurrentPriority(ICifGroup* This) {
    return This->lpVtbl->GetCurrentPriority(This);
}
#endif
#endif
...
#else
/*** ICifGroup methods ***/
static FORCEINLINE HRESULT ICifRWGroup_GetID(ICifRWGroup* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifRWGroup_GetDescription(ICifRWGroup* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE DWORD ICifRWGroup_GetPriority(ICifRWGroup* This) {
    return This->lpVtbl->GetPriority(This);
}
static FORCEINLINE HRESULT ICifRWGroup_EnumComponents(ICifRWGroup* This,IEnumCifComponents **a,DWORD filter,void *pv) {
    return This->lpVtbl->EnumComponents(This,a,filter,pv);
}
static FORCEINLINE DWORD ICifRWGroup_GetCurrentPriority(ICifRWGroup* This) {
    return This->lpVtbl->GetCurrentPriority(This);
}
/*** ICifRWGroup methods ***/
static FORCEINLINE HRESULT ICifRWGroup_SetDescription(ICifRWGroup* This,const char *desc) {
    return This->lpVtbl->SetDescription(This,desc);
}
static FORCEINLINE HRESULT ICifRWGroup_SetPriority(ICifRWGroup* This,DWORD priority) {
    return This->lpVtbl->SetPriority(This,priority);
}
static FORCEINLINE HRESULT ICifRWGroup_SetDetails(ICifRWGroup* This,const char *details) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IEnumCifGroups_QueryInterface(IEnumCifGroups* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IEnumCifGroups_AddRef(IEnumCifGroups* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IEnumCifGroups_Release(IEnumCifGroups* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumCifGroups methods ***/
static FORCEINLINE HRESULT IEnumCifGroups_Next(IEnumCifGroups* This,ICifGroup **a) {
    return This->lpVtbl->Next(This,a);
}
static FORCEINLINE HRESULT IEnumCifGroups_Reset(IEnumCifGroups* This) {
    return This->lpVtbl->Reset(This);
}
#endif
#endif
...
#else
/*** ICifMode methods ***/
static FORCEINLINE HRESULT ICifMode_GetID(ICifMode* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifMode_GetDescription(ICifMode* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE HRESULT ICifMode_GetDetails(ICifMode* This,char *details,DWORD size) {
    return This->lpVtbl->GetDetails(This,details,size);
}
static FORCEINLINE HRESULT ICifMode_EnumComponents(ICifMode* This,IEnumCifComponents **a,DWORD filter,void *pv) {
    return This->lpVtbl->EnumComponents(This,a,filter,pv);
}
#endif
#endif
...
#else
/*** ICifMode methods ***/
static FORCEINLINE HRESULT ICifRWMode_GetID(ICifRWMode* This,char *id,DWORD size) {
    return This->lpVtbl->GetID(This,id,size);
}
static FORCEINLINE HRESULT ICifRWMode_GetDescription(ICifRWMode* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE HRESULT ICifRWMode_GetDetails(ICifRWMode* This,char *details,DWORD size) {
    return This->lpVtbl->GetDetails(This,details,size);
}
static FORCEINLINE HRESULT ICifRWMode_EnumComponents(ICifRWMode* This,IEnumCifComponents **a,DWORD filter,void *pv) {
    return This->lpVtbl->EnumComponents(This,a,filter,pv);
}
/*** ICifRWMode methods ***/
static FORCEINLINE HRESULT ICifRWMode_SetDescription(ICifRWMode* This,const char *desc) {
    return This->lpVtbl->SetDescription(This,desc);
}
static FORCEINLINE HRESULT ICifRWMode_SetDetails(ICifRWMode* This,const char *details) {
    return This->lpVtbl->SetDetails(This,details);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IEnumCifModes_QueryInterface(IEnumCifModes* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IEnumCifModes_AddRef(IEnumCifModes* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IEnumCifModes_Release(IEnumCifModes* This) {
    return This->lpVtbl->Release(This);
}
/*** IEnumCifModes methods ***/
static FORCEINLINE HRESULT IEnumCifModes_Next(IEnumCifModes* This,ICifMode **a) {
    return This->lpVtbl->Next(This,a);
}
static FORCEINLINE HRESULT IEnumCifModes_Reset(IEnumCifModes* This) {
    return This->lpVtbl->Reset(This);
}
#endif
#endif
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT ICifRWFile_QueryInterface(ICifRWFile* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG ICifRWFile_AddRef(ICifRWFile* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG ICifRWFile_Release(ICifRWFile* This) {
    return This->lpVtbl->Release(This);
}
/*** ICifFile methods ***/
static FORCEINLINE HRESULT ICifRWFile_EnumComponents(ICifRWFile* This,IEnumCifComponents **enum_components,DWORD filter,void *pv) {
    return This->lpVtbl->EnumComponents(This,enum_components,filter,pv);
}
static FORCEINLINE HRESULT ICifRWFile_FindComponent(ICifRWFile* This,const char *id,ICifComponent **p) {
    return This->lpVtbl->FindComponent(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_EnumGroups(ICifRWFile* This,IEnumCifGroups **enum_groups,DWORD filter,void *pv) {
    return This->lpVtbl->EnumGroups(This,enum_groups,filter,pv);
}
static FORCEINLINE HRESULT ICifRWFile_FindGroup(ICifRWFile* This,const char *id,ICifGroup **p) {
    return This->lpVtbl->FindGroup(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_EnumModes(ICifRWFile* This,IEnumCifModes **cuf_modes,DWORD filter,void *pv) {
    return This->lpVtbl->EnumModes(This,cuf_modes,filter,pv);
}
static FORCEINLINE HRESULT ICifRWFile_FindMode(ICifRWFile* This,const char *id,ICifMode **p) {
    return This->lpVtbl->FindMode(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_GetDescription(ICifRWFile* This,char *desc,DWORD size) {
    return This->lpVtbl->GetDescription(This,desc,size);
}
static FORCEINLINE HRESULT ICifRWFile_GetDetDlls(ICifRWFile* This,char *dlls,DWORD size) {
    return This->lpVtbl->GetDetDlls(This,dlls,size);
}
/*** ICifRWFile methods ***/
static FORCEINLINE HRESULT ICifRWFile_SetDescription(ICifRWFile* This,const char *desc) {
    return This->lpVtbl->SetDescription(This,desc);
}
static FORCEINLINE HRESULT ICifRWFile_CreateComponent(ICifRWFile* This,const char *id,ICifRWComponent **p) {
    return This->lpVtbl->CreateComponent(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_CreateGroup(ICifRWFile* This,const char *id,ICifRWGroup **p) {
    return This->lpVtbl->CreateGroup(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_CreateMode(ICifRWFile* This,const char *id,ICifRWMode **p) {
    return This->lpVtbl->CreateMode(This,id,p);
}
static FORCEINLINE HRESULT ICifRWFile_DeleteComponent(ICifRWFile* This,const char *id) {
    return This->lpVtbl->DeleteComponent(This,id);
}
static FORCEINLINE HRESULT ICifRWFile_DeleteGroup(ICifRWFile* This,const char *id) {
    return This->lpVtbl->DeleteGroup(This,id);
}
static FORCEINLINE HRESULT ICifRWFile_DeleteMode(ICifRWFile* This,const char *id) {
    return This->lpVtbl->DeleteMode(This,id);
}
static FORCEINLINE HRESULT ICifRWFile_Flush(ICifRWFile* This) {
...
static FORCEINLINE HRESULT IInstallEngineCallback_OnEngineProblem(IInstallEngineCallback* This,DWORD problem,DWORD *action) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IInstallEngineTiming_QueryInterface(IInstallEngineTiming* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IInstallEngineTiming_AddRef(IInstallEngineTiming* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IInstallEngineTiming_Release(IInstallEngineTiming* This) {
    return This->lpVtbl->Release(This);
}
/*** IInstallEngineTiming methods ***/
static FORCEINLINE HRESULT IInstallEngineTiming_GetRates(IInstallEngineTiming* This,DWORD *download,DWORD *install) {
    return This->lpVtbl->GetRates(This,download,install);
}
static FORCEINLINE HRESULT IInstallEngineTiming_GetInstallProgress(IInstallEngineTiming* This,INSTALLPROGRESS *progress) {
