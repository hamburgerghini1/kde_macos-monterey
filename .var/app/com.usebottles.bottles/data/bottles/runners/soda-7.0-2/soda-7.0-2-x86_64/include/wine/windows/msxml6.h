/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/msxml6.idl - Do not edit ***/
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2_QueryInterface(IXMLHTTPRequest2* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IXMLHTTPRequest2_AddRef(IXMLHTTPRequest2* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IXMLHTTPRequest2_Release(IXMLHTTPRequest2* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLHTTPRequest2 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2_Open(IXMLHTTPRequest2* This,const WCHAR *method,const WCHAR *url,IXMLHTTPRequest2Callback *callback,const WCHAR *username,const WCHAR *password,const WCHAR *proxyuser,const WCHAR *proxypassword) {
    return This->lpVtbl->Open(This,method,url,callback,username,password,proxyuser,proxypassword);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_Send(IXMLHTTPRequest2* This,ISequentialStream *body,ULONGLONG length) {
    return This->lpVtbl->Send(This,body,length);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_Abort(IXMLHTTPRequest2* This) {
    return This->lpVtbl->Abort(This);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_SetCookie(IXMLHTTPRequest2* This,const XHR_COOKIE *cookie,DWORD *state) {
    return This->lpVtbl->SetCookie(This,cookie,state);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_SetCustomResponseStream(IXMLHTTPRequest2* This,ISequentialStream *stream) {
    return This->lpVtbl->SetCustomResponseStream(This,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_SetProperty(IXMLHTTPRequest2* This,XHR_PROPERTY property,ULONGLONG value) {
    return This->lpVtbl->SetProperty(This,property,value);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_SetRequestHeader(IXMLHTTPRequest2* This,const WCHAR *header,const WCHAR *value) {
    return This->lpVtbl->SetRequestHeader(This,header,value);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_GetAllResponseHeaders(IXMLHTTPRequest2* This,WCHAR **headers) {
    return This->lpVtbl->GetAllResponseHeaders(This,headers);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_GetCookie(IXMLHTTPRequest2* This,const WCHAR *url,const WCHAR *name,DWORD flags,ULONG *cookies_cnt,XHR_COOKIE **cookies) {
    return This->lpVtbl->GetCookie(This,url,name,flags,cookies_cnt,cookies);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2_GetResponseHeader(IXMLHTTPRequest2* This,const WCHAR *header,WCHAR **value) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3_QueryInterface(IXMLHTTPRequest3* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IXMLHTTPRequest3_AddRef(IXMLHTTPRequest3* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IXMLHTTPRequest3_Release(IXMLHTTPRequest3* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLHTTPRequest2 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3_Open(IXMLHTTPRequest3* This,const WCHAR *method,const WCHAR *url,IXMLHTTPRequest2Callback *callback,const WCHAR *username,const WCHAR *password,const WCHAR *proxyuser,const WCHAR *proxypassword) {
    return This->lpVtbl->Open(This,method,url,callback,username,password,proxyuser,proxypassword);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_Send(IXMLHTTPRequest3* This,ISequentialStream *body,ULONGLONG length) {
    return This->lpVtbl->Send(This,body,length);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_Abort(IXMLHTTPRequest3* This) {
    return This->lpVtbl->Abort(This);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetCookie(IXMLHTTPRequest3* This,const XHR_COOKIE *cookie,DWORD *state) {
    return This->lpVtbl->SetCookie(This,cookie,state);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetCustomResponseStream(IXMLHTTPRequest3* This,ISequentialStream *stream) {
    return This->lpVtbl->SetCustomResponseStream(This,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetProperty(IXMLHTTPRequest3* This,XHR_PROPERTY property,ULONGLONG value) {
    return This->lpVtbl->SetProperty(This,property,value);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetRequestHeader(IXMLHTTPRequest3* This,const WCHAR *header,const WCHAR *value) {
    return This->lpVtbl->SetRequestHeader(This,header,value);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_GetAllResponseHeaders(IXMLHTTPRequest3* This,WCHAR **headers) {
    return This->lpVtbl->GetAllResponseHeaders(This,headers);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_GetCookie(IXMLHTTPRequest3* This,const WCHAR *url,const WCHAR *name,DWORD flags,ULONG *cookies_cnt,XHR_COOKIE **cookies) {
    return This->lpVtbl->GetCookie(This,url,name,flags,cookies_cnt,cookies);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3_GetResponseHeader(IXMLHTTPRequest3* This,const WCHAR *header,WCHAR **value) {
    return This->lpVtbl->GetResponseHeader(This,header,value);
}
/*** IXMLHTTPRequest3 methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3_SetClientCertificate(IXMLHTTPRequest3* This,DWORD count,const BYTE *hashes,const WCHAR *pin) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_QueryInterface(IXMLHTTPRequest2Callback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IXMLHTTPRequest2Callback_AddRef(IXMLHTTPRequest2Callback* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IXMLHTTPRequest2Callback_Release(IXMLHTTPRequest2Callback* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLHTTPRequest2Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnRedirect(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *xhr,const WCHAR *url) {
    return This->lpVtbl->OnRedirect(This,xhr,url);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnHeadersAvailable(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *xhr,DWORD status,const WCHAR *msg) {
    return This->lpVtbl->OnHeadersAvailable(This,xhr,status,msg);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnDataAvailable(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *xhr,ISequentialStream *stream) {
    return This->lpVtbl->OnDataAvailable(This,xhr,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnResponseReceived(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *xhr,ISequentialStream *stream) {
    return This->lpVtbl->OnResponseReceived(This,xhr,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest2Callback_OnError(IXMLHTTPRequest2Callback* This,IXMLHTTPRequest2 *xhr,HRESULT error) {
...
#else
/*** IUnknown methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_QueryInterface(IXMLHTTPRequest3Callback* This,REFIID riid,void **ppvObject) {
    return This->lpVtbl->QueryInterface(This,riid,ppvObject);
}
static FORCEINLINE ULONG IXMLHTTPRequest3Callback_AddRef(IXMLHTTPRequest3Callback* This) {
    return This->lpVtbl->AddRef(This);
}
static FORCEINLINE ULONG IXMLHTTPRequest3Callback_Release(IXMLHTTPRequest3Callback* This) {
    return This->lpVtbl->Release(This);
}
/*** IXMLHTTPRequest2Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnRedirect(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *xhr,const WCHAR *url) {
    return This->lpVtbl->OnRedirect(This,xhr,url);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnHeadersAvailable(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *xhr,DWORD status,const WCHAR *msg) {
    return This->lpVtbl->OnHeadersAvailable(This,xhr,status,msg);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnDataAvailable(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *xhr,ISequentialStream *stream) {
    return This->lpVtbl->OnDataAvailable(This,xhr,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnResponseReceived(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *xhr,ISequentialStream *stream) {
    return This->lpVtbl->OnResponseReceived(This,xhr,stream);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnError(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest2 *xhr,HRESULT error) {
    return This->lpVtbl->OnError(This,xhr,error);
}
/*** IXMLHTTPRequest3Callback methods ***/
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnServerCertificateReceived(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest3 *xhr,DWORD errors,DWORD count,const XHR_CERT *certificates) {
    return This->lpVtbl->OnServerCertificateReceived(This,xhr,errors,count,certificates);
}
static FORCEINLINE HRESULT IXMLHTTPRequest3Callback_OnClientCertificateRequested(IXMLHTTPRequest3Callback* This,IXMLHTTPRequest3 *xhr,DWORD count,const WCHAR **list) {
