/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/audioclient.idl - Do not edit ***/
...
/*** IAudioClient2 methods ***/
static FORCEINLINE HRESULT IAudioClient2_IsOffloadCapable(IAudioClient2* This,AUDIO_STREAM_CATEGORY category,BOOL *offload_capable) {
    return This->lpVtbl->IsOffloadCapable(This,category,offload_capable);
}
static FORCEINLINE HRESULT IAudioClient2_SetClientProperties(IAudioClient2* This,const AudioClientProperties *prop) {
    return This->lpVtbl->SetClientProperties(This,prop);
}
static FORCEINLINE HRESULT IAudioClient2_GetBufferSizeLimits(IAudioClient2* This,const WAVEFORMATEX *format,BOOL event_driven,REFERENCE_TIME *min_duration,REFERENCE_TIME *max_duration) {
...
/*** IAudioClient2 methods ***/
static FORCEINLINE HRESULT IAudioClient3_IsOffloadCapable(IAudioClient3* This,AUDIO_STREAM_CATEGORY category,BOOL *offload_capable) {
    return This->lpVtbl->IsOffloadCapable(This,category,offload_capable);
}
static FORCEINLINE HRESULT IAudioClient3_SetClientProperties(IAudioClient3* This,const AudioClientProperties *prop) {
    return This->lpVtbl->SetClientProperties(This,prop);
}
static FORCEINLINE HRESULT IAudioClient3_GetBufferSizeLimits(IAudioClient3* This,const WAVEFORMATEX *format,BOOL event_driven,REFERENCE_TIME *min_duration,REFERENCE_TIME *max_duration) {
    return This->lpVtbl->GetBufferSizeLimits(This,format,event_driven,min_duration,max_duration);
}
/*** IAudioClient3 methods ***/
static FORCEINLINE HRESULT IAudioClient3_GetSharedModeEnginePeriod(IAudioClient3* This,const WAVEFORMATEX *format,UINT32 *default_period_frames,UINT32 *unit_period_frames,UINT32 *min_period_frames,UINT32 *max_period_frames) {
...
static FORCEINLINE HRESULT IAudioClient3_GetCurrentSharedModeEnginePeriod(IAudioClient3* This,WAVEFORMATEX **cur_format,UINT32 *cur_period_frames) {
    return This->lpVtbl->GetCurrentSharedModeEnginePeriod(This,cur_format,cur_period_frames);
}
static FORCEINLINE HRESULT IAudioClient3_InitializeSharedAudioStream(IAudioClient3* This,DWORD flags,UINT32 period_frames,const WAVEFORMATEX *format,const GUID *session_guid) {
...
/*** IAudioAmbisonicsControl methods ***/
static FORCEINLINE HRESULT IAudioAmbisonicsControl_SetData(IAudioAmbisonicsControl* This,const AMBISONICS_PARAMS *param,UINT32 size) {
    return This->lpVtbl->SetData(This,param,size);
}
static FORCEINLINE HRESULT IAudioAmbisonicsControl_SetHeadTracking(IAudioAmbisonicsControl* This,BOOL enable) {
    return This->lpVtbl->SetHeadTracking(This,enable);
}
static FORCEINLINE HRESULT IAudioAmbisonicsControl_GetHeadTracking(IAudioAmbisonicsControl* This,BOOL *enable) {
