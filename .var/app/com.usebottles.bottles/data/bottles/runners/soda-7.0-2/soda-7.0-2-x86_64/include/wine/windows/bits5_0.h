/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/bits5_0.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IBackgroundCopyJob5_GetOwnerElevationState(IBackgroundCopyJob5* This,BOOL *elevated) {
