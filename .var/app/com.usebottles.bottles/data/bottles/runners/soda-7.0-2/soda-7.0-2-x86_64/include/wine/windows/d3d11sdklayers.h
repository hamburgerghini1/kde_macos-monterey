/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/d3d11sdklayers.idl - Do not edit ***/
...
/*** ID3D11SwitchToRef methods ***/
static FORCEINLINE BOOL ID3D11SwitchToRef_SetUseRef(ID3D11SwitchToRef* This,BOOL useref) {
    return This->lpVtbl->SetUseRef(This,useref);
}
static FORCEINLINE BOOL ID3D11SwitchToRef_GetUseRef(ID3D11SwitchToRef* This) {
