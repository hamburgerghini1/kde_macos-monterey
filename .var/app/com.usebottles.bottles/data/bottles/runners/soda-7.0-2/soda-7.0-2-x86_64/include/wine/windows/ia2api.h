...
static FORCEINLINE HRESULT IAccessible2_get_accDescription(IAccessible2* This,VARIANT varID,BSTR *description) {
    return This->lpVtbl->get_accDescription(This,varID,description);
}
static FORCEINLINE HRESULT IAccessible2_get_accRole(IAccessible2* This,VARIANT varID,VARIANT *role) {
    return This->lpVtbl->get_accRole(This,varID,role);
}
static FORCEINLINE HRESULT IAccessible2_get_accState(IAccessible2* This,VARIANT varID,VARIANT *state) {
    return This->lpVtbl->get_accState(This,varID,state);
}
static FORCEINLINE HRESULT IAccessible2_get_accHelp(IAccessible2* This,VARIANT varID,BSTR *help) {
    return This->lpVtbl->get_accHelp(This,varID,help);
}
static FORCEINLINE HRESULT IAccessible2_get_accHelpTopic(IAccessible2* This,BSTR *helpfile,VARIANT varID,LONG *pidTopic) {
    return This->lpVtbl->get_accHelpTopic(This,helpfile,varID,pidTopic);
}
static FORCEINLINE HRESULT IAccessible2_get_accKeyboardShortcut(IAccessible2* This,VARIANT varID,BSTR *shortcut) {
...
static FORCEINLINE HRESULT IAccessible2_get_accDefaultAction(IAccessible2* This,VARIANT varID,BSTR *action) {
...
static FORCEINLINE HRESULT IAccessible2_accLocation(IAccessible2* This,LONG *left,LONG *top,LONG *width,LONG *height,VARIANT varID) {
    return This->lpVtbl->accLocation(This,left,top,width,height,varID);
}
static FORCEINLINE HRESULT IAccessible2_accNavigate(IAccessible2* This,LONG dir,VARIANT varStart,VARIANT *pvarEnd) {
    return This->lpVtbl->accNavigate(This,dir,varStart,pvarEnd);
}
static FORCEINLINE HRESULT IAccessible2_accHitTest(IAccessible2* This,LONG left,LONG top,VARIANT *pvarID) {
...
static FORCEINLINE HRESULT IAccessible2_put_accName(IAccessible2* This,VARIANT varID,BSTR name) {
    return This->lpVtbl->put_accName(This,varID,name);
}
static FORCEINLINE HRESULT IAccessible2_put_accValue(IAccessible2* This,VARIANT varID,BSTR value) {
...
static FORCEINLINE HRESULT IAccessible2_2_get_accDescription(IAccessible2_2* This,VARIANT varID,BSTR *description) {
    return This->lpVtbl->get_accDescription(This,varID,description);
}
static FORCEINLINE HRESULT IAccessible2_2_get_accRole(IAccessible2_2* This,VARIANT varID,VARIANT *role) {
    return This->lpVtbl->get_accRole(This,varID,role);
}
static FORCEINLINE HRESULT IAccessible2_2_get_accState(IAccessible2_2* This,VARIANT varID,VARIANT *state) {
    return This->lpVtbl->get_accState(This,varID,state);
}
static FORCEINLINE HRESULT IAccessible2_2_get_accHelp(IAccessible2_2* This,VARIANT varID,BSTR *help) {
    return This->lpVtbl->get_accHelp(This,varID,help);
}
static FORCEINLINE HRESULT IAccessible2_2_get_accHelpTopic(IAccessible2_2* This,BSTR *helpfile,VARIANT varID,LONG *pidTopic) {
    return This->lpVtbl->get_accHelpTopic(This,helpfile,varID,pidTopic);
}
static FORCEINLINE HRESULT IAccessible2_2_get_accKeyboardShortcut(IAccessible2_2* This,VARIANT varID,BSTR *shortcut) {
    return This->lpVtbl->get_accKeyboardShortcut(This,varID,shortcut);
}
...
static FORCEINLINE HRESULT IAccessible2_2_get_accDefaultAction(IAccessible2_2* This,VARIANT varID,BSTR *action) {
    return This->lpVtbl->get_accDefaultAction(This,varID,action);
}
static FORCEINLINE HRESULT IAccessible2_2_accSelect(IAccessible2_2* This,LONG flagsSelect,VARIANT varID) {
    return This->lpVtbl->accSelect(This,flagsSelect,varID);
}
static FORCEINLINE HRESULT IAccessible2_2_accLocation(IAccessible2_2* This,LONG *left,LONG *top,LONG *width,LONG *height,VARIANT varID) {
    return This->lpVtbl->accLocation(This,left,top,width,height,varID);
}
static FORCEINLINE HRESULT IAccessible2_2_accNavigate(IAccessible2_2* This,LONG dir,VARIANT varStart,VARIANT *pvarEnd) {
    return This->lpVtbl->accNavigate(This,dir,varStart,pvarEnd);
}
static FORCEINLINE HRESULT IAccessible2_2_accHitTest(IAccessible2_2* This,LONG left,LONG top,VARIANT *pvarID) {
    return This->lpVtbl->accHitTest(This,left,top,pvarID);
}
static FORCEINLINE HRESULT IAccessible2_2_accDoDefaultAction(IAccessible2_2* This,VARIANT varID) {
    return This->lpVtbl->accDoDefaultAction(This,varID);
}
static FORCEINLINE HRESULT IAccessible2_2_put_accName(IAccessible2_2* This,VARIANT varID,BSTR name) {
    return This->lpVtbl->put_accName(This,varID,name);
}
static FORCEINLINE HRESULT IAccessible2_2_put_accValue(IAccessible2_2* This,VARIANT varID,BSTR value) {
    return This->lpVtbl->put_accValue(This,varID,value);
}
/*** IAccessible2 methods ***/
...
static FORCEINLINE HRESULT IAccessible2_3_get_accDescription(IAccessible2_3* This,VARIANT varID,BSTR *description) {
    return This->lpVtbl->get_accDescription(This,varID,description);
}
static FORCEINLINE HRESULT IAccessible2_3_get_accRole(IAccessible2_3* This,VARIANT varID,VARIANT *role) {
    return This->lpVtbl->get_accRole(This,varID,role);
}
static FORCEINLINE HRESULT IAccessible2_3_get_accState(IAccessible2_3* This,VARIANT varID,VARIANT *state) {
    return This->lpVtbl->get_accState(This,varID,state);
}
static FORCEINLINE HRESULT IAccessible2_3_get_accHelp(IAccessible2_3* This,VARIANT varID,BSTR *help) {
    return This->lpVtbl->get_accHelp(This,varID,help);
}
static FORCEINLINE HRESULT IAccessible2_3_get_accHelpTopic(IAccessible2_3* This,BSTR *helpfile,VARIANT varID,LONG *pidTopic) {
    return This->lpVtbl->get_accHelpTopic(This,helpfile,varID,pidTopic);
}
static FORCEINLINE HRESULT IAccessible2_3_get_accKeyboardShortcut(IAccessible2_3* This,VARIANT varID,BSTR *shortcut) {
    return This->lpVtbl->get_accKeyboardShortcut(This,varID,shortcut);
}
...
static FORCEINLINE HRESULT IAccessible2_3_get_accDefaultAction(IAccessible2_3* This,VARIANT varID,BSTR *action) {
    return This->lpVtbl->get_accDefaultAction(This,varID,action);
}
static FORCEINLINE HRESULT IAccessible2_3_accSelect(IAccessible2_3* This,LONG flagsSelect,VARIANT varID) {
    return This->lpVtbl->accSelect(This,flagsSelect,varID);
}
static FORCEINLINE HRESULT IAccessible2_3_accLocation(IAccessible2_3* This,LONG *left,LONG *top,LONG *width,LONG *height,VARIANT varID) {
    return This->lpVtbl->accLocation(This,left,top,width,height,varID);
}
static FORCEINLINE HRESULT IAccessible2_3_accNavigate(IAccessible2_3* This,LONG dir,VARIANT varStart,VARIANT *pvarEnd) {
    return This->lpVtbl->accNavigate(This,dir,varStart,pvarEnd);
}
static FORCEINLINE HRESULT IAccessible2_3_accHitTest(IAccessible2_3* This,LONG left,LONG top,VARIANT *pvarID) {
    return This->lpVtbl->accHitTest(This,left,top,pvarID);
}
static FORCEINLINE HRESULT IAccessible2_3_accDoDefaultAction(IAccessible2_3* This,VARIANT varID) {
    return This->lpVtbl->accDoDefaultAction(This,varID);
}
static FORCEINLINE HRESULT IAccessible2_3_put_accName(IAccessible2_3* This,VARIANT varID,BSTR name) {
    return This->lpVtbl->put_accName(This,varID,name);
}
static FORCEINLINE HRESULT IAccessible2_3_put_accValue(IAccessible2_3* This,VARIANT varID,BSTR value) {
    return This->lpVtbl->put_accValue(This,varID,value);
}
/*** IAccessible2 methods ***/
