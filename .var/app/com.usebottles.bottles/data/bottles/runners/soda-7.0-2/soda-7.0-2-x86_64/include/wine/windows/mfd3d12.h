/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/mfd3d12.idl - Do not edit ***/
...
/*** IMFD3D12SynchronizationObjectCommands methods ***/
static FORCEINLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReady(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *producer_queue) {
    return This->lpVtbl->EnqueueResourceReady(This,producer_queue);
}
static FORCEINLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceReadyWait(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
    return This->lpVtbl->EnqueueResourceReadyWait(This,consumer_queue);
}
static FORCEINLINE HRESULT IMFD3D12SynchronizationObjectCommands_SignalEventOnResourceReady(IMFD3D12SynchronizationObjectCommands* This,HANDLE event) {
    return This->lpVtbl->SignalEventOnResourceReady(This,event);
}
static FORCEINLINE HRESULT IMFD3D12SynchronizationObjectCommands_EnqueueResourceRelease(IMFD3D12SynchronizationObjectCommands* This,ID3D12CommandQueue *consumer_queue) {
