/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/spatialaudioclient.idl - Do not edit ***/
...
static FORCEINLINE HRESULT ISpatialAudioObjectBase_IsActive(ISpatialAudioObjectBase* This,BOOL *active) {
...
static FORCEINLINE HRESULT ISpatialAudioObject_IsActive(ISpatialAudioObject* This,BOOL *active) {
    return This->lpVtbl->IsActive(This,active);
}
