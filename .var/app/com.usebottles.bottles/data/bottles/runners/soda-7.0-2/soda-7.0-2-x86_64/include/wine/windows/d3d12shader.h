/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/d3d12shader.idl - Do not edit ***/
...
static FORCEINLINE BOOL ID3D12ShaderReflection_IsSampleFrequencyShader(ID3D12ShaderReflection* This) {
