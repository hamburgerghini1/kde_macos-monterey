/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/directmanipulation.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IDirectManipulationManager_ProcessInput(IDirectManipulationManager* This,const MSG *msg,BOOL *handled) {
...
static FORCEINLINE HRESULT IDirectManipulationViewport_ZoomToRect(IDirectManipulationViewport* This,const float left,const float top,const float right,const float bottom,BOOL animate) {
...
static FORCEINLINE HRESULT IDirectManipulationViewport2_ZoomToRect(IDirectManipulationViewport2* This,const float left,const float top,const float right,const float bottom,BOOL animate) {
    return This->lpVtbl->ZoomToRect(This,left,top,right,bottom,animate);
}
...
static FORCEINLINE HRESULT IDirectManipulationManager2_ProcessInput(IDirectManipulationManager2* This,const MSG *msg,BOOL *handled) {
    return This->lpVtbl->ProcessInput(This,msg,handled);
}
