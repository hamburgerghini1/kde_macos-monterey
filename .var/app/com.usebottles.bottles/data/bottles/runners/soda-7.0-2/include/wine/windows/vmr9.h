/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/vmr9.idl - Do not edit ***/
...
static FORCEINLINE HRESULT IVMRImageCompositor9_SetStreamMediaType(IVMRImageCompositor9* This,DWORD stream,AM_MEDIA_TYPE *mt,BOOL texture) {
