/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/dmodshow.idl - Do not edit ***/
...
/*** IDMOWrapperFilter methods ***/
static FORCEINLINE HRESULT IDMOWrapperFilter_Init(IDMOWrapperFilter* This,REFCLSID clsid,REFCLSID category) {
