/*** Autogenerated by WIDL 7.0 from ../ValveSoftware-winegit/include/d3d10sdklayers.idl - Do not edit ***/
...
/*** ID3D10SwitchToRef methods ***/
static FORCEINLINE BOOL ID3D10SwitchToRef_SetUseRef(ID3D10SwitchToRef* This,BOOL useref) {
    return This->lpVtbl->SetUseRef(This,useref);
}
static FORCEINLINE BOOL ID3D10SwitchToRef_GetUseRef(ID3D10SwitchToRef* This) {
