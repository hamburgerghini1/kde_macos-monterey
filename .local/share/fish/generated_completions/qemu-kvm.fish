...
complete -c qemu-kvm -o soundhw -o soundhw -d 'Enable audio and selected sound hardware'
...
complete -c qemu-kvm -o fdb -d 'Use file as floppy disk 0/1 image (see the disk images chapter in the System …'
complete -c qemu-kvm -o hdd -d 'Use file as hard disk 0, 1, 2 or 3 image (see the disk images chapter in the …'
...
complete -c qemu-kvm -o curses -d 'Normally, if QEMU is compiled with graphical window support, it displays outp…'
complete -c qemu-kvm -o alt-grab -d 'Use Ctrl-Alt-Shift to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-kvm -o ctrl-grab -d 'Use Right-Ctrl to grab mouse (instead of Ctrl-Alt)'
complete -c qemu-kvm -o no-quit -d 'Disable window close capability (SDL and GTK only)'
complete -c qemu-kvm -o sdl -d 'Enable SDL'
...
complete -c qemu-kvm -o gdb -d 'Accept a gdb connection on device dev (see the GDB usage chapter in the Syste…'
...
complete -c qemu-kvm -o watchdog -d 'Create a virtual hardware watchdog device'
...
complete -c qemu-kvm -o enable-fips -d 'Enable FIPS 140-2 compliance mode'
