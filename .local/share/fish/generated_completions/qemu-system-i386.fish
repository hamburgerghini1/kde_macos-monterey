...
complete -c qemu-system-i386 -o fdb -d 'Use file as floppy disk 0/1 image (see the disk images chapter in the System …'
complete -c qemu-system-i386 -o hdd -d 'Use file as hard disk 0, 1, 2 or 3 image (see the disk images chapter in the …'
...
complete -c qemu-system-i386 -o no-quit -d 'Disable window close capability (SDL and GTK only)'
...
complete -c qemu-system-i386 -o gdb -d 'Accept a gdb connection on device dev (see the GDB usage chapter in the Syste…'
